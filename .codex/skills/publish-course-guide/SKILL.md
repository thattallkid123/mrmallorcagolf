...
5. Update whatever tracks Andy's own played-course count/list (site copy or Drive doc — confirm the exact file with Andy if unclear; do not guess or invent a number).
