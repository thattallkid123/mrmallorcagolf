...
const SIDEBAR_COPY = {
  ...
  zh: { experience: '体验项目', h3: '与PGA职业球手同场竞技，在这些球场享受私人球局。', p: '在Son Gual、Alcanada等球场享受私人高尔夫日。全程安排，球场实地指导。', seeExp: '了解体验项目', contact: '联系我们', moreGuides: '更多指南', allGuides: '所有指南', home: '首页', guidesLabel: '指南' },
            ...
            <ul style={{listStyle:'none',padding:0,margin:0}}>
              {meta.related.map(r => (
                <li key={r.slug} style={{borderBottom:'1px solid var(--linen)',padding:'10px 0'}}>
                  <a href={`/guides/${r.slug}`} style={{fontSize:'0.85rem',fontWeight:300,color:'var(--charcoal)',textDecoration:'none',lineHeight:1.5,display:'block'}}>{r.title}</a>
                </li>
              ))}
