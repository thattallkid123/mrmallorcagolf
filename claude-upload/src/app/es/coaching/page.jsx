...
export const metadata = {
  ...
  description: 'Coaching de golf en campo en Mallorca con PGA Advanced Professional Andy Griffiths. Mejora real en condiciones reales — para golfistas en visita y residentes.',
    ...
    <PageLayout lang="es">
      ...
      <section className="improvements">
        ...
        <div className="improvements-grid">
          ...
          <div className="improvement reveal reveal-delay-1"><span className="improvement__num">02</span><h3>Elección de golpe bajo presión</h3><p>Las decisiones que se derrumban bajo presión — el driver cuando un hierro 5 gana el hoyo — se hacen visibles en el campo de una forma que nunca ocurre en la zona de práctica.</p></div>
