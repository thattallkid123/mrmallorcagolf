...
export const metadata = {
  title: 'Mallorca Golf Ratgeber  Platz-Bewertungen & Tipps',
  description: 'Ehrliche Golfrategeber fr Mallorca von einem PGA Professional. Platz-Bewertungen, Greenfees und Reiseplanung  aktualisiert 2026.',
    ...
    <PageLayout lang="de">
      ...
      <section style={{maxWidth:860,margin:'0 auto',padding:'clamp(48px,8vw,96px) clamp(20px,4vw,40px)'}}>
        ...
        <Link href="/de/guides/son-gual-review" className="reveal" style={{display:'block',textDecoration:'none',borderBottom:'1px solid var(--linen)',padding:'32px 0'}}>
          ...
          <p style={{fontSize:'0.95rem',fontWeight:300,color:'var(--taupe)',lineHeight:1.75,margin:'0 0 12px',maxWidth:640}}>Mein meistgespielter Platz auf der Insel. Der Wind, die Greens, die Schlusslcher  und warum Obama und Nadal immer wiederkommen.</p>
          <p style={{fontSize:'9px',letterSpacing:'.1em',textTransform:'uppercase',fontFamily:"'Jost',sans-serif",color:'var(--stone)'}}>Championship  Par 72  80165  Handicap erforderlich</p>
        </Link>

        {/*  COMING SOON block  */}
        <div style={{marginTop:'3rem',padding:'2rem',background:'var(--cream)',border:'1px solid var(--linen)'}}>
          <p style={{fontSize:'9px',fontWeight:500,letterSpacing:'.18em',textTransform:'uppercase',fontFamily:"'Jost',sans-serif",color:'var(--gold)',marginBottom:'0.75rem'}}>Weitere Ratgeber folgen in Krze</p>
          <p style={{fontSize:'0.95rem',fontWeight:300,color:'var(--taupe)',lineHeight:1.8,margin:0}}>Ich spiele mich derzeit durch jeden Golfplatz auf der Insel. Jede Bewertung folgt nach dem Spielen  ehrliche Einschtzungen, keine Broschren. Die nchsten Ratgeber erscheinen in den kommenden Wochen.</p>
        </div>
      ...
      <section className="cta-final">
        <div className="cta-final__left reveal">
          ...
          <h2 className="serif-display" style={{color:'#fff'}}>Eine private Runde auf einem dieser Pltze  mit einem PGA Professional an Ihrer Seite.</h2>
          <p>Teilen Sie mir Ihre Daten und Wnsche mit. Ich melde mich persnlich innerhalb von 24 Stunden.</p>
        </div>
