...
const REGIONS = [
  ...
  { key: 'palma', label: 'Palma & Central' },
  { key: 'southwest', label: 'Southwest' },
  { key: 'south', label: 'South' },
  { key: 'east', label: 'East' },
  { key: 'north', label: 'North' },
  { key: 'west', label: 'West & Tramuntana' },
...
const REGION_HEADERS = {
  ...
  east: { title: 'East', subtitle: '50–65km from Palma · Worth basing yourself here', count: '5 courses' },
  north: { title: 'North', subtitle: "Port d'Alcúdia · 55–60km · Alcanada alone justifies the drive", count: '2 courses' },
  west: { title: 'West & Tramuntana', subtitle: 'Bunyola · 10km', count: '1 course' },
}
    ...
    <>
      ...
      <section className="geography reveal">
        <div className="geography__left">
          ...
          <p>Twenty-two courses ranging from genuine European Tour venues to quieter, less-visited gems. Green fees from €20 to over €200. I&apos;m a PGA Advanced Professional based on the island, working my way through every course. Courses marked ★ I&apos;ve played and reviewed first-hand.</p>
        ...
        <div className="geography__right">
          {[
            ...
            { region: 'Palma Central', courses: 'Son Muntaner · Son Vida · Son Quint · T Golf Puntiró · Palma Pitch & Putt' },
            { region: 'Palma Outskirts', courses: 'Son Gual (11km east) · Son Termes (10km northwest)' },
            { region: 'South', courses: 'Golf Maioris · Son Antem East · Son Antem West' },
            { region: 'East', courses: 'Capdepera · Canyamel · Pula · Son Servera · Vall dOr' },
      ...
      <div className="intro-bar">
        <div className="intro-bar__text reveal">
          <p>Mallorca — or Majorca, as it&apos;s commonly spelled in the UK — has more outstanding golf than most visitors realise. The courses marked with ★ are ones I&apos;ve played personally and can review with genuine first-hand knowledge. All others are well-researched and accurate — but I&apos;ll tell you clearly which is which.</p>
