...
COURSE_COST_ROWS = [
    ["Alcanada", "EUR 230", "EUR 115", "35-48", "25-38", "8/10"],
    ...
    ["Pollenca", "EUR 75", "EUR 65", "35-45", "30-40", "6/10"],
    ...
    ["Son Termes", "EUR 110", "EUR 90", "36-47", "EUR 33", "6/10"],
...
def generate_trip_planner():
    ...
    story.extend(
        [
            ...
            Paragraph("<b>Day 5: Northeast Adventure</b><br/>Club de Golf Alcanada - EUR 230 peak | Lighthouse views | 50 mins from Palma", BODY),
            Paragraph("<b>Day 6: Value and Local Gem</b><br/>Pollenca - EUR 75 peak | Scenic | Less crowded", BODY),
...
def generate_cost_guide():
    ...
    story.extend(
        [
            ...
            Paragraph("<b>Best Premium:</b> Son Muntaner (EUR 125-260), Son Vida (EUR 120-180), Alcanada (EUR 115-230).", BODY),
...
def generate_beginners_guide():
    ...
    story.extend(
        [
            ...
            Paragraph("<b>Pollenca</b> - EUR 65-75 | Difficulty 6/10<br/>Less crowded, beautiful setting, scenery plus slight challenge.", BODY),
