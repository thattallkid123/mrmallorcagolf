...
def generate_trip_planner():
    ...
    story.extend(
        [
            ...
            Paragraph("<b>Day 4: Travel / Rest Day</b><br/>Optional: Palma Pitch & Putt (9 holes, €17-30) - recovery day. Explore Palma or rest.", BODY),
...
def generate_cost_guide():
    ...
    story.extend(
        [
            ...
            Spacer(1, 8),
            Paragraph("<b>Best Value:</b> Maioris (€91-110), Palma Pitch & Putt (€27-30), Son Antem East (€70-100).", BODY),
