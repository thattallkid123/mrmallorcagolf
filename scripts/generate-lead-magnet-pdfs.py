...
COURSE_COST_ROWS = [
    ...
    ["Andratx", "EUR 140", "EUR 95", "EUR 45", "35-40", "9/10"],
    ...
    ["Maioris", "EUR 81", "EUR 69", "36-47", "EUR 33", "5/10"],
    ["Palma Pitch & Putt", "EUR 25", "EUR 20", "-", "-", "2/10"],
    ["Pollenca", "EUR 110", "EUR 65", "35-45", "30-40", "6/10"],
    ["Pula", "EUR 135", "EUR 75", "EUR 40", "EUR 35", "7/10"],
    ["Reserva Rotana", "EUR 140", "EUR 85", "35-45", "EUR 35", "6/10"],
    ["Santa Ponsa 1", "EUR 125", "EUR 75", "30-45", "30-40", "7/10"],
    ["Santa Ponsa 2", "EUR 130", "EUR 80", "30-45", "30-40", "7/10"],
    ["Santa Ponsa 3", "EUR 125", "EUR 75", "30-45", "30-40", "6/10"],
    ["Son Antem East", "EUR 100", "EUR 70", "35-45", "EUR 35", "5/10"],
    ["Son Antem West", "EUR 135", "EUR 90", "30-45", "EUR 35", "6/10"],
    ["Son Gual", "EUR 165", "EUR 110", "35-45", "25-38", "8/10"],
    ["Son Muntaner", "EUR 250", "EUR 125", "Incl.", "35-45", "8/10"],
    ["Son Quint", "EUR 95", "EUR 65", "35-40", "30-40", "6/10"],
    ["Son Servera", "EUR 120", "EUR 70", "35-45", "30-40", "6/10"],
    ["Son Termes", "EUR 110", "EUR 85", "36-47", "EUR 33", "6/10"],
    ...
    ["Vall d'Or", "EUR 125", "EUR 75", "35-45", "30-40", "6/10"],
]
...
def generate_trip_planner():
    ...
    story.extend(
        [
            ...
            Paragraph("<b>Day 1: Arrival and Easy Warm-Up</b><br/>Santa Ponsa 1 - EUR 125 peak | Par 72 | Walkable | 25 mins from airport<br/>Public access, forgiving layout, confidence-building. Perfect warm-up after travel.", BODY),
            Paragraph("<b>Day 2: Championship Round</b><br/>Son Gual - EUR 165 peak | Par 72 | Championship | 10 mins from Palma<br/>Andy's favourite. Fast greens, proper test, excellent conditioning. Early tee time recommended.", BODY),
            Paragraph("<b>Day 3: Scenic and Wild</b><br/>Golf de Andratx - EUR 140 peak | Par 72 | Mountain course | 45 mins from Palma<br/>Dramatic views, challenging terrain. New environment adds variety to your week.", BODY),
            PageBreak(),
            Paragraph("MR MALLORCA GOLF", SMALL),
            Paragraph("Days 4-7: Northeast and Rest", SECTION),
            Paragraph("<b>Day 4: Travel / Rest Day</b><br/>Optional: Palma Pitch & Putt (9 holes, EUR 25) - recovery day. Explore Palma or rest.", BODY),
            Paragraph("<b>Day 5: Northeast Adventure</b><br/>Club de Golf Alcanada - EUR 220 peak | Lighthouse views | 50 mins from Palma", BODY),
            Paragraph("<b>Day 6: Value and Local Gem</b><br/>Pollenca - EUR 110 peak | Scenic | Less crowded", BODY),
            Paragraph("<b>Day 7: Grand Finale</b><br/>Son Muntaner - EUR 250 peak | Premium finish near Palma", BODY),
            Spacer(1, 8),
...
def generate_cost_guide():
    ...
    story.extend(
        [
            ...
            Spacer(1, 8),
            Paragraph("<b>Best Value:</b> Maioris (EUR 69-81), Palma Pitch & Putt (EUR 20-25), Son Antem East (EUR 70-100).", BODY),
            Paragraph("<b>Best Premium:</b> Son Muntaner (EUR 125-250), Son Vida (EUR 120-180), Alcanada (EUR 115-220).", BODY),
...
def generate_course_comparison():
    rows = [
        ...
        ["Son Muntaner", "4/5", "EUR 250", "3/5", "5/5", "15 min", "Luxury"],
...
def generate_beginners_guide():
    ...
    story.extend(
        [
            ...
            Paragraph("<b>Palma Pitch & Putt</b> - EUR 20-25 | Difficulty 1/10<br/>Central, par-3 focused, no long drives. Perfect starter round.", BODY),
            Paragraph("<b>Santa Ponsa 3</b> - EUR 75-125 | Difficulty 5/10<br/>Public access, flat, forgiving. Great for an 18-hole confidence-builder.", BODY),
            ...
            Paragraph("<b>Pollenca</b> - EUR 65-110 | Difficulty 6/10<br/>Less crowded, beautiful setting, scenery plus slight challenge.", BODY),
