...
COURSE_COST_ROWS = [
    ...
    ["Santa Ponsa 2", "EUR 88", "EUR 65", "30-45", "30-40", "7/10"],
    ["Santa Ponsa 3", "EUR 30", "EUR 25", "30-45", "30-40", "6/10"],
...
def generate_beginners_guide():
    ...
    story.extend(
        [
            ...
            Paragraph("<b>Santa Ponsa 3</b> - EUR 25-30 | Difficulty 5/10<br/>Public access, flat, forgiving. Great for an 18-hole confidence-builder.", BODY),
