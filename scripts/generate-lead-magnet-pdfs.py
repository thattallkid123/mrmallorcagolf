...
COURSE_COST_ROWS = [
    ...
    ["Son Antem East", "€100", "€70", "35-45", "€35", "5/10"],
    ["Son Antem West", "€135", "€90", "30-45", "€35", "6/10"],
    ["Son Gual", "€165", "€115", "35-45", "25-38", "8/10"],
    ["Son Muntaner", "€260", "€125", "Incl.", "35-45", "8/10"],
    ["Son Quint", "€95", "€65", "35-40", "30-40", "6/10"],
    ["Son Servera", "€145", "€80", "35-45", "30-40", "6/10"],
    ["Son Termes", "€110", "€90", "36-47", "€33", "6/10"],
    ["Son Vida", "€180", "€120", "35-45", "35-45", "8/10"],
    ["T Golf Calvia", "€210", "€170", "35-45", "35-40", "7/10"],
    ["T Golf Palma", "€100", "€70", "35-45", "35-40", "6/10"],
...
def generate_trip_planner():
    ...
    story.extend(
        [
            ...
            Paragraph("<b>Day 4: Travel / Rest Day</b><br/>Optional: Palma Pitch & Putt (9 holes, €20-30) - recovery day. Explore Palma or rest.", BODY),
...
def generate_cost_guide():
    ...
    story.extend(
        [
            ...
            Spacer(1, 8),
            Paragraph("<b>Best Value:</b> Maioris (€91-110), Palma Pitch & Putt (€20-30), Son Antem East (€70-100).", BODY),
            Paragraph("<b>Best Premium:</b> Son Muntaner (€125-260), Son Vida (€120-180), Alcanada (€115-230).", BODY),
...
def generate_course_comparison():
    rows = [
        ...
        ["Son Quint", "3/5", "€95", "2/5", "3/5", "15 min", "Budget"],
        ["Pollenca", "3/5", "€110", "4/5", "3/5", "55 min", "Scenic Value"],
        ["Maioris", "2/5", "€81", "2/5", "2/5", "25 min", "Budget"],
        ["Palma Pitch & Putt", "1/5", "€25", "N/A", "2/5", "2 min", "Beginners"],
    ]
    story = story_intro(
...
def generate_beginners_guide():
    ...
    story.extend(
        [
            ...
            Paragraph("<b>Palma Pitch & Putt</b> - €20-30 | Difficulty 1/10<br/>Central, par-3 focused, no long drives. Perfect starter round.", BODY),
            ...
            Paragraph("<b>Son Quint</b> - €65-95 | Difficulty 5/10<br/>Near Palma, manageable par-4s, good facilities. Accessible difficulty.", BODY),
            Paragraph("<b>Son Antem East</b> - €70-100 | Difficulty 5/10<br/>Resort course, buggy-friendly, coaching available. Gentle terrain.", BODY),
