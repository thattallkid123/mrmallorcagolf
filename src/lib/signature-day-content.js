...
const content = {
  de: {
    ...
    breadcrumbHome: 'Startseite', heroImageAlt: 'Andy Griffiths auf einem Golfplatz auf Mallorca im Abendlicht', heroEyebrow: 'Das komplette Erlebnis, Mallorca', heroTitle: 'Ein privater Golftag\nrund um Runde, Koerper und Abend.', heroBody: '18 Löcher mit mir, eine Session nach der Runde mit John Brazier, private Transfers und ein Abend, der für Ihre Gruppe arrangiert wird. Eine Person koordiniert den ganzen Tag ab dem ersten Gespraech.', price: 'Preis nach Umfang des Tages', primaryCta: 'Anfragen', secondaryCta: 'Den Tag ansehen', coursesCta: 'Mallorcas Golfplätze entdecken', whatsappLabel: 'WhatsApp schreiben', whatsappHref: 'https://wa.me/34624466702?text=Hi%20Andy%2C%20ich%20interessiere%20mich%20für%20den%20Signature%20Day.',
    included: ['Platz- und Tagesplanung', 'Private Startzeit', '18 Löcher mit Andy', 'Session mit John Brazier', 'Verbundenes Debrief und Prioritaeten', 'Private Transfers', 'Abendkoordination'],
    dayStages: [
      { time: 'Vor dem Tag', title: 'Planen und bestaetigen', body: 'Ich wähle den Platz mit Ihnen aus, organisiere Startzeit und Transfers und koordiniere den Abend. Sie erhalten ein klares Angebot, bevor etwas gebucht wird.' },
      ...
      { time: 'Das Debrief', title: 'Ein verbundener Plan', body: 'Wir bringen Golf- und Koerperbeobachtungen zusammen. Sie gehen mit Klarheit darüber, was passiert ist, was dazu beitragen kann und woran Sie zuerst arbeiten sollten.' },
    ...
    optionalExtras: [
      ...
      { title: 'Videografie und Fotografie', text: 'Professionelle Begleitung kann ergaenzt werden, wenn Sie den Tag dokumentieren möchten.' },
      { title: 'Premium-Schlägermiete', text: 'Die beste passende Ausruestung am Platz kann vor Ihrer Ankunft organisiert werden.' },
      { title: 'Mehrtaegige Planung', text: 'Der Signature Day kann Teil einer größeren Mallorca-Reise mit weiteren Plätzen, Hotels und Inselerlebnissen sein.' },
    ],
    sections: {
  ...
  es: {
    ...
    breadcrumbHome: 'Inicio', heroImageAlt: 'Andy Griffiths en un campo de golf en Mallorca al atardecer', heroEyebrow: 'La experiencia completa, Mallorca', heroTitle: 'Un dia privado de golf\nalrededor de la vuelta, el cuerpo y la noche.', heroBody: '18 hoyos conmigo, una sesion después de la vuelta con John Brazier, traslados privados y una noche organizada para su grupo. Una sola persona coordina todo desde la primera conversacion.', price: 'Precio según el dia', primaryCta: 'Consultar', secondaryCta: 'Explorar el dia', coursesCta: 'Explorar los campos de golf de Mallorca', whatsappLabel: 'Mensaje por WhatsApp', whatsappHref: 'https://wa.me/34624466702?text=Hola%20Andy%2C%20me%20interesa%20el%20Signature%20Day.',
    included: ['Planificación del campo y del dia', 'Hora de salida privada', '18 hoyos con Andy', 'Sesion con John Brazier', 'Debrief conectado y prioridades', 'Traslados privados', 'Coordinacion de la noche'],
    dayStages: [
      ...
      { time: 'Después de la vuelta', title: 'Sesion con John Brazier', body: 'John trabaja en medicina complementaria y alternativa, recuperacion y rendimiento deportivo. Usa lo observado en la vuelta para revisar los patrones fisicos que hay detras.' },
    ...
    optionalExtras: [
      ...
      { title: 'Planificación de varios dias', text: 'El Signature Day puede formar parte de un itinerario más amplio en Mallorca con otros campos, hoteles y experiencias.' },
    ],
    sections: {
      overviewEyebrow: 'Que es', overviewTitle: 'Un dia completo, no una coleccion de extras.', overviewBody: 'Juego los 18 hoyos completos con usted y observo como se comporta su juego en condiciones reales. Después de la vuelta, John examina la parte de recuperacion y rendimiento fisico de lo que hemos visto. Luego unimos ambas perspectivas en prioridades practicas.', overviewBody2: 'Alrededor del golf, coordino la salida, los traslados privados y una noche en un hotel o restaurante recomendado, o con chef privado si encaja mejor con la ocasion.', overviewPrinciple: 'Las mejoras más rapidas suelen aparecer en el campo, donde las decisiones y el movimiento son reales. El resto del dia está pensado para convertir esas observaciones en algo util.', overviewImageAlt: 'Andy Griffiths entrenando a un golfista en Mallorca', includedTitle: 'Lo que cubre el dia central',
      howEyebrow: 'Como funciona', howTitle: 'Cinco fases. Una experiencia conectada.', howBody: 'Cada fase tiene un proposito claro, y las observaciones de la vuelta siguen presentes durante el resto del dia.', whyEyebrow: 'Por que es diferente', whyTitle: 'La vuelta y el cuerpo se consideran juntos.', whyBody: 'Durante la vuelta anoto movimiento, decisiones y patrones repetidos que afectan a su resultado. John después considera la parte de recuperacion y rendimiento deportivo de esas observaciones.', whyBody2: 'El valor está en unir esas observaciones. Sale con un orden claro de prioridades, no con sesiones separadas.', johnBody: 'John trabaja en medicina complementaria y alternativa y se especializa en recuperacion y rendimiento deportivo.', johnLink: 'Leer sobre el trabajo de John', whyImageAlt: 'Vuelta de cliente en Son Gual Mallorca',
      courseEyebrow: 'El campo', courseTitle: 'Elegido para su juego y la ocasion.', courseBody: 'Son Gual y Alcanada son mis opciones principales para un dia completo serio. Son Gual es mi campo favorito en Mallorca, con un tramo final especialmente fürte. Alcanada muestra a Robert Trent Jones Jr. en su version más escenica, con el faro visible durante gran parte de la vuelta.', courseBody2: 'El campo adecuado depende de su grupo, su juego y como quiere que se sienta el dia. Recomiendo con honestidad y explico por que.', eveningEyebrow: 'La noche', eveningTitle: 'Cena adaptada a donde se aloje.', eveningBody: 'La noche puede organizarse en un hotel o restaurante recomendado, o con chef privado cuando la propiedad y la ocasion lo permitan. Coordino el plan directamente para que se sienta como la parte final del dia.', eveningBody2: 'Son recomendaciones, no socios formales. La eleccion final depende de su hotel, sus fechas y la experiencia que quiera.', extrasEyebrow: 'Extras opcionales', extrasTitle: 'Anadir solo lo que mejora el dia.', extrasBody: 'Estos elementos pueden incluirse en la propuesta cuando encajen con el grupo, el campo y la fecha.', pricingEyebrow: 'Precio', pricingTitle: 'Confirmado cuando el dia tiene forma.', pricingBody: 'Cada Signature Day se cotiza después de la primera conversacion porque el campo, el tamaño del grupo, los traslados, la disponibilidad de John y el plan de noche afectan al alcance. La mayoria de los dias se construyen alrededor de una experiencia central de unos €3,000.', pricingBody2: 'Su propuesta mostrara exactamente que está incluido, que queda sujeto a disponibilidad y cualquier coste de terceros antes de comprometerse.', pricingCta: 'Consultar sobre el Signature Day',
    },
  },
  fr: {
    ...
    dayStages: [
      ...
      { time: 'Après la partie', title: 'Session avec John Brazier', body: 'John travaille en medecine complementaire et alternative, recuperation et performance sportive. Il utilise les observations du parcours pour examiner les schemas physiques en jeu.' },
      ...
      { time: 'La soiree', title: 'Une fin bien organisee', body: 'La journée se termine par un diner dans un hotel ou restaurant recommande, ou avec un chef prive lorsque cela convient. Le plan est construit autour de votre groupe et de votre lieu de sejour.' },
    ],
    optionalExtras: [
      { title: 'Caddie', text: 'Un caddie adapte peut être demande si le parcours, la date et la disponibilite le permettent.' },
      { title: 'Video et photographie', text: 'Une couverture professionnelle peut être ajoutee si vous souhaitez documenter la journée.' },
      { title: 'Location de clubs premium', text: 'Le meilleur materiel adapte disponible au parcours peut être organise avant votre arrivee.' },
    ...
    sections: {
      overviewEyebrow: 'Ce que c est', overviewTitle: 'Une journée complète, pas une collection d options.', overviewBody: 'Je joue les 18 trous avec vous et j observe votre jeu en conditions reelles. Après la partie, John examine l aspect recuperation et performance physique de ce que nous avons vu. Nous relions ensuite les deux lectures en priorites concretes.', overviewBody2: 'Autour du golf, je coordonne le départ, les transferts prives et une soiree dans un hotel ou restaurant recommande, ou avec un chef prive si cela convient mieux a l occasion.', overviewPrinciple: 'Les progres les plus rapides apparaissent souvent sur le parcours, la ou les decisions et les mouvements sont reels. Le reste de la journée rend ces observations utiles.', overviewImageAlt: 'Andy Griffiths coachant un golfeur a Majorque', includedTitle: 'Ce que couvre la journée de base', howEyebrow: 'Deroule', howTitle: 'Cinq etapes. Une experience connectee.', howBody: 'Chaque étape a un objectif clair, et les observations du parcours traversent le reste de la journée.', whyEyebrow: 'Pourquoi c est different', whyTitle: 'Le parcours et le corps sont regardes ensemble.', whyBody: 'Pendant la partie, je note les mouvements, decisions et schemas recurrents qui influencent votre score. John considere ensuite l aspect recuperation et performance sportive de ces observations.', whyBody2: 'La valeur vient du lien entre ces observations. Vous repartez avec un ordre clair de priorites, pas avec des sessions separees.', johnBody: 'John travaille en medecine complementaire et alternative et se specialise en recuperation et performance sportive.', johnLink: 'Lire le travail de John', whyImageAlt: 'Partie client a Son Gual Mallorca', courseEyebrow: 'Le parcours', courseTitle: 'Choisi pour votre jeu et l occasion.', courseBody: 'Son Gual et Alcanada sont mes choix principaux pour une vraie journée complète. Son Gual est mon parcours prefere a Majorque, avec une fin de parcours particulièrement forte. Alcanada montre Robert Trent Jones Jr. dans sa version la plus scenique, avec le phare visible pendant une grande partie du tour.', courseBody2: 'Le bon parcours depend de votre groupe, de votre jeu et du ton que vous voulez donner a la journée. Je recommande franchement et j explique pourquoi.', eveningEyebrow: 'La soiree', eveningTitle: 'Un diner adapte a votre lieu de sejour.', eveningBody: 'La soiree peut être arrangee dans un hotel ou restaurant recommande, ou autour d un chef prive lorsque la propriete et l occasion s y pretent. Je coordonne le plan directement pour qu il ressemble a la dernière partie de la journée.', eveningBody2: 'Ce sont des recommandations, pas des partenaires formels. Le choix final depend de votre hotel, de vos dates et de l experience souhaitee.', extrasEyebrow: 'Options', extrasTitle: 'Ajouter seulement ce qui ameliore la journée.', extrasBody: 'Ces elements peuvent être inclus dans la proposition lorsqu ils conviennent au groupe, au parcours et a la date.', pricingEyebrow: 'Tarif', pricingTitle: 'Confirme lorsque la journée a pris forme.', pricingBody: 'Chaque Signature Day est chiffre après le premier echange, car le parcours, la taille du groupe, les transferts, la disponibilite de John et la soiree modifient le perimetre. La plupart des journees sont construites autour d une experience de base d environ €3,000.', pricingBody2: 'Votre proposition indiquera exactement ce qui est inclus, ce qui depend de la disponibilite et les eventuels couts tiers avant tout engagement.', pricingCta: 'Demander le Signature Day',
    },
  },
  nl: {
    ...
    dayStages: [
      ...
      { time: 'De debrief', title: 'Een verbonden plan', body: 'We brengen de golf- en fysieke observaties samen. U vertrekt met duidelijkheid över wat er gebeurde, wat eraan kan bijdragen en waar u eerst aan moet werken.' },
  ...
  sv: {
    ...
    dayStages: [
      ...
      { time: 'Efter rundan', title: 'Session med John Brazier', body: 'John arbetar med complementary and alternative medicine, aterhamtning och sportprestation. Han använder observationerna från rundan for att titta pa de fysiska monster som ligger bakom.' },
      ...
      { time: 'Kvallen', title: 'Ett valordnat avslut', body: 'Dagen avslutas med middag pa ett rekommenderat hotell eller restaurang, eller med privat kock där det passar. Planen byggs runt din grupp och var ni bor.' },
    ],
    optionalExtras: [
      { title: 'Caddy', text: 'En lamplig caddy kan efterfragas när bana, datum och tillganglighet tillater.' },
    ...
    sections: {
      overviewEyebrow: 'Vad det ar', overviewTitle: 'En komplett dag, inte en samling tillagg.', overviewBody: 'Jag spelar hela 18 hål med dig och ser hur ditt spel beter sig under riktiga forhallanden. Efter rundan tittar John pa aterhamtnings- och sportprestationsdelen av det vi observerade. Sedan for vi ihop bada perspektiven till praktiska prioriteringar.', overviewBody2: 'Runt golfen koordinerar jag starttid, privata transfers och en kvall pa ett rekommenderat hotell eller restaurang, eller med privat kock när det passar tillfallet bättre.', overviewPrinciple: 'De snabbaste forbattrningarna sker ofta pa banan, där beslut och rorelse ar verkliga. Resten av dagen gor observationerna anvandbara.', overviewImageAlt: 'Andy Griffiths coachar en golfare pa Mallorca', includedTitle: 'Vad karndagen omfattar', howEyebrow: 'Hur dagen gar', howTitle: 'Fem steg. En sammanhangande upplevelse.', howBody: 'Varje steg har ett tydligt syfte, och observationerna från rundan följer med genom resten av dagen.', whyEyebrow: 'Varför det ar annorlunda', whyTitle: 'Rundan och kroppen ses tillsammans.', whyBody: 'Under rundan antecknar jag rorelse, beslut och aterkommande monster som paverkar din score. John tittar sedan pa aterhamtnings- och sportprestationsdelen av observationerna.', whyBody2: 'Vardet ligger i att knyta ihop observationerna. Du gar darifran med en tydlig prioriteringsordning, inte separata sessioner.', johnBody: 'John arbetar med complementary and alternative medicine och specialiserar sig pa aterhamtning och sportprestation.', johnLink: 'Las om Johns arbete', whyImageAlt: 'Kundrunda pa Son Gual Mallorca', courseEyebrow: 'Banan', courseTitle: 'Vald for ditt spel och tillfallet.', courseBody: 'Son Gual och Alcanada ar mina forstahandsval for en serios heldag. Son Gual ar min favoritbana pa Mallorca, med en särskilt stark avslutning. Alcanada visar Robert Trent Jones Jr. från hans mest sceniska sida, med fyren synlig under stora delar av rundan.', courseBody2: 'Rätt bana beror pa din grupp, ditt spel och hur du vill att dagen ska kannas. Jag rekommenderar arligt och forklarar varför.', eveningEyebrow: 'Kvallen', eveningTitle: 'Middag anpassad till där du bor.', eveningBody: 'Kvallen kan arrangeras pa ett rekommenderat hotell eller restaurang, eller med privat kock när boendet och tillfallet passar. Jag koordinerar planen direkt sa att den kanns som den sista delen av dagen.', eveningBody2: 'Detta ar rekommendationer, inte formella partners. Det slutliga valet beror pa hotell, datum och vilken upplevelse ni vill ha.', extrasEyebrow: 'Valfria tillagg', extrasTitle: 'Lagg bara till det som gor dagen bättre.', extrasBody: 'Dessa delar kan inga i forslaget när de passar gruppen, banan och datumet.', pricingEyebrow: 'Pris', pricingTitle: 'Bekraftas när dagen har form.', pricingBody: 'Varje Signature Day prissatts efter första samtalet eftersom bana, gruppstorlek, transfers, Johns tillganglighet och kvallsplan paverkar omfattningen. De flesta dagar byggs runt en karnupplevelse pa cirka €3,000.', pricingBody2: 'Ditt forslag visar exakt vad som ingar, vad som ar beroende av tillganglighet och eventuella tredjepartskostnader innan du bestammer dig.', pricingCta: 'Fråga om Signature Day',
    },
  },
  zh: {
