...
const content = {
  ...
  es: {
    ...
    dayStages: [
      ...
      { time: 'Después de la vuelta', title: 'Sesión con John Brazier', body: 'John trabaja en medicina complementaria y alternativa, recuperacion y rendimiento deportivo. Usa lo observado en la vuelta para revisar los patrones fisicos que hay detras.' },
