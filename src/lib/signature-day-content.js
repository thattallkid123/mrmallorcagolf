...
const content = {
  de: {
    ...
    dayStages: [
      ...
      { time: 'Nach der Runde', title: 'Session mit John Brazier', body: 'John arbeitet in complementary and alternative medicine, Recovery und Sports Performance. Er nutzt die Beobachtungen aus der Runde, um die körperlichen Muster dahinter zu betrachten.' },
