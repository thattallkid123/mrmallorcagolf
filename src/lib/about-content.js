export const ABOUT_CONTENT = {
  en: {
    ...
    finalCta: {
      ...
      body: "Tell me your dates, your handicap range, and what kind of trip you want. I'll point you toward the right courses and the add-ons that actually help.",
      primaryCta: 'Build Your Itinerary →',
      primaryHref: 'https://internal.mrmallorcagolf.com',
