export const ABOUT_CONTENT = {
  ...
  de: {
    ...
    chapters: [
      ...
      {
        label: 'Mallorca, 2025-',
        title: 'Vierundzwanzig Plätze, eine Insel und eine durch das eigene Spiel geschärfte Coaching-Philosophie.',
        paragraphs: [
    ...
    sidebarCta: {
      ...
      body: 'Golftage auf Son Gual, Alcanada und darüber hinaus. Alles organisiert. On-course-Coaching während des gesamten Tages.',
    ...
    press: {
      ...
      publication: 'Majorca Daily Bulletin',
      title: 'The New Pro in Town',
      excerpt: 'Wie ich elf Jahre Erfahrung aus einer chinesischen Akademie nach Mallorca brachte und warum das meine Trainingsphilosophie verändert hat.',
      url: 'https://www.majorcadailybulletin.com/holiday/life-style/2026/05/22/142571/the-new-pro-town-andy-griffiths-brings-world-class-chinese-academy-experience-the-mediterranean.html',
  ...
  es: {
    ...
    chapters: [
      ...
      {
        label: 'Mallorca, 2025-',
        title: 'Veinticuatro campos, una isla y una filosofía de coaching afinada al volver a jugar.',
        paragraphs: [
    ...
    sidebarCta: {
      ...
      body: 'Días de golf en Son Gual, Alcanada y más. Todo organizado. Coaching en el campo durante todo el día.',
    ...
    press: {
      ...
      publication: 'Majorca Daily Bulletin',
      title: 'The New Pro in Town',
      excerpt: 'Cómo llevé once años de experiencia de una academia china a Mallorca, y por qué eso cambia mi forma de enseñar.',
      url: 'https://www.majorcadailybulletin.com/holiday/life-style/2026/05/22/142571/the-new-pro-town-andy-griffiths-brings-world-class-chinese-academy-experience-the-mediterranean.html',
  ...
  fr: {
    ...
    chapters: [
      ...
      {
        label: 'Majorque, 2025-',
        title: 'Vingt-quatre parcours, une île et une philosophie de coaching affûtée par le fait de rejouer.',
        paragraphs: [
    ...
    sidebarCta: {
      ...
      body: 'Des journées de golf à Son Gual, Alcanada et au-delà. Tout est organisé. Coaching sur le parcours tout au long de la journée.',
    ...
    press: {
      ...
      publication: 'Majorca Daily Bulletin',
      title: 'The New Pro in Town',
      excerpt: 'Comment j\'ai apporté onze ans d\'expérience d\'une académie chinoise à Majorque, et pourquoi cela change ma façon de coacher.',
      url: 'https://www.majorcadailybulletin.com/holiday/life-style/2026/05/22/142571/the-new-pro-town-andy-griffiths-brings-world-class-chinese-academy-experience-the-mediterranean.html',
  ...
  nl: {
    ...
    chapters: [
      ...
      { label: 'Mallorca, 2025-', title: 'Vierentwintig banen, één eiland en een coachingsfilosofie aangescherpt door zelf weer te spelen.', paragraphs: ['In maart 2025 verhuisde ik met mijn vrouw Yina naar Mallorca. Dichter bij familie in het VK, zon het hele jaar door en een werkelijk uitzonderlijk golfeiland dat de meeste mensen te weinig waarderen.', 'Ik begon weer serieus te spelen. Ik werk me door elke baan op het eiland heen. Ik ontdekte opnieuw hoe het voelt om op de eerste tee te staan en echt om de score te geven. Dat competitieve instinct, jarenlang slapend door fulltime coaching, kwam snel terug.', 'Een PGA Professional die meer dan tien jaar in Azië coachte en nu golfdagen organiseert op een van de beste golfeilanden van Europa. Als dat klinkt als de dag die u zoekt, neem dan contact op.'], quote: 'De coachingsfilosofie die voortkwam uit weer spelen is eenvoudig: de snelste verbeteringen gebeuren op de baan, niet op de range. Echte omstandigheden, echte beslissingen. Vooruitgang die zo ontstaat, blijft hangen.' },
    ],
    imageAlt: 'Andy Griffiths - UK PGA Advanced Professional, Mallorca',
    ...
    sidebarCta: { title: 'Speel de mooiste banen van Mallorca met mij aan uw zijde.', body: 'Golfdagen op Son Gual, Alcanada en meer. Alles geregeld. Coaching op de baan gedurende de hele dag.', button: 'Bekijk de ervaringen →', href: '/nl/play-with-a-pro' },
    ...
    press: { eyebrow: 'Uitgelicht in', publication: 'Majorca Daily Bulletin', title: 'The New Pro in Town', excerpt: 'Hoe ik elf jaar academie-ervaring uit China naar Mallorca bracht, en waarom dat mijn trainingsfilosofie veranderde.', url: 'https://www.majorcadailybulletin.com/holiday/life-style/2026/05/22/142571/the-new-pro-town-andy-griffiths-brings-world-class-chinese-academy-experience-the-mediterranean.html', linkText: 'Lees het volledige artikel' },
  },
  sv: {
    locale: 'sv',
    ...
    sidebarCta: { title: 'Spela Mallorcas finaste banor med mig vid din sida.', body: 'Golfdagar på Son Gual, Alcanada och fler därtill. Allt ordnat. Coaching ute på banan hela dagen.', button: 'Se upplevelserna →', href: '/sv/play-with-a-pro' },
    ...
    press: { eyebrow: 'Presenterad i', publication: 'Majorca Daily Bulletin', title: 'The New Pro in Town', excerpt: 'Hur jag tog elva års akademiexpertis från Kina till Mallorca, och varför det förändrade mitt träningssätt.', url: 'https://www.majorcadailybulletin.com/holiday/life-style/2026/05/22/142571/the-new-pro-town-andy-griffiths-brings-world-class-chinese-academy-experience-the-mediterranean.html', linkText: 'Läs hela reportaget' },
  },
  zh: {
    locale: 'zh',
    ...
    chapters: [
      ...
      { label: '马略卡，2025-', title: '二十四座球场，一座岛屿，以及在重新认真打球后被磨砺出的教学理念。', paragraphs: ['2025 年 3 月，我和妻子 Yina 搬到了马略卡。这里离英国的家人更近，全年阳光充足，而且是一座真正出色、却常常被低估的高尔夫岛屿。', '我也重新开始认真打球，走遍岛上的每一座球场。重新找回站在第一洞发球台上、真正关心成绩的感觉。那个在多年全职教学中沉睡下来的竞争本能，很快就回来了。', '一位在亚洲执教超过十年的 PGA Professional，如今在欧洲最好的高尔夫岛屿之一举办高尔夫日。如果这听起来正是你想要的一天，欢迎联系我。'], quote: '重新开始认真打球后，我的教学理念变得很简单：最快的进步发生在球场上，而不是练习场。真实条件，真实决策。这样得到的进步，往往更能保持。' },
    ],
    ...
    sidebarCta: { title: '与我一起打马略卡最好的球场。', body: '在 Son Gual、Alcanada 以及更多球场安排高尔夫日。全程安排妥当，并提供球场实战教学。', button: '查看体验 →', href: '/zh/play-with-a-pro' },
