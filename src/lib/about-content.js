export const ABOUT_CONTENT = {
  ...
  nl: {
    ...
    chapters: [
      ...
      { label: 'Mallorca, 2025-', title: 'Vierentwintig banen, één eiland en een coachingsfilosofie aangescherpt door zelf weer te spelen.', paragraphs: ['In maart 2025 verhuisde ik met mijn vrouw Yina naar Mallorca. Dichter bij familie in het VK, zon het hele jaar door en een werkelijk uitzonderlijk golfeiland dat de meeste mensen te weinig waarderen.', 'Ik begon weer serieus te spelen. Ik werk me door elke baan op het eiland heen. Ik ontdekte opnieuw hoe het voelt om op de eerste tee te staan en echt om de score te geven. Dat competitieve instinct, jarenlang slapend door fulltime coaching, kwam snel terug.', 'Een PGA Professional die meer dan tien jaar in Azië coachte en nu privé-golfdagen organiseert op een van de beste golfeilanden van Europa. Als dat klinkt als de dag die u zoekt, neem dan contact op.'], quote: 'De coachingsfilosofie die voortkwam uit weer spelen is eenvoudig: de snelste verbeteringen gebeuren op de baan, niet op de range. Echte omstandigheden, echte beslissingen. Vooruitgang die zo ontstaat, blijft hangen.' },
    ],
    imageAlt: 'Andy Griffiths - UK PGA Advanced Professional, Mallorca',
  ...
  zh: {
    ...
    chapters: [
      ...
      { label: '马略卡，2025-', title: '二十四座球场，一座岛屿，以及在重新认真打球后被磨砺出的教学理念。', paragraphs: ['2025 年 3 月，我和妻子 Yina 搬到了马略卡。这里离英国的家人更近，全年阳光充足，而且是一座真正出色、却常常被低估的高尔夫岛屿。', '我也重新开始认真打球，走遍岛上的每一座球场。重新找回站在第一洞发球台上、真正关心成绩的感觉。那个在多年全职教学中沉睡下来的竞争本能，很快就回来了。', '一位在亚洲执教超过十年的 PGA Professional，如今在欧洲最好的高尔夫岛屿之一举办私人高尔夫日。如果这听起来正是你想要的一天，欢迎联系我。'], quote: '重新开始认真打球后，我的教学理念变得很简单：最快的进步发生在球场上，而不是练习场。真实条件，真实决策。这样得到的进步，往往更能保持。' },
    ],
