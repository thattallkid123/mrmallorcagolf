export const GUIDES_CONTENT = {
    ...
    liveGuides: [
      {
        ...
        readTime: '6 min read',
        keywords: 'Championship · Par 72 · €125-250 · Buggy included',
      },
      {
  ...
  es: {
    ...
    hero: {
      ...
      lead:
        'Análisis de campos, planificación de viajes y green fees, escritos por un Profesional PGA que juega aquí cada semana.',
      tags: ['Actualizado 2026', 'Análisis de primera mano', 'PGA Professional'],
    },
    liveGuides: [
      {
        slug: 'son-muntaner-review',
      ...
      },
      {
        ...
        intro:
          'Lo que ocurre realmente cuando pasas un día completo en el mejor campo de Mallorca con un coach que lo juega casi cada semana.',
        readTime: '5 min',
        keywords: 'Son Gual · Jugar con un Pro · Experiencia de día completo',
      },
      {
        slug: 'best-golf-courses-mallorca',
        badge: 'Guía',
        ...
        intro:
          'Veinticuatro campos en la isla. Así los clasificaría para un visitante con tiempo limitado y expectativas altas.',
        readTime: '8 min',
      ...
      },
      {
        ...
        intro:
          'La versión sin adornos: qué hace mejor la isla que Portugal, dónde se queda corta y a quién le conviene.',
        readTime: '5 min',
      ...
      },
      {
        ...
        intro:
          'La foto completa de lo que cuesta realmente un viaje de golf aquí: green fees, alquiler, caddies y dónde ahorrar sin sacrificar calidad.',
        readTime: '5 min',
  ...
  de: {
    ...
    liveGuides: [
      ...
      },
      {
        ...
        intro:
          'Was wirklich passiert, wenn man einen ganzen Tag auf Mallorcas bestem Platz mit einem Coach verbringt, der ihn fast jede Woche spielt.',
        readTime: '5 Min.',
        keywords: 'Son Gual · Mit Profi spielen · Ganztageserlebnis',
      },
      {
        slug: 'best-golf-courses-mallorca',
        badge: 'Ratgeber',
        ...
        intro:
          'Vierundzwanzig Plätze auf der Insel. So würde ich sie für einen Besucher mit begrenzter Zeit und hohen Ansprüchen einordnen.',
        readTime: '8 Min.',
  ...
  fr: {
    ...
    hero: {
      ...
      tags: ['Mis à jour 2026', 'Avis de première main', 'PGA Professional'],
    },
    liveGuides: [
      {
        slug: 'son-muntaner-review',
      ...
      },
      {
        ...
        intro:
          "Ce qui se passe vraiment quand vous passez une journée entière sur le meilleur parcours de Majorque avec un coach qui le joue presque chaque semaine.",
        readTime: '5 min',
        keywords: 'Son Gual · Jouer avec un Pro · Journée complète',
      },
      {
        slug: 'best-golf-courses-mallorca',
        badge: 'Guide',
        ...
        intro:
          "Vingt-quatre parcours sur l'île. Voici comment je les classerais pour un visiteur avec peu de temps et des exigences élevées.",
        readTime: '8 min',
  ...
  nl: {
    ...
    liveGuides: [
      ...
      },
      {
        ...
        intro:
          'Wat er werkelijk gebeurt als je een volledige dag doorbrengt op het mooiste parcours van Mallorca met een coach die het bijna elke week speelt.',
        readTime: '5 min',
        keywords: 'Son Gual · Spelen met een Pro · Dagervaring',
      },
      {
        slug: 'best-golf-courses-mallorca',
        badge: 'Gids',
        ...
        intro:
          'Vierentwintig banen op het eiland. Zo zou ik ze rangschikken voor een bezoeker met beperkte tijd en hoge verwachtingen.',
        readTime: '8 min',
  ...
  sv: {
    ...
    hero: {
      ...
      lead:
        'Banrecensioner, reseplanering och greenfee-priser - skrivna av en PGA Professional som spelar här varje vecka.',
      tags: ['Uppdaterad 2026', 'Förstahandsrecensioner', 'PGA Professional'],
    },
    liveGuides: [
      {
        slug: 'son-muntaner-review',
      ...
      },
      {
        ...
        intro:
          'Vad som faktiskt händer när du tillbringar en hel dag på Mallorcas finaste bana med en coach som spelar den nästan varje vecka.',
        readTime: '5 min',
        keywords: 'Son Gual · Spela med ett proffs · Heldagsupplevelse',
      },
      {
        slug: 'best-golf-courses-mallorca',
        badge: 'Guide',
        ...
        intro:
          'Tjugofyra banor på ön. Så här skulle jag rangordna dem för en besökare med begränsad tid och höga krav.',
        readTime: '8 min',
  ...
  zh: {
    ...
    hero: {
      ...
      title: '马略卡高尔夫。诚实指南。',
      lead:
        '球场评测、行程规划与果岭费信息，由每周都在这里打球的 PGA 职业教练撰写。',
    ...
    liveGuides: [
      ...
      },
      {
        ...
        intro:
          '当你与一位几乎每周都在马略卡岛最佳球场挥杆的教练共度一整天，究竟会发生什么。',
        readTime: '5分钟',
        keywords: 'Son Gual · 与职业球手同场 · 全天体验',
      },
      {
        slug: 'best-golf-courses-mallorca',
        badge: '指南',
        ...
        intro:
          '岛上共有二十四个球场，我会如何为时间有限、要求不低的访客逐一排序。',
        readTime: '8分钟',
