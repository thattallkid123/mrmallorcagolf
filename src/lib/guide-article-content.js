  ...
  'best-golf-courses-mallorca': {
    ...
    blocks: [
      ...
      { type: 'heading', text: 'All 24 Mallorca Golf Courses: Quick Reference' },
      {
        ...
        rows: [
          ['Son Gual', 'Palma', '72', 'EUR 110-165', '9/10', '5.0', 'Serious championship round'],
          ['Club de Golf Alcanada', "Port d'Alcudia", '72', 'EUR 115-220', '7/10', '5.0', 'Spectacular views, championship quality'],
          ['Son Muntaner', 'Son Vida - Palma', '72', 'EUR 125-250', '7/10', '4.5', 'Best-conditioned, close to Palma'],
          ['T Golf Calvia', 'Calvia', '72', 'EUR 170-210', '7/10', '5.0', 'Premium all-round experience'],
          ['Golf de Andratx', 'Camp de Mar', '72', 'EUR 95-140', '9/10', '4.0', 'Hardest test on the island'],
          ['Golf Son Vida', 'Son Vida - Palma', '70', 'EUR 80-190', '8/10', '4.5', 'Historic course, Seve won here'],
          ['T Golf Palma (Puntiro)', 'Palma', '71', 'EUR 100-140', '7/10', '4.5', 'Only Nicklaus design on island'],
          ['Golf Santa Ponsa 1', 'Santa Ponsa', '72', 'EUR 75-125', '8/10', '4.0', 'European Tour venue, public access'],
          ['Golf Santa Ponsa 2', 'Santa Ponsa', '72', 'Members / arranged', '7/10', '3.5', 'Quiet, members-only feel'],
          ['Golf Santa Ponsa 3', 'Santa Ponsa', '30 (9H)', 'Members / arranged', '4/10', '3.0', 'Beginners, approach practice'],
          ['Golf Son Quint', 'Son Vida - Palma', '71', 'EUR 70-140', '5/10', '4.0', 'All levels, Tiger Woods played here'],
          ['Real Golf de Bendinat', 'Bendinat', '70', 'EUR 75-125', '6/10', '3.5', 'Wooded valley, bay views'],
          ['Golf Son Termes', 'Bunyola', '70', 'EUR 85-110', '6/10', '3.5', 'Tramuntana mountain setting'],
          ['Golf Son Antem West', 'Llucmajor', '72', 'EUR 90-135', '7/10', '4.0', 'Resort course, tougher than Son Antem East'],
          ['Golf Son Antem East', 'Llucmajor', '72', 'EUR 90-140', '6/10', '3.5', 'Wide fairways, resort golf'],
          ['Golf Maioris', 'Llucmajor', '72', 'EUR 80-110', '7/10', '3.5', 'Underrated, quieter option'],
          ['Pula Golf', 'Son Servera', '72', 'EUR 80-145', '7/10', '4.0', 'Olazabal redesign, 8 Tour events'],
          ['Golf Club Son Servera', 'Son Servera', '72', 'EUR 80-145', '6/10', '4.0', 'Relaxed parkland, historic'],
          ["Vall d'Or Golf", "S'Horta", '71', 'EUR 85-130', '6/10', '3.5', 'East coast views, strong back nine'],
          ['Capdepera Golf', 'Arta', '72', 'EUR 85-135', '7/10', '3.5', 'Strong back nine and standout mountain hole'],
          ['Canyamel Golf', 'Capdepera', '73', 'EUR 65-145', '6/10', '4.0', 'Most photographed, east coast'],
          ['Golf Pollensa', 'Pollensa', '35 (9H)', 'EUR 55-65', '4/10', '3.5', 'Easy warm-up, Tramuntana views'],
          ['Palma Pitch & Putt', 'Central Palma', '27 (9H)', 'EUR 14-22', '2/10', '3.0', 'Beginners, approach practice'],
    ...
    blocks: [
      {
        type: 'paragraph',
        text:
          "Most golf days are forgettable. You play, you leave, and you can't remember the score by Thursday. The days that stay with you are the ones where something changed - in your game, in what you understood about the course, or just in the conversation. This is what a day at Son Gual actually looks like.",
      },
      ...
      },
      {
        type: 'paragraph',
        text:
          'Tee times at Son Gual go early. That is not incidental - the course plays very differently in the first two hours of the day. The wind starts later. The fairways are quiet. The light across the Bay of Palma on the approach to the 8th hole at 8am is the kind of thing people send photos of. We aim for that window.',
      },
      ...
      { type: 'heading', text: 'The First Tee' },
      {
        type: 'paragraph',
        text:
          'There is a pre-round briefing at the clubhouse. Coffee, a look at the scorecard, a short conversation about what we are working on. Not a technical lecture. Just enough to make the first tee feel intentional rather than rushed.',
      },
      {
        type: 'paragraph',
        text:
      ...
      },
      {
        type: 'paragraph',
        text:
          'Most golfers lose the majority of their shots to the wrong decision, not the wrong swing. On a course like Son Gual - where the greens are fast and raised and where you miss matters more than how you swing - that becomes visible very quickly. We work on it in real conditions with a real score on the line. That is the only context in which it sticks.',
      },
      {
        type: 'paragraph',
        text:
      ...
      },
      {
        type: 'paragraph',
        text:
          'Most clients say they leave with one or two specific things that changed - a different club choice in a situation they had been getting wrong for years, a clearer sense of what their game is actually capable of, or just a better understanding of how to think around a difficult course. That is what I am trying to give them. The day at Son Gual is just the context in which it happens.',
      },
      {
        type: 'quoteBox',
        text:
          "After just 18 holes together, I've discovered a new ceiling to my potential. A fantastic professional and a lovely man to boot.",
