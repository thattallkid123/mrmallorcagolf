    ...
    blocks: [
      ...
      { type: 'heading', text: 'All 24 Mallorca Golf Courses: Quick Reference' },
      {
        ...
        rows: [
          ...
          ['Golf de Andratx', 'Camp de Mar', '72', '\u20AC95-140', '9/10', '4.0', 'Hardest test on the island'],
          ...
          ['Golf Santa Ponsa 2', 'Santa Ponsa', '72', 'Members only (no public rate)', '7/10', '3.5', 'Quiet, members-only feel'],
          ['Golf Santa Ponsa 3', 'Santa Ponsa', '30 (9H)', 'Members only (no public rate)', '4/10', '3.0', 'Beginners, approach practice'],
          ...
          ['Golf Maioris', 'Llucmajor', '72', '\u20AC80-110', '7/10', '3.5', 'Underrated, quieter option'],
          ...
          ["Vall d'Or Golf", "S'Horta", '71', '\u20AC85-130', '6/10', '3.5', 'East coast views, strong back nine'],
