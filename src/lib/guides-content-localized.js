// Generated from resolved guides locale content.
// English owns structure; locale files store copy overlays only.

export const GUIDES_LOCALIZED_CONTENT = {
  "es": {
    "locale": "es",
    "hero": {
      "breadcrumbHome": "ES",
    ...
    "liveGuides": [
      ...
      },
      {
        ...
        "readTime": "7 min",
        "keywords": "Championship · Par 72 · €115-165 · Hándicap requerido"
      },
      {
      ...
      },
      {
        ...
        "intro": "El par 5 más largo de España, vistas de montaña sobre el suroeste y un recorrido que premia la gestión del juego mucho más que la distancia. Un 7,5 sobre 10.",
        "readTime": "6 min",
      ...
      },
      {
        ...
        "intro": "Veinticuatro campos en la isla. Así los clasificaría para un visitante con tiempo limitado y expectativas altas.",
        "readTime": "8 min",
  ...
  "de": {
    ...
    "liveGuides": [
      ...
      },
      {
        ...
        "readTime": "7 Min.",
        "keywords": "Championship · Par 72 · €115-165 · Handicap erforderlich"
      },
      {
        "slug": "t-golf-calvia-review",
        "badge": "Platz-Bewertung",
      ...
      },
      {
        ...
        "intro": "Das längste Par 5 Spaniens, Bergblicke über den Südwesten und ein Layout, das Spielmanagement weit mehr belohnt als Weite. Eine 7,5 von 10.",
        "readTime": "6 Min.",
      ...
      },
      {
        ...
        "intro": "Vierundzwanzig Plätze auf der Insel. So würde ich sie für einen Besucher mit begrenzter Zeit und hohen Ansprüchen einordnen.",
        "readTime": "8 Min.",
  ...
  "fr": {
    ...
    "liveGuides": [
      ...
      },
      {
        ...
        "readTime": "7 min",
        "keywords": "Championship · Par 72 · €115-165 · Handicap requis"
      },
      {
        "slug": "t-golf-calvia-review",
        "badge": "Avis Parcours",
  ...
  "nl": {
    ...
    "liveGuides": [
      ...
      },
      {
        ...
        "readTime": "7 min",
        "keywords": "Championship · Par 72 · €115-165 · Handicap vereist"
      },
      {
        "slug": "t-golf-calvia-review",
        "badge": "Baanreview",
      ...
      },
      {
        ...
        "readTime": "6 min",
        "keywords": "Resortbaan - Par 72 - €109-135 - 15-20 min van Palma"
      },
      {
        "slug": "son-termes-review",
        "badge": "Baanreview",
      ...
      },
      {
        ...
        "intro": "Vierentwintig banen op het eiland. Zo zou ik ze rangschikken voor een bezoeker met beperkte tijd en hoge verwachtingen.",
        "readTime": "8 min",
  ...
  "sv": {
    ...
    "liveGuides": [
      ...
      },
      {
        ...
        "readTime": "7 min",
        "keywords": "Championship · Par 72 · €115-165 · Handicap krävs"
      },
      {
        "slug": "t-golf-calvia-review",
        "badge": "Banrecension",
...
export function getLocalizedGuidesContent(locale) {
  return GUIDES_LOCALIZED_CONTENT[locale] || null
}
