  ...
  en: {
    ...
    whyMallorca: {
      ...
      stats: [
        ...
        { value: 'Tour', label: 'pedigree across the island' },
      ],
    },
    courses: {
...
const HOME_OVERRIDES = {
  de: {
    ...
    whyMallorca: {
      ...
      stats: [
        ...
        { value: 'Tour', label: 'Plätze mit Tourgeschichte' },
      ],
    },
  ...
  es: {
    ...
    whyMallorca: {
      ...
      stats: [
        ...
        { value: 'Tour', label: 'campos con historia de Tour' },
      ],
    },
    courses: {
  ...
  nl: {
    ...
    whyMallorca: { eyebrow: 'Waarom Mallorca', title: 'Mallorca heeft banen op Tour-niveau. Veel bezoekers ontdekken maar een klein deel.', paragraphs: ['Veel van Europa’s beste banen sluiten in de winter. Mallorca niet. Van oktober tot april krijgt u lagere greenfees, rustigere banen en omstandigheden die elders midden in de zomer al goed zouden zijn.', 'Er liggen 22 banen binnen bereik, verschillende met echte Tourgeschiedenis en serieuze architectuur. Mallorca is een echte golfbestemming, en de meeste bezoekers zien daar maar een klein deel van.'], stats: [{ value: '22', label: 'banen op het eiland' }, { value: '300+', label: 'dagen zon per jaar' }, { value: 'Jan-Dec', label: 'seizoen het hele jaar' }, { value: 'Tour', label: 'banen met Tourgeschiedenis' }] },
  ...
  zh: {
    ...
    whyMallorca: { eyebrow: '为什么是马略卡', title: '马略卡有真正达到巡回赛水准的球场。很多来这里的人，其实只看到了很小的一部分。', paragraphs: ['欧洲很多顶级球场一到冬天就关门，马略卡不会。每年 10 月到次年 4 月，是这里的甜蜜期：果岭费更低，球场更安静，球况却依然出色。', '全岛共有 22 座球场，距离都不算远，其中不少有巡回赛历史，也有很成熟的设计。马略卡是真正的高尔夫目的地，只是大多数访客还没有真正认识它。'], stats: [{ value: '22', label: '岛上球场数量' }, { value: '300+', label: '年均晴天' }, { value: 'Jan-Dec', label: '全年可打' }, { value: '巡回赛', label: '拥有巡回赛履历的球场' }] },
