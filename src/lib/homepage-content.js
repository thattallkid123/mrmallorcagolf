    ...
    "items": [
      ...
      },
      {
        ...
        "features": [
          ...
          "Recommended hotel, restaurant, or private-chef dinner planning",
          "Private transfers and recovery time",
          "Caddy, videographer, and premium club hire options",
          "Connected post-round debrief and priorities",
          "Priority booking. Your dates held first."
        ],
        "note": "Personalised from the ground up. Private transfers and a post-round recovery and sports-performance session form part of the core plan; caddies, a private chef, and professional coverage can be added where suitable.",
        "cta": "Enquire",
        "href": "/contact",
