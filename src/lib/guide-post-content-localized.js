  ...
  'son-muntaner-review': {
    ...
    es: {
      ...
      blocks: [
        ...
        { type: 'paragraph', text: "El back nine se abre ligeramente. Más libertad con el driver, aunque los complejos de greens siguen siendo pequeños y engañosamente difíciles. La percepción de profundidad desde la distancia es un desafío constante en Son Muntaner — los greens parecen más grandes de lo que son, y las distancias de aproximación más cortas de lo que juegan." },
    ...
    fr: {
      ...
      blocks: [
        ...
        { type: 'paragraph', text: "Le neuf retour s'ouvre légèrement. Plus de liberté avec le driver, bien que les complexes de greens restent petits et trompeusement difficiles. La perception de la profondeur à distance est un défi constant à Son Muntaner — les greens paraissent plus grands qu'ils ne sont, et les distances d'approche plus courtes qu'elles ne jouent." },
    ...
    nl: {
      ...
      blocks: [
        ...
        { type: 'paragraph', text: "De tweede negen opent iets. Meer vrijheid met de driver, maar de greencomplexen blijven klein en bedrieglijk moeilijk. Diepteperceptie op afstand is een constante uitdaging op Son Muntaner — greens lijken groter dan ze zijn, en benaderingsafstanden zien er korter uit dan ze spelen." },
    ...
    sv: {
      ...
      blocks: [
        ...
        { type: 'paragraph', text: "Niohålet hem öppnar sig något. Mer frihet med driverslagen, men greenkomplexen förblir små och vilseledande svåra. Djupperception på avstånd är en konsekvent utmaning på Son Muntaner — greener ser större ut än de är, och inflygningsavstånd ser kortare ut än de spelar." },
