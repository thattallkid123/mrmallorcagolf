// Generated from resolved contact locale content.
// English owns structure; locale files store copy overlays only.

export const CONTACT_LOCALIZED_CONTENT = {
  "es": {
    "locale": "es",
    "hero": {
    ...
    "form": {
      ...
      "groupsizeOptions": [
        {
          "label": "Seleccione el tamaño del grupo"
        },
        {
          "label": "1 - solo/a"
        },
  ...
  "de": {
    ...
    "form": {
      ...
      "experiences": [
        ...
        [
          "not-sure",
          "Noch unsicher - beraten Sie mich",
          ""
        ]
      ],
  ...
  "fr": {
    ...
    "form": {
      ...
      "groupsizeOptions": [
        {
          "label": "Choisir la taille du groupe"
        },
        {
          "label": "1 - seul(e)"
        },
      ...
      "experiences": [
        ...
        [
          "not-sure",
          "Je ne suis pas encore certain(e) - conseillez-moi",
          ""
        ]
      ],
...
export function getLocalizedContactContent(locale) {
  return CONTACT_LOCALIZED_CONTENT[locale] || null
}
