// Generated from resolved golf-courses locale content.
// English owns structure; locale files store copy overlays only.

export const GOLF_COURSES_LOCALIZED_CONTENT = {
  "de": {
    "locale": "de",
    "hero": {
  ...
  "es": {
    ...
    "regionHeaders": {
      "palma": {
        "subtitle": "Campos alrededor de la ciudad",
        "count": "8 campos"
      },
      "southwest": {
        "title": "Suroeste",
        "subtitle": "Santa Ponsa y Camp de Mar",
        "count": "6 campos"
      },
      "south": {
        "title": "Sur",
        "subtitle": "Zona de Llucmajor",
        "count": "3 campos"
      },
      "east": {
        "title": "Este",
        "subtitle": "Buena zona para alojarse",
        "count": "6 campos"
      },
      "north": {
        "title": "Norte",
        "subtitle": "Solo Alcanada ya justifica el trayecto",
        "count": "2 campos"
      }
    },
    "ui": {
  ...
  "fr": {
    ...
    "regionHeaders": {
      "palma": {
        "subtitle": "Parcours autour de la ville",
        "count": "8 parcours"
      },
      "southwest": {
        "title": "Sud-ouest",
  ...
  "nl": {
    ...
    "regionHeaders": {
      ...
      "south": {
        "title": "Zuid",
        "subtitle": "Regio Llucmajor",
        "count": "3 banen"
      },
      "east": {
        "title": "Oost",
        "subtitle": "Goede uitvalsbasis",
        "count": "6 banen"
      },
      "north": {
        "title": "Noord",
        "subtitle": "Alleen Alcanada maakt de rit al de moeite waard",
        "count": "2 banen"
      }
    },
    "ui": {
      ...
      "faq": [
        {
          "q": "Hoeveel golfbanen zijn er op Mallorca?",
          "a": "Mallorca heeft in totaal 24 golfbanen. Daarvan zijn er 21 open voor greenfee-bezoekers zonder lidmaatschap. Het eiland bestaat uit vijf hoofdregio's: Palma, Zuidwest, Zuid, Oost en Noord."
        },
        {
          "q": "Wat is de beste golfbaan van Mallorca?",
          "a": "Er is niet een beste baan. Het hangt af van wat u van de ronde verwacht. Voor een echte championship-test kijkt u naar de moeilijkste banen. Voor het landschap filtert u op de kust- en bergomgevingen. Voor onderhoud op Tour-niveau sorteert u op mijn beoordeling. Stuur me uw handicap en wat voor u het belangrijkst is en ik wijs u de juiste shortlist."
        },
        {
  ...
  "zh": {
    ...
    "regionHeaders": {
      ...
      "southwest": {
        "title": "西南部",
        "subtitle": "Santa Ponsa 与 Camp de Mar",
        "count": "6 座球场"
      },
      "south": {
        "title": "南部",
        "subtitle": "Llucmajor 区域",
        "count": "3 座球场"
      },
      "east": {
        "title": "东部",
    ...
    "ui": {
      ...
      "faq": [
        {
          "q": "马略卡有多少座高尔夫球场？",
          "a": "马略卡岛共拥有 24 座高尔夫球场，其中 21 座对支付果岭费的访客开放，无需会籍。全岛分为五个主要区域：帕尔马、西南部、南部、东部和北部。"
        },
        {
          "q": "马略卡最好的高尔夫球场是哪一座？",
          "a": "没有唯一的最佳球场，关键看您想从这一场中得到什么。想要真正的锦标赛级挑战，就看难度最高的球场；想要风景，就筛选海岸和山地球场；想要巡回赛级的球场养护，就按我的评分排序。把您的差点和最看重的方面发给我，我会为您推荐合适的名单。"
        },
        {
          "q": "在马略卡打一场高尔夫要多少钱？",
        ...
        {
          "q": "在马略卡打球需要差点证明吗？",
          "a": "大多数球场欢迎各种水平，但有些要求有效的差点证明，或设有最高差点限制。我已在上方的球场卡片上标出有差点要求的球场及其限制，方便您预订前查看。如果您不确定自己的证明，把您考虑的球场告诉我，我来帮您确认。"
        }
      ],
      "toolCta": {
        "eyebrow": "快捷入口",
...
export function getLocalizedGolfCoursesContent(locale) {
  return GOLF_COURSES_LOCALIZED_CONTENT[locale] || null
}
