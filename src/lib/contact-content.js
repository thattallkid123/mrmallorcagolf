...
export const CONTACT_CONTENT = {
  en: {
    ...
    form: {
      ...
      experiences: [
        ['itinerary', 'Trip itinerary / course planning', 'Start here'],
        ['mallorca-round', 'Add Play With A Pro - Solo', '€495'],
        ['signature-day', 'Add Play With A Pro - Group', '€950'],
        ['full-andy-day', 'Hosted multi-day golf journey', 'From €3,000'],
