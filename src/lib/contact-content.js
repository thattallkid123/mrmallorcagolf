...
export const CONTACT_CONTENT = {
  en: {
    ...
    form: {
      ...
      experiences: [
        ['mallorca-round', 'A Day With Andy — Solo', '€595 all inclusive'],
        ['signature-day', 'A Day With Andy — Group of 2 to 4', '€1,195 + green fees'],
        ['full-experience', 'Multi-day trip', 'On enquiry'],
  ...
  de: {
    ...
    form: {
      ...
      experiences: [
        ['mallorca-round', 'Ein Tag mit Andy - Solo', '€595 alles inklusive'],
        ['signature-day', 'Ein Tag mit Andy - Gruppe von 2 bis 4', '€1.195 + Greenfees'],
  ...
  es: {
    ...
    form: {
      ...
      experiences: [
        ['mallorca-round', 'Un día con Andy - Solo', '€595 todo incluido'],
        ['signature-day', 'Un día con Andy - Grupo de 2 a 4', '€1.195 + green fees'],
  ...
  fr: {
    ...
    form: {
      ...
      experiences: [
        ['mallorca-round', 'Une journée avec Andy - Solo', '€595 tout compris'],
        ['signature-day', 'Une journée avec Andy - Groupe de 2 à 4', '€1 195 + green fees'],
  ...
  nl: {
    ...
    form: {
      ...
      experiences: [
        ['mallorca-round', 'Een dag met Andy - Solo', '€595 all-in'],
        ['signature-day', 'Een dag met Andy - Groep van 2 tot 4', '€1.195 + greenfees'],
  ...
  sv: {
    ...
    form: {
      ...
      experiences: [
        ['mallorca-round', 'En dag med Andy - Solo', '€595 allt inkluderat'],
        ['signature-day', 'En dag med Andy - Grupp på 2 till 4', '€1.195 + green fees'],
  ...
  zh: {
    ...
    form: {
      ...
      experiences: [
        ['mallorca-round', '与 Andy 共度一天 - 单人', '€595 全包'],
        ['signature-day', '与 Andy 共度一天 - 2 到 4 人', '€1,195 + 果岭费'],
