...
export const CONTACT_CONTENT = {
  en: {
    ...
    form: {
      ...
      experiences: [
        ...
        ['mallorca-round', 'Play With A Pro - Solo', '€695'],
        ['signature-day', 'Play With A Pro - Group', '€950 total'],
  ...
  de: {
    ...
    form: {
      ...
      experiences: [
        ['mallorca-round', 'Ein Tag mit Andy - Solo', '€695'],
        ['signature-day', 'Ein Tag mit Andy - Gruppe', '€950 insgesamt + Greenfees'],
  ...
  es: {
    ...
    form: {
      ...
      experiences: [
        ['mallorca-round', 'Un día con Andy - Solo', '€695'],
        ['signature-day', 'Un día con Andy - Grupo', '€950 en total + green fees'],
  ...
  fr: {
    ...
    form: {
      ...
      experiences: [
        ['mallorca-round', 'Une journée avec Andy - Solo', '€695'],
        ['signature-day', 'Une journée avec Andy - Groupe', '€950 au total'],
  ...
  nl: {
    ...
    form: {
      ...
      experiences: [
        ['mallorca-round', 'Een dag met Andy - Solo', '€695'],
        ['signature-day', 'Een dag met Andy - Groep', '€950 totaal'],
  ...
  sv: {
    ...
    form: {
      ...
      experiences: [
        ['mallorca-round', 'En dag med Andy - Solo', '€695'],
        ['signature-day', 'En dag med Andy - Grupp', '€950 totalt'],
  ...
  zh: {
    ...
    form: {
      ...
      experiences: [
        ['mallorca-round', '与 Andy 共度一天 - 单人', '€695'],
        ['signature-day', '与 Andy 共度一天 - 小组', '€950 总计'],
