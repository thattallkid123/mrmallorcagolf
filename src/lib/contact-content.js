  ...
  de: {
    ...
    form: {
      ...
      experiences: [
        ...
        ['signature-day', 'Ein Tag mit Andy - Gruppe', '€950 total + Greenfees'],
  ...
  es: {
    ...
    form: {
      ...
      experiences: [
        ...
        ['signature-day', 'Un día con Andy - Grupo', '€950 total + green fees'],
  ...
  fr: {
    ...
    form: {
      ...
      experiences: [
        ...
        ['signature-day', 'Une journée avec Andy - Groupe', '€950 total'],
  ...
  nl: {
    ...
    form: {
      ...
      experiences: [
        ...
        ['signature-day', 'Een dag met Andy - Groep', '€950 total'],
  ...
  sv: {
    ...
    form: {
      ...
      experiences: [
        ...
        ['signature-day', 'En dag med Andy - Grupp', '€950 total'],
  ...
  zh: {
    ...
    form: {
      ...
      experiences: [
        ...
        ['signature-day', '与 Andy 共度一天 - 小组', '€950 total'],
