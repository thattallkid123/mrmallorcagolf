...
export const GOLF_COURSE_UI_TRANSLATIONS = {
  de: {
    ...
    quickPicks: ['Bester Platz: Son Gual','Schönster Platz: Alcanada','Bester in Spanien: Son Muntaner','Schwierigster: Golf de Andratx','Bester für Anfänger: Son Quint','Bestes Preis-Leistung: Golf Pollença','Bester Ostküste: Pula oder Canyamel'],
  ...
  es: {
    ...
    quickPicks: ['El mejor: Son Gual','El más pintoresco: Alcanada','El mejor de España: Son Muntaner','El más difícil: Golf de Andratx','El mejor para principiantes: Son Quint','El mejor precio: Golf Pollença','El mejor de la costa este: Pula o Canyamel'],
  ...
  fr: {
    ...
    quickPicks: ["Le meilleur : Son Gual","Le plus pittoresque : Alcanada","Le meilleur d'Espagne : Son Muntaner","Le plus difficile : Golf de Andratx","Le meilleur pour débutants : Son Quint","Le meilleur rapport qualité-prix : Golf Pollença","Le meilleur côte est : Pula ou Canyamel"],
  ...
  zh: {
    ...
    quickPicks: ['综合最佳：Son Gual','最美风景：Alcanada','西班牙最佳：Son Muntaner','难度最高：Golf de Andratx','最适合初学者：Son Quint','最具性价比：Golf Pollença','东海岸最佳：Pula或Canyamel'],
    ctaEyebrow: '想体验这些球场？',
  ...
  nl: {
    ...
    quickPicks: ['Beste overall: Son Gual','Mooiste: Alcanada','Beste van Spanje: Son Muntaner','Moeilijkste: Golf de Andratx','Beste voor beginners: Son Quint','Beste waarde: Golf Pollença','Beste oostkust: Pula of Canyamel'],
  ...
  sv: {
    ...
    quickPicks: ['Bäst totalt: Son Gual','Vackrast: Alcanada','Bäst i Spanien: Son Muntaner','Svårast: Golf de Andratx','Bäst för nybörjare: Son Quint','Bäst värde: Golf Pollença','Bäst östkust: Pula eller Canyamel'],
...
Object.assign(GOLF_COURSE_UI_TRANSLATIONS.zh, {
  ...
  geoP1: '这里一共有 24 座球场，从真正的巡回赛场地到更安静的小众好场都有。公开 18 洞果岭费现在大致在 55 到 252 EUR 之间，如果要做比较，应该以峰值价格为准。',
  geoP2: '最佳时间通常是 3 月中旬到 6 月初，以及 9 月中旬到 11 月中旬。如果更看重性价比，更好的窗口是 6 到 8 月或 12 到 2 月。',
  geoRegions: [
    {
      region: '帕尔马',
    ...
    {
      region: '北部',
      courses: 'Alcanada · Golf Pollença',
    },
  ],
})
...
export const GOLF_COURSE_REGION_HEADERS = {
  ...
  east: { title: 'East', subtitle: 'Worth basing yourself here', count: '5 courses' },
