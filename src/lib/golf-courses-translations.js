export const GOLF_COURSE_UI_TRANSLATIONS = {
  ...
  de: {
    ...
    sidebarP: 'Golftag, alles arrangiert, Coaching auf dem Platz. Son Gual und Alcanada sind die primären Venues.',
  ...
  es: {
    ...
    sidebarP: 'Día de golf, todo organizado, coaching en campo. Son Gual y Alcanada son los campos principales.',
    ...
    ctaH2: 'Día de golf, todo organizado, UK PGA profesional durante toda la jornada.',
  ...
  fr: {
    ...
    sidebarP: 'Journée de golf, tout organisé, coaching sur parcours. Son Gual et Alcanada sont les sites principaux.',
    ...
    ctaH2: "Journée de golf, tout organisé, UK PGA professionnel tout au long de la journée.",
  ...
  zh: {
    ...
    sidebarP: '高尔夫一日体验，全程安排妥当，并提供球场实战教学。Son Gual和Alcanada是主要场地。',
    sidebarBtn: '立即联系 →',
  ...
  nl: {
    ...
    sidebarP: 'Golfdag, alles geregeld, coaching op de baan. Son Gual en Alcanada zijn de primaire locaties.',
  ...
  sv: {
    ...
    sidebarP: 'Golfdag, allt ordnat, coaching på banan. Son Gual och Alcanada är de primära banorna.',
...
Object.assign(GOLF_COURSE_UI_TRANSLATIONS.zh, {
  ...
  sidebarP: '高尔夫日安排、全程打理，并为你选最适合的一座球场。',
  sidebarBtn: '联系我们 →',
  quickPicksTitle: '快速推荐',
  ctaEyebrow: '想打其中一座吗？',
  ctaH2: '从第一洞开始，我都会陪你一起打完整个高尔夫日。',
