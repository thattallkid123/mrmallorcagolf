...
export const PLAY_WITH_A_PRO_CONTENT = {
  en: {
    ...
    hero: {
      ...
      body: 'One course. A full day alongside a PGA Advanced Professional who has arranged everything. Solo from €495. Groups from €950. Green fees additional, confirmed when we speak.',
      price: null,
      ...
      tiers: [
        ...
        },
        {
          ...
          features: [
            ...
            'Green fees included',
            'Long lunch at the course restaurant included',
            'Private transfers included',
            'Caddy, videographer, or premium club hire available',
      ...
      tiers: [
        {
          ...
          price: null,
          note: 'Andys Tagessatz. Greenfees werden im Gespräch bestätigt.',
          features: [
            'Platz passend zu Ihrem Spiel und Handicap',
            'Startzeit gesichert und komplett organisiert',
            'Spielplan und Warm-up vor der Runde',
        ...
        },
        {
          ...
          name: 'Voller Tag',
          price: '€3.000+',
          note: 'Alles inklusive: Greenfees, Mittagessen, Transfers und Extras. Andy bestätigt den vollständigen Tagesplan im Voraus.',
          features: [
            'Platz, Startzeit und Coaching',
            'Greenfees inklusive',
            'Langes Mittagessen im Clubrestaurant inklusive',
            'Private Transfers inklusive',
            'Caddie, Videograf oder Premium-Schlägerverleih verfügbar',
            'Spa-Zugang und Concierge-Support verfügbar',
          ],
          button: 'Anfragen →',
          href: '/de/contact',
          featured: false,
      ...
      tiers: [
        {
          ...
          price: null,
          note: 'La tarifa del día de Andy. Green fees confirmados por separado cuando hablemos.',
          features: [
            'Campo elegido según su juego y su hándicap',
            'Hora de salida asegurada y completamente gestionada',
            'Plan de juego y calentamiento antes de la vuelta',
        ...
        },
        {
          ...
          name: 'Día completo',
          price: '€3.000+',
          note: 'Todo incluido: green fees, almuerzo, traslados y extras. Andy confirma el itinerario completo con usted de antemano.',
          features: [
            'Campo, hora de salida y coaching',
            'Green fees incluidos',
            'Almuerzo largo en el restaurante del club incluido',
            'Traslados privados incluidos',
            'Caddie, videógrafo o alquiler premium de palos disponibles',
            'Acceso a spa y soporte concierge disponibles',
          ],
          button: 'Consultar →',
          href: '/es/contact',
          featured: false,
      ...
      tiers: [
        {
          ...
          price: null,
          note: "Le tarif journée d'Andy. Green fees confirmés séparément lors de notre échange.",
          features: [
            'Parcours choisi selon votre jeu et votre index',
            'Heure de départ sécurisée et entièrement gérée',
            'Plan de jeu et échauffement avant la partie',
        ...
        },
        {
          ...
          price: '€3 000+',
          note: "Tout compris : green fees, déjeuner, transferts et extras. Andy confirme le programme complet avec vous à l'avance.",
          features: [
            'Parcours, heure de départ et coaching',
            'Green fees inclus',
            'Long déjeuner au restaurant du club inclus',
            'Transferts privés inclus',
            'Caddie, vidéaste ou location de clubs premium disponibles',
            'Accès spa et accompagnement conciergerie disponibles',
          ],
          button: 'Demander →',
          href: '/fr/contact',
          featured: false,
      ...
      tiers: [
        {
          ...
          price: null,
          note: "Andy's dagtarief. Greenfees apart bevestigd wanneer we spreken.",
          features: [
            'Baan gekozen op basis van uw spel en handicap',
            'Starttijd vastgelegd en volledig geregeld',
            'Spelplan en warming-up voor de ronde',
        ...
        },
        {
          ...
          name: 'Volledige dag',
          price: '€3.000+',
          note: 'Alles inbegrepen: greenfees, lunch, transfers en extras. Andy bevestigt het volledige programma vooraf met u.',
          features: [
            'Baan, starttijd en coaching',
            'Greenfees inbegrepen',
            'Uitgebreide lunch in het clubrestaurant inbegrepen',
            'Privétransfers inbegrepen',
            'Caddie, videograaf of premium clubverhuur beschikbaar',
            'Toegang tot spa en conciërgediensten beschikbaar',
          ],
          button: 'Aanvragen →',
          href: '/nl/contact',
          featured: false,
      ...
      tiers: [
        {
          ...
          price: null,
          note: 'Andys dagspris. Green fees bekräftas separat när vi pratar.',
          features: [
            'Bana vald efter ditt spel och handicap',
            'Starttid säkrad och helt ordnad',
            'Spelplan och uppvärmning före rundan',
        ...
        },
        {
          ...
          name: 'Hel dag',
          price: '€3 000+',
          note: 'Allt ingår: green fees, lunch, transfers och tillägg. Andy bekräftar hela programmet med dig i förväg.',
          features: [
            'Bana, starttid och coaching',
            'Green fees ingår',
            'Lång lunch i klubbrestaurangen ingår',
            'Privata transfers ingår',
            'Caddie, videograf eller premium klubbhyra tillgängligt',
            'Spa-tillgång och concierge-stöd tillgängligt',
          ],
          button: 'Förfrågan →',
          href: '/sv/contact',
          featured: false,
    ...
    packages: {
      tiers: [
        ...
        },
        {
          ...
          name: '全天尊享',
          price: '€3,000+',
          note: '全部包含：果岭费、午餐、接送及附加服务。Andy 提前与您确认完整行程安排。',
          features: [
            '球场、开球时间与全程指导',
            '果岭费已包含',
            '球场餐厅悠长午餐已包含',
