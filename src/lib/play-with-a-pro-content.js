  ...
  en: {
    ...
    packages: {
      ...
      tiers: [
        {
          ...
          name: 'Solo',
          price: '€495',
          note: "Andy's fixed day rate. Green fee confirmed separately.",
          features: [
        ...
        },
        {
          ...
          name: 'Group',
          price: '€950',
          note: 'Andy\'s fixed day rate for 2 or 3 golfers. Green fees confirmed separately.',
          features: [
        ...
        },
        {
          ...
          name: 'Full Day',
          price: '€3,000+',
          note: 'Everything arranged. From course to caddy to Michelin lunch to transfers. Fully bespoke.',
          features: [
      ...
      multiDay: {
        ...
        title: 'The Signature Experience - a multi-day golf journey.',
        body: 'Two or three consecutive days across Mallorca\'s finest courses - Son Gual, Alcanada, and beyond - with private transfers, handpicked dining, and access to members-only courses most visitors cannot book. From €3,000+ for a full custom itinerary.',
