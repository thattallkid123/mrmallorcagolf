...
const PLAY_WITH_A_PRO_AUDIT_OVERRIDES = {
  de: {
    ...
    packages: {
      ...
      body: 'Beide Varianten sind privat, werden von mir begleitet und auf einem der besten Plätze der Insel gespielt. Solo ist alles inklusive. Gruppen von 2 oder 3 zahlen einen festen Tagessatz, Greenfees werden separat bestätigt.',
      tiers: [
        {
          eyebrow: 'Solo',
  ...
  es: {
    ...
    packages: {
      ...
      body: 'Ambas son privadas, me tienen a mí como anfitrión y se juegan en uno de los mejores campos de la isla. Solo. Green fees adicionales. Los grupos de 2 o 3 pagan una tarifa fija por el día, con los green fees confirmados por separado.',
      tiers: [
        {
          eyebrow: 'Solo',
          name: 'A Day With Andy',
  ...
  fr: {
    ...
    packages: {
      ...
      body: "Les deux formats sont privés, organisés avec moi et joués sur l'un des plus beaux parcours de l'île. En solo, tout est compris. Les groupes de 2 ou 3 paient un tarif fixe pour la journée, avec les green fees confirmés séparément.",
      tiers: [
        {
          eyebrow: 'Solo',
          name: 'A Day With Andy',
  ...
  nl: {
    ...
    packages: {
      ...
      body: 'Beide zijn privé, worden door mij begeleid en gespeeld op een van de beste banen van het eiland. Solo is inclusief greenfee en lunch. Groepen van 2 of 3 betalen één vaste dagprijs, met greenfees die apart worden bevestigd.',
      tiers: [
        {
          eyebrow: 'Solo',
          name: 'A Day With Andy',
  ...
  sv: {
    ...
    packages: {
      ...
      body: 'Båda alternativen är privata, leds av mig och spelas på en av öns bästa banor. Solo inkluderar greenfee och lunch. Grupper på 2 eller 3 betalar ett fast dagspris, med green fees som bekräftas separat.',
      tiers: [
        {
          eyebrow: 'Solo',
          name: 'A Day With Andy',
  ...
  zh: {
    ...
    packages: {
      title: '两种安排这一天的方式。',
      body: '两种方案都是私人的，也都由我亲自陪同，地点会是岛上最好的球场之一。单人方案为全包。2 或 3 人的小组按固定日费计价，果岭费另行确认。',
      tiers: [
        {
          eyebrow: '单人',
          name: 'A Day With Andy',
