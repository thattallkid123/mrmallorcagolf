...
export const PLAY_WITH_A_PRO_CONTENT = {
  en: {
    ...
    included: {
      ...
      items: [
        ['Course selection', 'I match the course to your game, handicap, and what you want from the day. I recommend, you confirm.'],
        ['Tee time', 'Secured and fully handled before you arrive. You just show up.'],
        ['Pre-round briefing', 'What to expect from the course, the holes that matter, and what I will be watching for in your game.'],
