    ...
    packages: {
      ...
      tiers: [
        ...
        applyTierFlags({
          ...
          name: 'Signature Day',
          price: '€3,000+',
          note: 'Personalised from the ground up. Transfers, golf physio with John Brazier, hotel dinner, and other add-ons confirmed before the day.',
          features: [
            'Course, tee time, and full hosted golf day with Andy',
            'Golf physio with John Brazier — The Golf Doctor',
            'Private transfers to and from the course',
            'Evening dinner at a partner hotel — coordinated with concierge',
          ],
          button: 'Enquire →',
          href: '/contact',
