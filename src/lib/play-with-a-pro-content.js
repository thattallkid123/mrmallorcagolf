...
export const PLAY_WITH_A_PRO_CONTENT = {
  en: {
    ...
    finalCta: {
      ...
      title: "Tell me the trip you are building and I'll tell you where this fits.",
      body: "Send dates, group size, handicap range, and the courses you are considering. If a Play With A Pro day makes sense, I will recommend the right course and format.",
      primaryCta: 'Add this to my trip →',
      primaryHref: '/contact',
