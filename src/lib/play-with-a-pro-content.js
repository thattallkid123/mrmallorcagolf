...
export const PLAY_WITH_A_PRO_CONTENT = {
    ...
    packages: {
      ...
      tiers: [
        ...
        applyTierFlags({
          ...
          features: [
            'Course, tee time, and full hosted golf day with Andy',
  ...
  fr: {
    ...
    faq: {
      ...
      items: [
        { q: 'Proposez-vous des cours pour grands débutants ?', a: 'Oui. Toutes mes sessions se déroulent sur le parcours, pas sur le practice. Avec de bons par 3 et des parcours courts à Mallorca, les débutants peuvent jouer au vrai golf dès le départ et voir les compétences qu\'ils doivent développer.' },
        ...
        { q: 'Où se déroulent exactement les sessions à Mallorca ?', a: 'Sur des parcours à travers l\'île, choisis selon votre jeu. Quand vous prenez contact, nous choisissons ensemble la meilleure option pour votre niveau et vos objectifs.' },
        { q: 'Dans quelles langues enseignez-vous ?', a: 'Anglais et mandarin. Mon espagnol est en cours, mais Mallorca est un bon endroit pour pratiquer les deux.' },
        ...
        { q: 'Que se passe-t-il s\'il pleut ?', a: 'Mallorca bénéficie de plus de 300 jours de soleil par an, donc cela arrive rarement. Si une session est annulée pour cause de pluie, nous la reportons sans frais supplémentaires.' },
      ],
    },
    finalCta: {
