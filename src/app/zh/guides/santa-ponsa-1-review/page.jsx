...
{
  "type": "paragraph",
  "text": "Santa Ponsa 1是Santa Ponsa球场群中唯一对公众开放的球场，也是其中真正拥有欧洲巡回赛资历的一座。它曾举办2021年DP World Tour Mallorca Golf Open。这座球场在中断十年之后，把顶级职业高尔夫重新带回了马略卡。最终冠军Jeff Winther在前两轮两次打出62杆。球场完全承受住了那个级别的比赛。"
},
{
  "type": "heading",
...
{
  "type": "paragraph",
  "text": "球车：18洞EUR 43。球杆租赁：EUR 40。球场对公众开放，可直接预订，不需要会员资格。旺季建议尽早订位；DP World Tour的背景会吸引那些真正懂这座球场价值的访客。"
},
{
  "type": "heading",
  "text": "结论"
