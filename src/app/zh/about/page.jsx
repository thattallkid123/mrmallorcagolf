    ...
    <PageLayout lang="zh">
      ...
      <div className="story">
        <main className="story__main">
          <div className="chapter reveal">
            ...
            <h2>跟随两大洲最优秀的教练。</h2>
            <p>我自幼打高尔夫，差点曾达到+1，但很早便知道教练才是我的方向。在伯明翰大学完成高尔夫管理学专业学习、取得PGA职业资格后，我开始追随欧洲��北美最有经验的教练，逐步构建自己的职业生涯。</p>
          ...
          <div className="chapter reveal">
            ...
            <p>十一年后，我实现了当初来此的目标。2023年，我的第一个女儿出生。回�家乡的渴望，以及构建属于自己事业的机会，已无法再被忽视。</p>
          </div>
          <div className="chapter reveal">
        ...
        <aside className="story__sidebar">
          <div className="creds reveal">
            ...
            <ul className="cred-list">
              <li key={0} className="cred-item"><span className="cred-check">&#10003;</span><span className="cred-text"><strong>PGA高级职业教练（英国）</strong>英国高尔夫教练最高资质</span></li>
              ...
              <li key={4} className="cred-item"><span className="cred-check">&#10003;</span><span className="cred-text"><strong>美国�少年高尔夫Top 50</strong>全球教练</span></li>
              ...
              <li key={6} className="cred-item"><span className="cred-check">&#10003;</span><span className="cred-text"><strong>中国国家队</strong>精英�少年与竞技教练</span></li>
              <li key={7} className="cred-item"><span className="cred-check">&#10003;</span><span className="cred-text"><strong>数亿次��放量</strong>抖音高尔夫教学内容</span></li>
          ...
          <div className="sidebar-cta reveal">
            <h3>与我同游马略卡岛最佳球场。</h3>
            <p>在Son Gual、Alcanada等球场的私人专属日。全程安�，球场实地指导。</p>
      ...
      <section className="cta-final">
        <div className="cta-final__left reveal">
          ...
          <h2 className="serif-display" style={{color:'#fff'}}>PGA高级职业教练。卓越的高尔夫之岛。您的球局。</h2>
          <p>告诉我您的日期、差点��期望。我将围绕您来规�这一天。</p>
        </div>
