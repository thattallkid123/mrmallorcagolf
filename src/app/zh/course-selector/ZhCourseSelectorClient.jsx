...
const COURSES = [
  ...
  { id:'palma-pitch-putt', en:'Palma Pitch & Putt', zhDesc:'帕尔马市中心 · 初学者和儿童入门', region:'palma', regionZh:'帕尔马市中心', level:1, budget:1, difficulty:'2/10 · Par 27，9洞', price:'参考范围 €20–€30（约 ¥155–¥235）', tags:['easy','family','firsttime'], photoUrl:'/images/courses/palma-pitch-putt.webp', photoAlt:'Palma Pitch & Putt beginner course', forWho:'完全初学者、儿童、或非打球伴侣想试试高尔夫。', why:'岛上唯一官方 pitch & putt。9洞，Par 27，638 米总长。所有洞都是 Par 3，距离 50–100 米，考验精准而不是力量。€20（9洞）或 €30（18洞）。有球杆租赁。', photo:'初学者首选 · 儿童适合 · 非常便宜', andy:'如果有非打球的人想体验高尔夫，或者孩子想学，这是完美的起点。无压力，真实比赛。', article:'/zh/guides/palma-pitch-putt' },
]
