...
export default function ContactForm_ES() {
  const { error, form, handleChange, handleSubmit, submitted, submitting } = useContactFormSubmission('es')
          ...
          <>
            ...
            <form onSubmit={handleSubmit} aria-busy={submitting}>
              ...
              <div className="form-submit">
                <button type="submit" className="btn-submit" disabled={submitting}>Enviar consulta &rarr;</button>
