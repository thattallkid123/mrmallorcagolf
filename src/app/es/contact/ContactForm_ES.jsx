    ...
    <div className="contact-wrap">
      <div className="contact-left">
        ...
        <div className="contact-details">
          ...
          <div className="contact-detail"><span className="contact-detail__label">Ubicacion</span><a href="https://maps.google.com/?q=Mallorca,Spain" target="_blank" rel="noopener noreferrer" className="contact-detail__value" style={{color:"inherit",textDecoration:"none"}}>Mallorca, España ↗</a></div>
        </div>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="form-group">
                ...
                <select name="experience" className="form-control" value={form.experience} onChange={handleChange}>
                  ...
                  <option value="mallorca-round">La Ronda Mallorca — €350 p.p. + tarifa green</option>
                  <option value="signature-day">El Día Signature — Desde €450 p.p. + tarifa green</option>
                  <option value="full-experience">La Experiencia Completa — A consultar</option>
                  <option value="not-sure">Aún no lo sé — recomiéndame</option>
                </select>
              </div>
              ...
              <div className="form-submit">
                ...
                <p className="form-note">Sin respuestas automáticas. Leo cada mensaje personalmente.</p>
              </div>
            </form>
          </>
        )}
