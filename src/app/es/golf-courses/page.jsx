...
export const metadata = {
  title: 'Guia de Golf en Mallorca 2026 â€” Todos los campos de la isla',
  description: 'La guia completa del golf en Mallorca â€” 22 campos, green fees, dificultades y recomendaciones honestas de un PGA profesional en la isla.',
...
export default function GolfCourses_ES() {
  ...
  backgroundPosition: 'center, center 40%',
        ...
        <div className="page-hero__inner">
          ...
          <h1>Golf en Mallorca 2026 â€”<br />La Guia del Experto</h1>
          <div className="page-hero__meta">
            <span className="page-hero__tag">22 campos</span>
            <span className="page-hero__tag">Green Fees 2026</span>
            <span className="page-hero__tag page-hero__tag--gold">â˜… Resenas de experto de primera mano</span>
