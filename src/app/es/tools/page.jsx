...
export const metadata = buildPageMetadata('/tools', 'es', {
  title: 'Herramientas gratuitas de planificación de golf en Mallorca | Mr Mallorca Golf',
...
const TOOLS = [
  {
    ...
    eyebrow: 'Búsqueda de campo',
    title: 'Encuentra tu campo de golf en Mallorca',
  ...
  },
  {
    ...
    eyebrow: 'Comparación de campos',
    title: 'Compara los 24 campos',
  ...
  },
  {
    ...
    eyebrow: 'Planificación del día',
    title: 'Constructor de día de golf',
