      ...
      <div className="legal-page">
        <div className="legal-page__inner">
          ...
          <section className="legal-section">
            ...
            <p>Para cualquier consulta sobre protección de datos, contacta con nosotros en: <a href="mailto:info@mrmallorcagolf.com">info@mrmallorcagolf.com</a></p>
          </section>
          ...
          <section className="legal-section">
            ...
            <p>No utilizaremos tus datos para comunicaciones comerciales no solicitadas sin tu consentimiento expreso. Si te suscribes para recibir resultados del Course Selector o notas por email, podrás darte de baja en cualquier momento desde el propio correo o escribiéndonos directamente.</p>
          </section>
          ...
          <section className="legal-section">
            ...
            <p>Para ejercer cualquiera de estos derechos, escríbenos a <a href="mailto:info@mrmallorcagolf.com">info@mrmallorcagolf.com</a>. Responderemos en un plazo de 30 días.</p>
          </section>
