      ...
      <div className="legal-page">
        <div className="legal-page__inner">
          ...
          <section className="legal-section">
            ...
            <p>Este sitio web es operado por Andy Griffiths, con actividad bajo el nombre comercial <strong>Mr Mallorca Golf</strong>, con domicilio en Mallorca, Espana.</p>
            <p>Para cualquier consulta sobre proteccion de datos, contacta con nosotros en: <a href="mailto:info@mrmallorcagolf.com">info@mrmallorcagolf.com</a></p>
          </section>
          ...
          <section className="legal-section">
            ...
            <ul>
              ...
              <li>Comunicarnos contigo en relacion con tu reserva o visita prevista</li>
              <li>Enviar resultados del Course Selector y emails de seguimiento cuando te hayas suscrito expresamente</li>
              <li>Mejorar nuestros servicios a partir de patrones de uso generales (solo analitica)</li>
            </ul>
            <p>No utilizaremos tus datos para comunicaciones comerciales no solicitadas sin tu consentimiento expreso. Si te suscribes para recibir resultados del Course Selector o notas por email, podras darte de baja en cualquier momento desde el propio correo o escribiendonos directamente.</p>
          </section>

          <section className="legal-section">
            <h2>4. Base juridica del tratamiento</h2>
            <p>Tratamos tus datos personales sobre las siguientes bases juridicas conforme al RGPD y la Ley Organica de Proteccion de Datos y Garantia de los Derechos Digitales (LOPDGDD):</p>
            <ul>
              <li><strong>Ejecucion de un contrato:</strong> para gestionar o preparar una reserva en respuesta a tu consulta</li>
              <li><strong>Interes legitimo:</strong> para responder a tus mensajes y gestionar nuestras operaciones comerciales</li>
          ...
          <section className="legal-section">
            ...
            <p>De conformidad con el RGPD y la legislacion espanola de proteccion de datos, tienes los siguientes derechos:</p>
            <ul>
              ...
              <li><strong>Supresion:</strong> solicitar la eliminacion de tus datos personales (&ldquo;derecho al olvido&rdquo;)</li>
              <li><strong>Limitacion:</strong> solicitar que restrinjamos el uso de tus datos</li>
              <li><strong>Portabilidad:</strong> recibir tus datos en un formato estructurado y de uso comun</li>
              <li><strong>Oposicion:</strong> oponerte al tratamiento basado en intereses legitimos</li>
            </ul>
            <p>Para ejercer cualquiera de estos derechos, escribenos a <a href="mailto:info@mrmallorcagolf.com">info@mrmallorcagolf.com</a>. Responderemos en un plazo de 30 dias.</p>
          </section>
