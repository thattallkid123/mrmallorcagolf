...
export const metadata = {
  title: 'Guía de Golf en Mallorca — Campos, Consejos y Reseñas Honestas',
  description: 'Guías honestas sobre el golf en Mallorca por un PGA profesional. Campos, green fees, planificación de viaje y mejor época — actualizado para 2026.',
    ...
    <PageLayout lang="es">
      ...
      <header className="page-hero">
        <div className="page-hero__inner">
          ...
          <p style={{fontSize:'1rem',fontWeight:300,color:'rgba(255,255,255,.6)',lineHeight:1.8,maxWidth:540,marginTop:'1rem'}}>Reseñas de campos, planificación de viajes, green fees y cuándo venir — escritas por un PGA profesional que juega aquí cada semana.</p>
          <div className="page-hero__meta" style={{marginTop:'1.5rem'}}>
            <span className="page-hero__tag">8 Guías</span>
      ...
      <section style={{maxWidth:860,margin:'0 auto',padding:'clamp(48px,8vw,96px) clamp(20px,4vw,40px)'}}>
        <p style={{fontSize:'0.875rem',fontWeight:300,color:'var(--taupe)',fontStyle:'italic',marginBottom:'2rem',paddingBottom:'1.5rem',borderBottom:'1px solid var(--linen)'}}>(Estas guías están escritas en inglés — la información más completa para golfistas en la isla.)</p>
      ...
      <section className="cta-final">
        <div className="cta-final__left reveal">
          ...
          <h2 className="serif-display" style={{color:'#fff'}}>Una vuelta privada en uno de estos campos con un PGA profesional a su lado.</h2>
