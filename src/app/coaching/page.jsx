...
export const metadata = {
  title: 'On-Course Golf Coaching in Mallorca â€” PGA Professional',
  description: 'On-course golf coaching in Mallorca with PGA Advanced Professional Andy Griffiths. Real improvement in real conditions â€” for visiting and resident golfers.',
  alternates: {
...
const improvements = [
  { num: '01', title: 'Course management', text: 'Most amateur golfers lose the majority of their shots to the wrong decision, not the wrong swing. Choosing the right club, target, shape â€” these separate a 90 from an 80. We work on them in real time, on real holes, with a real score at stake.' },
  { num: '02', title: 'Shot selection under pressure', text: "The decisions that fall apart under pressure â€” the driver when a 5-iron wins the hole, the hero shot when the safe play scores the same â€” become visible on the course in a way they never do on a range. I see them, name them, and we work through them together." },
  { num: '03', title: 'Reading greens and slopes', text: 'Putting and chipping on a course green is fundamentally different from a practice green. The speed, the slope, the grain, the pressure of the moment â€” all of it changes what works. We practise it in the actual conditions.' },
  { num: '04', title: 'Playing in wind', text: "Mallorca is windy. Son Gual especially lives in its own wind ecosystem. Club selection in a crosswind, trajectory management, trusting your aim when the ball seems to be drifting â€” this is something you can only work on when it's actually blowing." },
  { num: '05', title: 'Mental game and routine', text: 'How you talk to yourself after a bad shot. How you approach the next tee. Whether you have a pre-shot routine and whether it holds under pressure. The mental side is completely invisible on the range â€” it only shows up when the consequences are real.' },
  ...
  { num: '07', title: 'Consistency in real conditions', text: "Uneven lies, tight fairways, course rough â€” the course demands shots the range never asks for. Playing them regularly, with feedback in real time, is how you build a game that shows up when it counts.", full: true },
]
    ...
    <PageLayout>
      ...
      <header className="page-hero coaching-hero" style={{
        ...
        <div className="page-hero__inner">
          ...
          <p style={{fontSize:'1rem',fontWeight:300,color:'rgba(255,255,255,.6)',lineHeight:1.8,maxWidth:560,marginTop:'1rem'}}>On-course coaching for visiting and resident golfers. Real conditions, real decisions, real improvement â€” and none of the technical overload that leaves most range sessions unused by the 3rd hole.</p>
        </div>
      </header>
      ...
      <section className="range-section">
        <div className="reveal">
          ...
          <p>On-course coaching puts the lesson where it actually helps. On the fairway. In the rough. On a sloping lie with a wind you didn&apos;t expect. With a score that matters. That&apos;s where games change â€” and that&apos;s where we work.</p>
        ...
        <div className="reveal">
          ...
          <p>By the time we reach the first tee, I already have a picture of what to look for. The feedback is situational and honest â€” not a generic lesson plan applied to everyone.</p>
      ...
      <section className="how-section">
        <div className="reveal">
          ...
          <p>Sessions take place on-course at Son Gual, Alcanada, or a course matched to your level and goals. We play together, the coaching happens in real time, and the feedback is situational and honest â€” not a generic lesson plan applied to everyone.</p>
        </div>
        <div className="how-steps reveal">
          {[
            ...
            { num: '02', title: 'The round', text: "We play together. Coaching happens in real time â€” the right observation at the right moment. Not a running commentary. Not a lesson. The thing that changes your score." },
      ...
      <section className="who-section">
        ...
        <div className="who-grid">
          {[
            { title: 'Visiting golfers', text: 'Focused improvement during your time on the island â€” not just a round.' },
      ...
      <section className="cta-final">
        <div className="cta-final__left reveal">
          ...
          <p>Tell me where your game is and what you want from it. I&apos;ll build the session around that â€” not a generic programme.</p>
        </div>
