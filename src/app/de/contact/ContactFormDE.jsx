    ...
    <div className="contact-wrap">
      <div className="contact-left">
        ...
        <div className="contact-details">
          ...
          <div className="contact-detail"><span className="contact-detail__label">Standort</span><a href="https://maps.google.com/?q=Mallorca,Spain" target="_blank" rel="noopener noreferrer" className="contact-detail__value" style={{color:"inherit",textDecoration:"none"}}>Mallorca, Spanien ↗</a></div>
        </div>
        ...
        {submitted ? (
          ...
          <>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="form-group">
                <label>Welche Erfahrung interessiert Sie?</label>
                <select name="experience" className="form-control" value={form.experience} onChange={handleChange}>
                  <option value="">Auswählen</option>
                  <option value="mallorca-round">Die Mallorca-Runde — €350 p.P. + Green Fee</option>
                  <option value="signature-day">Der Signature-Tag — Ab €450 p.P. + Green Fee</option>
                  <option value="full-experience">Das Gesamterlebnis — Auf Anfrage</option>
                  <option value="not-sure">Noch nicht sicher — bitte empfehlen</option>
                </select>
              </div>
              ...
              <div className="form-submit">
                ...
                <p className="form-note">Keine automatischen Antworten. Ich lese jede Nachricht persönlich.</p>
              </div>
            </form>
          </>
        )}
