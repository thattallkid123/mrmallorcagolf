...
export const metadata = buildPageMetadata('/tools', 'de', {
  title: 'Kostenlose Mallorca Golf Planungstools | Mr Mallorca Golf',
...
const TOOLS = [
  {
    ...
    eyebrow: 'Golfplatz-Auswahl',
    title: 'Finde deinen Mallorca-Golfplatz',
  ...
  },
  {
    ...
    eyebrow: 'Golfplatz-Vergleich',
    title: 'Vergleiche alle 24 Golfplätze',
