...
export const metadata = {
  title: 'Mallorca Golf Guide — Plätze, Tipps und ehrliche Bewertungen',
  description: 'Ehrliche Golfrategeber für Mallorca von einem PGA Professional. Plätze, Greenfees, Reiseplanung und Besuchszeiten — aktualisiert für 2026.',
    ...
    <PageLayout lang="de">
      ...
      <header className="page-hero">
        <div className="page-hero__inner">
          ...
          <p style={{fontSize:'1rem',fontWeight:300,color:'rgba(255,255,255,.6)',lineHeight:1.8,maxWidth:540,marginTop:'1rem'}}>Platz-Bewertungen, Reiseplanung, Greenfees und die beste Reisezeit — geschrieben von einem PGA Professional, der hier jede Woche spielt.</p>
          <div className="page-hero__meta" style={{marginTop:'1.5rem'}}>
            <span className="page-hero__tag">8 Ratgeber</span>
      ...
      <section style={{maxWidth:860,margin:'0 auto',padding:'clamp(48px,8vw,96px) clamp(20px,4vw,40px)'}}>
        <p style={{fontSize:'0.875rem',fontWeight:300,color:'var(--taupe)',fontStyle:'italic',marginBottom:'2rem',paddingBottom:'1.5rem',borderBottom:'1px solid var(--linen)'}}>(Diese Ratgeber sind auf Englisch verfasst — die umfassendsten Informationen für Golfspieler auf der Insel.)</p>
      ...
      <section className="cta-final">
        ...
        <div className="cta-final__right reveal">
          <Link href="/de/play-with-a-pro" className="btn btn--gold" style={{fontSize:10,padding:'14px 36px'}}>Die Erlebnisse entdecken {">"}</Link>
