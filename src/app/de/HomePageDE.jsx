    ...
    <>
      <section className="hero">
        ...
        <div className="hero__content">
          ...
          <h1 className="serif-display hero__title">
            Spielen Sie Mallocas beste<br />Golfplätze.<br />
            <em style={{fontStyle:'italic',fontWeight:400,opacity:0.85}}>Mit einem Profi an Ihrer Seite.</em>
          </h1>
          <div className="hero__actions">
            <Link href="/de/contact" className="btn btn--gold">Buchen Sie Ihren Tag</Link>
            <a href="#courses" className="btn btn--outline-white">Kurse erkunden</a>
          </div>
        </div>
        <div className="hero__trust">
          ...
          <p className="hero__trust-line"><em>18 Jahre Golfunterricht</em></p>
      ...
      <section className="courses" id="courses">
        <div className="courses__header">
          <div className="courses__header-left">
            ...
            <h2 className="serif-display">Los mejores Golfplätze — jugados y valorados.</h2>
          </div>
        ...
        <div className="courses__track" ref={trackRef} onMouseDown={onMouseDown} onMouseLeave={onMouseLeave} onMouseUp={onMouseUp} onMouseMove={onMouseMove}>
          {courses.map((c, i) => (
            <article key={i} className={`course-card ${c.cls}`} onClick={() => router.push('/de/golf-courses')} style={{cursor:'pointer'}}>
        ...
        <div style={{textAlign:'center',marginTop:'2.5rem'}}>
          <Link href="/de/golf-courses" className="btn btn--dark">Ver los 22 campos →</Link>
        </div>
      </section>
      ...
      <section className="what">
        <div className="what__left reveal">
          ...
          <Link href="/de/play-with-a-pro" className="btn btn--dark">Ver las experiencias</Link>
        </div>
      ...
      <section className="packages">
        ...
        <div className="packages__grid">
          <div className="package reveal">
            ...
            <Link href="/de/contact" className="btn btn--dark">Consultar</Link>
          </div>
          <div className="package package--featured reveal reveal-delay-1">
            ...
            <Link href="/de/contact" className="btn btn--gold">Consultar</Link>
          </div>
      ...
      <section className="cta-final">
        ...
        <div className="cta-final__right reveal reveal-delay-1">
          ...
          <Link href="/de/contact" className="btn btn--gold" style={{fontSize:11,padding:'15px 36px',letterSpacing:'0.18em'}}>Buchen Sie Ihren Tag</Link>
