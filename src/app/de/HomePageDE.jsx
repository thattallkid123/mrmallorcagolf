    ...
    <>
      ...
      <section style={{background:'var(--deep)',borderTop:'1px solid rgba(255,255,255,0.06)',padding:'1.5rem clamp(20px,5vw,60px)'}}>
        <p style={{textAlign:'center',fontSize:'0.85rem',color:'rgba(255,255,255,0.4)',fontFamily:"'Jost',sans-serif",fontWeight:300,lineHeight:1.6}}>
          Andy 教练 &nbsp;·&nbsp; 300 Millionen+ Golfcoaching-Videoaufrufe auf TikTok &nbsp;·&nbsp; Coaching-Inhalte weltweit vertraut
        </p>
      </section>
      ...
      <section className="how">
        ...
        <div className="how__steps">
          ...
          <div className="how__step reveal reveal-delay-2"><span className="how__num">03</span><h3>Ankommen und spielen</h3><p>Ihre einzige Aufgabe ist es, die Runde zu genießen. Und besser zu spielen als erwartet.</p></div>
                  ...
                  {/* Die meisten Golfplätze in Europa schließen im Winter. Mallorca nicht. Im Januar sind die Fairways hier makellos.LACEHOLDER */}
      <section style={{background:'var(--deep)',padding:'clamp(60px,8vw,96px) clamp(20px,5vw,60px)'}}>
        <div style={{maxWidth:1200,margin:'0 auto',display:'grid',gridTemplateColumns:'repeat(auto-fit,minmax(280px,1fr))',gap:'clamp(40px,6vw,80px)',alignItems:'center'}}>
          <div>
            ...
            <h2 className="serif-display" style={{color:'#fff',fontSize:'clamp(1.5rem,4vw,2.6rem)',marginBottom:'1.5rem'}}>Mallorca hat European Tour-Plätze. Viele Besucher spielen ein paar und fragen sich, was sie verpasst haben.</h2>
            <p style={{fontSize:'0.95rem',color:'rgba(255,255,255,0.55)',lineHeight:1.85}}>Die meisten Golfplätze in Europa schließen im Winter. Mallorca nicht. Im Januar sind die Fairways hier makellos.</p>
          </div>
          <div style={{display:'flex',flexDirection:'column',gap:0}}>
            {[['22','Plätze auf der Insel'],['300+','Sonnentage pro Jahr'],['Jan–Dez','Ganzjährige Saison']].map(([num,label],i) => (
...
<section className="courses">
        ...
        <div className="courses__track" ref={trackRef} onMouseDown={onMouseDown} onMouseLeave={onMouseLeave} onMouseUp={onMouseUp} onMouseMove={onMouseMove}>
          {courses.map((c, i) => (
            <Link key={i} href="/de/golf-courses" style={{textDecoration:'none',display:'block'}}><article className={`course-card ${c.cls}`}>
        ...
        <div style={{textAlign:'center',marginTop:'2.5rem'}}>
          <Link href="/de/golf-courses" className="btn btn--dark">Alle 22 Plätze ansehen →</Link>
        </div>
      </section>
