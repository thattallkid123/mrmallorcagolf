    ...
    <div className="contact-wrap">
      <div className="contact-left">
        ...
        <div className="contact-details">
          ...
          <div className="contact-detail"><span className="contact-detail__label">Gevestigd</span><a href="https://maps.google.com/?q=Mallorca,Spain" target="_blank" rel="noopener noreferrer" className="contact-detail__value" style={{color:"inherit",textDecoration:"none"}}>Mallorca, Spanje ↗</a></div>
        </div>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="form-group">
                ...
                <select name="experience" className="form-control" value={form.experience} onChange={handleChange}>
                  ...
                  <option value="not-sure">Nog niet zeker — adviseer mij</option>
                </select>
              </div>
              ...
              <div className="form-submit">
                ...
                <p className="form-note">Geen automatische antwoorden. Ik lees elk bericht persoonlijk.</p>
              </div>
            </form>
          </>
        )}
