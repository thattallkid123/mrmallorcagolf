...
export default function ContactForm_NL() {
  const { error, form, handleChange, handleSubmit, submitted, submitting } = useContactFormSubmission('nl')
      ...
      <div className="contact-left">
        ...
        <div className="contact-cards">
          ...
          <div className="contact-card contact-card--info">
            <span className="contact-card__icon">⏱</span>
            <div>
              <p className="contact-card__label">Reactietijd</p>
              <p className="contact-card__value">Binnen 24 uur — meestal eerder</p>
            </div>
          </div>
          <a href="https://maps.google.com/?q=Mallorca,Spain" className="contact-card" target="_blank" rel="noopener noreferrer">
            <span className="contact-card__icon">📍</span>
            <div>
              <p className="contact-card__label">Gevestigd in</p>
              <p className="contact-card__value">Mallorca, Spanje</p>
            </div>
          </a>
        </div>
          ...
          <>
            ...
            <form onSubmit={handleSubmit} aria-busy={submitting}>
              ...
              <div className="form-submit">
                <button type="submit" className="btn-submit" disabled={submitting}>Aanvraag versturen &rarr;</button>
