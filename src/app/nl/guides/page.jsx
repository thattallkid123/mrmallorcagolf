...
export const metadata = {
  ...
  description: 'Eerlijke golfgidsen voor Mallorca door een PGA professional. Baanbeoordelingen, greenfees en reisplanning â€” bijgewerkt 2026.',
    ...
    <PageLayout lang="nl">
      ...
      <header className="page-hero">
        <div className="page-hero__inner">
          ...
          <p style={{fontSize:'1rem',fontWeight:300,color:'rgba(255,255,255,.6)',lineHeight:1.8,maxWidth:540,marginTop:'1rem'}}>Baanbeoordelingen, reisplanning en greenfees â€” geschreven door een PGA professional die hier elke week speelt.</p>
      ...
      <section style={{maxWidth:860,margin:'0 auto',padding:'clamp(48px,8vw,96px) clamp(20px,4vw,40px)'}}>
        ...
        <Link href="/nl/guides/son-gual-review" className="reveal" style={{display:'block',textDecoration:'none',borderBottom:'1px solid var(--linen)',padding:'32px 0'}}>
          ...
          <h2 style={{fontFamily:"'Cormorant Garamond',serif",fontSize:'clamp(1.2rem,2vw,1.5rem)',fontWeight:500,color:'var(--deep)',lineHeight:1.25,margin:'14px 0 10px'}}>Son Gual Golf Mallorca â€” Eerlijke Recensie van een PGA Professional (2026)</h2>
          <p style={{fontSize:'0.95rem',fontWeight:300,color:'var(--taupe)',lineHeight:1.75,margin:'0 0 12px',maxWidth:640}}>Mijn meest gespeelde baan op het eiland. De wind, de greens, de slotholes â€” en waarom Obama en Nadal blijven terugkomen.</p>
          <p style={{fontSize:'9px',letterSpacing:'.1em',textTransform:'uppercase',fontFamily:"'Jost',sans-serif",color:'var(--stone)'}}>Kampioenschap Â· Par 72 Â· â‚¬80â€“165 Â· Handicapcertificaat vereist</p>
        </Link>
        ...
        <div style={{marginTop:'3rem',padding:'2rem',background:'var(--cream)',border:'1px solid var(--linen)'}}>
          ...
          <p style={{fontSize:'0.95rem',fontWeight:300,color:'var(--taupe)',lineHeight:1.8,margin:0}}>Ik speel momenteel elke golfbaan op het eiland. Elke recensie verschijnt na het gespeeld te hebben â€” eerlijke beoordelingen, geen brochures. De volgende gidsen verschijnen in de komende weken.</p>
        </div>
      ...
      <section className="cta-final">
        <div className="cta-final__left reveal">
          ...
          <h2 className="serif-display" style={{color:'#fff'}}>Een privÃ©ronde op een van deze banen met een PGA professional aan uw zijde.</h2>
