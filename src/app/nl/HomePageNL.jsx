...
const faqs = [
  { q: 'Moet ik een goede golfer zijn?', a: 'Helemaal niet. De ervaring past zich aan uw niveau aan — beginners en scratch-golfers profiteren evenzeer van de dag. De enige vereiste is het verlangen naar een echt ander golferlevenis.' },
    ...
    <>
      ...
      <section className="hero">
        ...
        <div className="hero__content">
          ...
          <h1 className="serif-display hero__title">
            Speel de beste<br />banen van Mallorca.<br />
            <em style={{fontStyle:'italic',fontWeight:400,opacity:0.85}}>Met een pro aan uw zijde.</em>
          </h1>
          <div className="hero__actions">
            <Link href="/nl/contact" className="btn btn--gold">Boek uw dag</Link>
            <a href="#courses" className="btn btn--outline-white">Verken banen</a>
          </div>
        </div>
        <div className="hero__trust">
          ...
          <p className="hero__trust-line"><em>18 jaar golfcoaching</em></p>
      ...
      <section className="intro reveal">
        <div className="intro__left">
          <p className="eyebrow" style={{color:'rgba(255,255,255,0.35)',marginBottom:'1rem'}}>Wat maakt dit bijzonder</p>
          ...
          <p style={{fontSize:'1rem',color:'rgba(255,255,255,0.65)',lineHeight:1.85}}>
            Een privédag onder leiding van een UK PGA Advanced Professional met meer dan twee decennia coachingervaring op drie continenten — nationale teamspeelrs in China, grote toernooivenues in Europa, amateur- en profigolfers in Azië en de VS. De expertise achter de dag maakt het verschil. Het golf is beter. Het inzicht is echt.
          </p>
        </div>
        <div className="intro__right">
          <div className="intro__stat reveal reveal-delay-1">
            <div className="intro__stat-num">18</div>
            <div className="intro__stat-label">Jaar golfcoaching</div>
          </div>
          <div className="intro__stat reveal reveal-delay-2">
            <div className="intro__stat-num">15.000+</div>
            <div className="intro__stat-label">Gegeven lessen</div>
          </div>
          <div className="intro__stat reveal reveal-delay-3">
            <div className="intro__stat-num">300+</div>
            <div className="intro__stat-label">Wedstrijdwinnaars gecoacht</div>
          </div>
        </div>
      </section>
      ...
      <section style={{background:'var(--deep)',borderTop:'1px solid rgba(255,255,255,0.06)',padding:'1.5rem clamp(20px,5vw,60px)'}}>
        <p style={{textAlign:'center',fontSize:'0.85rem',color:'rgba(255,255,255,0.65)',fontFamily:"'Jost',sans-serif",fontWeight:300,lineHeight:1.6}}>
          Andy 教练 &nbsp;·&nbsp; 300 miljoen+ golfcoachings videoweergaven op TikTok &nbsp;·&nbsp; Coachinginhoud wereldwijd vertrouwd
        </p>
      </section>
      ...
      <section className="how">
        <div className="how__header reveal">
          ...
          <h2 className="serif-display">Drie stappen naar een ronde die u zich zult herinneren.</h2>
        </div>
        <div className="how__steps">
          <div className="how__step reveal">
            <span className="how__num">01</span>
            <h3>Neem contact op</h3>
            <p>Vertel me uw datums, uw handicap en wat u zoekt. Ik antwoord persoonlijk binnen 24 uur.</p>
          </div>
          <div className="how__step reveal reveal-delay-1">
            <span className="how__num">02</span>
            <h3>Ik bouw uw dag</h3>
            <p>Baan-aanbeveling, tee time, lunch, vervoer — alles geregeld voor u aankomt.</p>
          </div>
          <div className="how__step reveal reveal-delay-2">
            <span className="how__num">03</span>
            <h3>Verschijn en speel</h3>
            <p>Uw taak is het genieten van de ronde. De meesten spelen beter dan ze verwacht hadden.</p>
          </div>
        </div>
      </section>
      ...
      <section style={{background:'var(--deep)',padding:'clamp(60px,8vw,96px) clamp(20px,5vw,60px)'}}>
        <div style={{maxWidth:1200,margin:'0 auto',display:'grid',gridTemplateColumns:'repeat(auto-fit,minmax(280px,1fr))',gap:'clamp(40px,6vw,80px)',alignItems:'center'}}>
          ...
          <div className="reveal reveal-delay-1">
            {[
              { num: '22', label: 'banen op het eiland' },
              { num: '300+', label: 'zonnedagen per jaar' },
              { num: 'jan–dec', label: 'seizoen het hele jaar' },
              { num: '€80–220', label: 'greenfee bereik' },
            ].map((s, i) => (
      ...
      <section className="courses" id="courses">
        <div className="courses__header">
          <div className="courses__header-left">
            <p className="eyebrow">Uitgelichte banen</p>
            <h2 className="serif-display">De beste van Mallorca — gespeeld en beoordeeld.</h2>
          </div>
        ...
        <div className="courses__track" ref={trackRef} onMouseDown={onMouseDown} onMouseLeave={onMouseLeave} onMouseUp={onMouseUp} onMouseMove={onMouseMove}>
          {courses.map((c, i) => (
            <article key={i} className={`course-card ${c.cls}`} onClick={() => router.push('/nl/golf-courses#' + c.id)} style={{cursor:'pointer'}}>
        ...
        <div style={{textAlign:'center',marginTop:'2.5rem'}}>
          <Link href="/nl/golf-courses#all-courses" className="btn btn--dark">Zie alle 22 banen →</Link>
        </div>
      </section>
      ...
      <section className="what">
        <div className="what__left reveal">
          ...
          <h2 className="serif-display">De meeste golfdagen op Mallorca zijn een tee time en een zwaai tot ziens.</h2>
          <span className="gold-rule"></span>
          <p>Ik heb meer dan een decennium in China gecoacht, waar golflessen €500 per uur kostten en klanten echt verbetering wilden, niet zomaar aanmoediging. Daarvoor coachte ik in Pebble Beach, The Open Championship, Evian, en bracht een seizoen op een wereldcruise door veertig landen.</p>
          <p>Die achtergrond vormt elke ronde die ik begeleid. Dit is een privédag op een van Mallorca's beste banen. Echt advies gedurende — baanstrategie, besluitvorming, dingen die zelden in een standaard les voorkomen. Een dag waarover je nog op de vlucht naar huis spreekt.</p>
          <p>Alles is geregeld voor je aankomst — baan, tee time, lunch. Je enige taak op de dag is spelen.</p>
          <Link href="/nl/play-with-a-pro" className="btn btn--dark">Zie de ervaringen</Link>
        </div>
        <div className="what__right reveal reveal-delay-1">
          {[
            { icon: FEATURE_ICONS.arranged, title: 'Alles geregeld', text: 'Baan, tee time, vervoer, lunch — volledig afgehandeld voor je aankomst.' },
            { icon: FEATURE_ICONS.coaching, title: 'Coaching op de baan', text: 'Echte verbetering in echte omstandigheden. Geen les. Geen commentaar. De juiste opmerking op het juiste moment.' },
            { icon: FEATURE_ICONS.private, title: 'Volledig privé', text: 'Alleen jij en een UK PGA Advanced Professional. Geen vreemden in je groep. Een ronde volledig rond jouw spel.' },
            { icon: FEATURE_ICONS.access, title: 'Toegang tot meer', text: 'Alleen-leden-banen die de meeste bezoekende golfers niet onafhankelijk kunnen boeken — Santa Ponsa 2 & 3, en anderen.' },
          ].map((f, i) => (
      ...
      <section style={{background:'var(--pine)',padding:'clamp(48px,6vw,72px) clamp(20px,5vw,60px)'}}>
        <div style={{maxWidth:720,margin:'0 auto',textAlign:'center'}}>
          <p style={{fontFamily:"'Cormorant Garamond',serif",fontSize:'clamp(1.3rem,2.5vw,1.9rem)',fontStyle:'italic',fontWeight:400,color:'#fff',lineHeight:1.45,marginBottom:'1.25rem'}}>
            &ldquo;Na slechts 18 gaten samen heb ik een nieuw plafond van mijn potentieel ontdekt.&rdquo;
          </p>
          <p style={{fontSize:'9px',letterSpacing:'.18em',textTransform:'uppercase',color:'var(--gold-light)',fontFamily:"'Jost',sans-serif"}}>— Jo, na een dag op Son Gual</p>
        </div>
      </section>
      ...
      <section className="packages">
        <div className="packages__header reveal">
          ...
          <h2 className="serif-display">Een coach. Een baan. Uw dag.</h2>
          <p>Drie niveaus van ervaring. Allemaal privé, allemaal persoonlijk door Andy begeleid.</p>
        </div>
        <div className="packages__grid">
          <div className="package reveal">
            <p className="package__tier">De Mallorca-ronde</p>
            <h3 className="package__name">Speel met een pro</h3>
            <div className="package__divider"></div>
            <ul className="package__features">
              {['Baan afgestemd op uw spel en handicap','Tee time beveiligd en volledig afgehandeld','Pre-ronde briefing en opwarming','18 gaten naast Andy','Coaching op de baan gedurende','Post-ronde debriefing — eerlijk en duidelijk'].map((f,i) => <li key={i}>{f}</li>)}
            </ul>
            <p className="package__price" style={{marginTop:'1.25rem',marginBottom:'0.5rem'}}>€350 pp + greenfee</p>
            <p style={{fontSize:'0.75rem',color:'var(--taupe)',marginBottom:'1.25rem',lineHeight:1.5}}>Greenfees zijn aanvullend — meestal €80–220 pp afhankelijk van baan en seizoen.</p>
            <Link href="/nl/contact" className="btn btn--dark">Informeer</Link>
          </div>
          <div className="package package--featured reveal reveal-delay-1">
            <p className="package__tier">De Signature Day</p>
            <h3 className="package__name">Gehoste golfdag</h3>
            <div className="package__divider"></div>
            <ul className="package__features">
          ...
          <div className="package reveal reveal-delay-2">
            <p className="package__tier">De Complete Ervaring</p>
            <h3 className="package__name">Bespoke Golfreis</h3>
            <div className="package__divider"></div>
            <ul className="package__features">
              {[
                'Multi-baan dag of volledige 4-daagse route',
                "Privé vervoer van Palma hotels of villa's",
                'Diner in voorzorgtig gekozen Mallorca restaurant',
                'Spa- of herstelsessie op partnerlocation',
                'Zonsondergang kustrit langs de Tramuntana',
                'Hete luchtballon over de bergen',
                'Wijnproeverij in Mallorcaans wijngaard',
                'Volledige concierge voor groepen en bedrijven',
              ].map((f,i) => <li key={i}>{f}</li>)}
            </ul>
            <p className="package__price" style={{marginTop:'1.25rem',marginBottom:'1.25rem'}}>Aangepaste route — op aanvraag</p>
            <Link href="/nl/contact" className="btn btn--dark">Informeer</Link>
          </div>
        </div>
      </section>
      ...
      <section className="faq">
        <div className="faq__left reveal">
          ...
          <h2 className="serif-display">Dingen die mensen vragen voordat ze contact opnemen.</h2>
          <p>Vertel me uw datums, uw handicap en wat u zoekt. Ik antwoord persoonlijk binnen 24 uur.</p>
        </div>
      ...
      <section className="cta-final">
        <div className="cta-final__left reveal">
          ...
          <h2 className="serif-display" style={{color:'#fff'}}>Neem contact op.<br />Ik zorg voor de rest.</h2>
          <p>Vertel me uw datums, uw handicap en wat u van de dag wilt. Ik kom terug met een aanbeveling — persoonlijk, binnen 24 uur.</p>
        </div>
        <div className="cta-final__right reveal reveal-delay-1">
          <p className="serif-italic">&ldquo;Het golf is beter. Het inzicht is echt.&rdquo;</p>
          <Link href="/nl/contact" className="btn btn--gold" style={{fontSize:11,padding:'15px 36px',letterSpacing:'0.18em'}}>Boek uw dag</Link>
