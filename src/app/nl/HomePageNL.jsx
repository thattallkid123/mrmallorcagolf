    ...
    <>
      ...
      <section className="intro reveal">
        ...
        <div className="intro__right">
          <div className="intro__stat reveal reveal-delay-1"><div className="intro__stat-num">11</div><div className="intro__stat-label">Jaar coachen in China</div></div>
          <div className="intro__stat reveal reveal-delay-2"><div className="intro__stat-num">40+</div><div className="intro__stat-label">Landen waar ik heb gecoacht</div></div>
          <div className="intro__stat reveal reveal-delay-3"><div className="intro__stat-num">22</div><div className="intro__stat-label">Mallorca-banen verkend</div></div>
        </div>
      </section>
