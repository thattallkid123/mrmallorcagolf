...
export const metadata = {
  title: 'Spelen met een Pro â€” Privegolfdagen op Mallorca',
  description: 'Een prive golfronde op Mallorca, gespeeld naast UK PGA Advanced Professional Andy Griffiths. Coaching op de baan, volle dag geregeld. Vanaf â‚¬350 per persoon.',
  ...
  backgroundPosition: 'center, center, 38% center',
        ...
        <div className="pwap-hero__inner">
          <div className="pwap-hero__content">
            ...
            <p className="eyebrow eyebrow--gold" style={{marginBottom:'1rem',marginTop:'1rem'}}>Privegolfdagen Â· Mallorca</p>
      ...
      <section className="pwap-day">
        <div className="pwap-day__left reveal">
          ...
          <p>Tijdens de ronde wordt de coaching op natuurlijke wijze verweven â€” geen lopend commentaar, maar de juiste observatie op het juiste moment.</p>
          <p>Ik heb gecoacht in omgevingen waar de verwachting serieuze, meetbare verbetering was â€” nationaal team spelers in China, golffanaten door heel Azie.</p>
          <div className="pull-quote"><p>&ldquo;Wat de meeste golfers ontdekken: ze vertrekken merkbaar beter spelend en zelfverzekerder â€” en begrijpen waarom, wat het deel is dat blijft.&rdquo;</p></div>
      ...
      <section className="pwap-courses">
        <div className="courses-intro reveal">
          ...
          <p style={{color:'rgba(255,255,255,.55)',lineHeight:1.8,maxWidth:680}}>Een groep met beginners, een kortere halve dag â€” er zijn banen die beter werken, en ik vertel u eerlijk welke. Sommige zijn alleen voor leden â€” die toegang kan worden geregeld.</p>
        </div>
      </section>
      ...
      <section className="pwap-testimonials">
        ...
        <div className="pwap-testimonials__grid">
          ...
          <div className="testimonial reveal reveal-delay-2"><p>&ldquo;Andy veranderde volledig hoe ik over baanbeheer denk. Na 18 holes met hem op Son Gual speelde ik mijn beste score daar en begreep ik eindelijk waarom.&rdquo;</p><span className="testimonial__author">â€” Adam</span></div>
        </div>
      </section>
      ...
      <section className="pwap-packages" id="packages">
        <div className="reveal">
          ...
          <h2 className="serif-display" style={{fontSize:'clamp(1.8rem,3vw,2.5rem)',color:'var(--deep)',marginTop:'.5rem',marginBottom:'1rem'}}>Drie niveaus. Allemaal privÃ©, allemaal persoonlijk begeleid.</h2>
        ...
        <div className="pricing-grid">
          ...
          <div className="tier tier--feature reveal">
            ...
            <p className="tier__price">Vanaf â‚¬450 p.p. + green fee</p>
            <div className="tier__rule"></div>
            <ul className="tier__features">
              ...
              <li>Ontspannen tempo â€” een volledige dag</li>
            </ul>
            <Link href="/nl/contact" className="tier__btn">Aanvragen &rarr;</Link>
          </div>
          <div className="tier reveal">
      ...
      <section className="cta-final">
        <div className="cta-final__left reveal">
          ...
          <p>Vertel me uw data, uw handicap en wat u van de dag wilt. Ik kom terug met een aanbeveling â€” persoonlijk, binnen 24 uur.</p>
        </div>
