    ...
    <>
      <section className="hero">
        ...
        <div className="hero__content">
          ...
          <h1 className="serif-display hero__title">
            Spela basta<br />golfbanorna pa Mallorca.<br />
            <em style={{fontStyle:'italic',fontWeight:400,opacity:0.85}}>Med en professionell vid din sida.</em>
          </h1>
          <div className="hero__actions">
            <Link href="/sv/contact" className="btn btn--gold">Reserve su día</Link>
      ...
      <section className="courses" id="courses">
        <div className="courses__header">
          <div className="courses__header-left">
            ...
            <h2 className="serif-display">Los mejores golfbanorna pa Mallorca — jugados y valorados.</h2>
          </div>
        ...
        <div style={{textAlign:'center',marginTop:'2.5rem'}}>
          <Link href="/sv/golf-courses" className="btn btn--dark">Ver los 22 campos →</Link>
        </div>
      </section>
      ...
      <section className="what">
        <div className="what__left reveal">
          ...
          <Link href="/sv/play-with-a-pro" className="btn btn--dark">Ver las experiencias</Link>
        </div>
      ...
      <section className="packages">
        ...
        <div className="packages__grid">
          <div className="package reveal">
            ...
            <Link href="/sv/contact" className="btn btn--dark">Consultar</Link>
          </div>
          <div className="package package--featured reveal reveal-delay-1">
            ...
            <Link href="/sv/contact" className="btn btn--gold">Consultar</Link>
          </div>
      ...
      <section className="cta-final">
        ...
        <div className="cta-final__right reveal reveal-delay-1">
          ...
          <Link href="/sv/contact" className="btn btn--gold" style={{fontSize:11,padding:'15px 36px',letterSpacing:'0.18em'}}>Reserve su día</Link>
