    ...
    <div className="contact-wrap">
      <div className="contact-left">
        ...
        <div className="contact-details">
          ...
          <div className="contact-detail"><span className="contact-detail__label">Baserad</span><a href="https://maps.google.com/?q=Mallorca,Spain" target="_blank" rel="noopener noreferrer" className="contact-detail__value" style={{color:"inherit",textDecoration:"none"}}>Mallorca, Spanien ↗</a></div>
        </div>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="form-group">
                ...
                <select name="experience" className="form-control" value={form.experience} onChange={handleChange}>
                  ...
                  <option value="mallorca-round">Mallorca-rundan — €350 per person + green fee</option>
                  <option value="signature-day">Signature-dagen — Från €450 per person + green fee</option>
                  <option value="full-experience">Hela Upplevelsen — På förfrågan</option>
                  <option value="not-sure">Vet inte ännu — ge mig en rekommendation</option>
                </select>
              </div>
              ...
              <div className="form-submit">
                ...
                <p className="form-note">Inga automatiska svar. Jag läser varje meddelande personligen.</p>
              </div>
            </form>
          </>
        )}
