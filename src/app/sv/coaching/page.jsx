...
export const metadata = {
  title: 'Golfcoaching på banan i Mallorca — PGA-proffs',
  description: 'Golfcoaching på banan i Mallorca med PGA Advanced Professional Andy Griffiths. Riktig förbättring i riktiga förhållanden — för besökande och bosatta golfare.',
    ...
    <PageLayout lang="sv">
      ...
      <section className="range-section">
        <div className="reveal">
          ...
          <p>Coaching på banan sätter lektionen där den faktiskt hjälper. På fairwayen. I roughen. På en sluttning med ett oväntat vind. Med en poäng som spelar roll. Det är där spel förändras — och det är där vi arbetar.</p>
          <div className="analogy-box">
            <p>&ldquo;Tänk på boxning. Du kan träna på kuddar i veckor och känna dig redo. Sedan har du din första sparring och allt förändras. Golf är likadant. Första teet är inte driving rangen.&rdquo;</p>
      ...
      <section className="improvements">
        <div className="reveal">
          ...
          <h2>Det här förändras under en runda med mig.</h2>
          <p className="improvements__sub">Och varför det fastnar på ett sätt rangearbete sällan gör.</p>
        </div>
        <div className="improvements-grid">
          <div className="improvement reveal"><span className="improvement__num">01</span><h3>Banhantering</h3><p>De flesta amateurgolfare förlorar merparten av sina slag på felaktiga beslut, inte felaktiga svingar. Att välja rätt klubba, mål, form — det är det som separerar ett 90:a från ett 80:a.</p></div>
          ...
          <div className="improvement reveal"><span className="improvement__num">03</span><h3>Läsa greener och sluttningar</h3><p>Att putta och chippa på en bana-green är fundamentalt annorlunda än en övningsgreen. Hastigheten, sluttningen, gräset, pressens moment — allt förändrar vad som fungerar.</p></div>
          ...
          <div className="improvement reveal"><span className="improvement__num">05</span><h3>Mentalt spel och rutin</h3><p>Hur du pratar med dig själv efter ett dåligt slag. Hur du angriper nästa tee. Om du har en förslagsrutin och om den håller under press. Den mentala sidan är helt osynlig på rangen.</p></div>
          <div className="improvement reveal reveal-delay-1"><span className="improvement__num">06</span><h3>Hitta lågt hängande frukt</h3><p>De flesta golfare förbättras snabbast inte från att bygga om sin swing utan från en eller två små lösningar. En klient hade chippat med en pitching wedge hela livet. Ett samtal, ett klubbyte, omedelbar förbättring.</p></div>
          <div className="improvement reveal improvement--full"><span className="improvement__num">07</span><h3>Konsekvens i riktiga förhållanden</h3><p>Ojämna liggar, smala fairways, rough — banan kräver slag rangen aldrig frågar efter. Att spela dem regelbundet, med feedback i realtid, är hur du bygger ett spel som dyker upp när det räknas.</p></div>
        </div>
      </section>
      ...
      <section className="how-section">
        <div className="reveal">
          ...
          <p>Sessioner sker på banan på Son Gual, Alcanada, eller en anpassad bana. Vi spelar tillsammans, coachingen sker i realtid, feedbacken är situationell och ärlig.</p>
        </div>
        <div className="how-steps reveal">
          <div className="how-step"><span className="how-step__num">01</span><div><h3>Frågeformuläret</h3><p>Innan sessionen fyller du i ett kort formulär. Vad som frustrerar dig, var luckorna är, hur en bra dag ser ut. Vid det första teet har jag redan en bild.</p></div></div>
          <div className="how-step"><span className="how-step__num">02</span><div><h3>Rundan</h3><p>Vi spelar tillsammans. Coaching sker i realtid — rätt observation vid rätt tillfälle. Inte en löpande kommentar. Saken som förändrar din poäng.</p></div></div>
          <div className="how-step"><span className="how-step__num">03</span><div><h3>Genomgången</h3><p>Över lunchen går vi igenom vad som förbättrades, vad du ska jobba med, och vad du tar med dig. Ärligt och tydligt.</p></div></div>
        </div>
      </section>
      ...
      <section className="who-section">
        ...
        <div className="who-grid">
          ...
          <div className="who-card reveal reveal-delay-1"><h3>Bosatta golfare</h3><p>Regelbundet arbete med en professionell som spelar samma banor som du.</p></div>
          <div className="who-card reveal reveal-delay-2"><h3>Rang/bana-glappet</h3><p>Ditt övningsspel förs aldrig över. Här fixar vi det.</p></div>
