...
export async function POST(request) {
  try {
    ...
    const bodyHtml = `
      ...
      <p style="margin:0 0 20px;font-family:Georgia,serif;font-size:15px;line-height:1.7;color:#2C2A27;">Handicap limits in Mallorca are often more flexible than the published numbers — if you're a few shots over a limit, I can frequently arrange access, especially midweek and outside peak season. Tell me your dates and group and I'll build the round order and tee times around your golf.</p>
