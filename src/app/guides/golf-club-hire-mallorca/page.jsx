  ...
  return (
    <PageLayout>
      ...
      <PostLayout meta={meta}>
        ...
        <div style={{ position: 'relative', width: '100%', maxWidth: '300px', height: '150px', margin: '1rem 0 0.5rem 0' }}>
          <Image
        ...
        <p style={{ fontSize: '0.85rem', fontStyle: 'italic', color: '#666', marginTop: '0' }}>clubrentalsmallorca.com</p>
        ...
        <p style={{ fontSize: '0.85rem', fontStyle: 'italic', color: '#666', marginTop: '0.25rem' }}>Callaway Rogue ST Max - Current season equipment</p>

        <h3><a href="https://rent2play.golf" target="_blank" rel="noopener noreferrer">Rent2Play Golf</a></h3>
        <div style={{ position: 'relative', width: '100%', maxWidth: '300px', height: '100px', margin: '1rem 0 0.5rem 0' }}>
          <Image
            src="/images/blog-golf-club-hire/Rent2Play.webp"
            alt="Rent2Play Golf Logo"
            fill
            style={{ objectFit: 'contain' }}
          />
        </div>
        <p style={{ fontSize: '0.85rem', fontStyle: 'italic', color: '#666', marginTop: '0' }}>rent2play.golf</p>
        ...
        <p style={{ fontSize: '0.85rem', fontStyle: 'italic', color: '#666', marginTop: '0.25rem' }}>TaylorMade Qi4D - Premium option</p>

        <h3><a href="https://mycaddymaster.com" target="_blank" rel="noopener noreferrer">MyCaddyMaster</a></h3>
        <div style={{ position: 'relative', width: '100%', maxWidth: '300px', height: '120px', margin: '1rem 0 0.5rem 0' }}>
          <Image
            src="/images/blog-golf-club-hire/My Caddy Master.jpg"
            alt="MyCaddyMaster Logo"
            fill
            style={{ objectFit: 'contain' }}
          />
        </div>
        <p style={{ fontSize: '0.85rem', fontStyle: 'italic', color: '#666', marginTop: '0' }}>mycaddymaster.com</p>
        ...
        <p style={{ fontSize: '0.85rem', fontStyle: 'italic', color: '#666', marginTop: '0.25rem' }}>Cobra Fly XL - Budget-friendly option</p>
        ...
        <div style={{ position: 'relative', width: '100%', maxWidth: '300px', height: '100px', margin: '1rem 0 0.5rem 0' }}>
          <Image
            ...
            alt="ClubsToHire Logo"
            fill
            style={{ objectFit: 'contain' }}
          />
        </div>
        <p style={{ fontSize: '0.85rem', fontStyle: 'italic', color: '#666', marginTop: '0' }}>clubstohire.com</p>
