  ...
  return (
    <PageLayout>
      ...
      <PostLayout meta={meta}>
        ...
        <p>One round per day is comfortable for most golfers — the courses are demanding, and summer heat is real. In cooler times, 36 holes a day is possible if that keen but most "golf only" visitors on a 5–7-day trip play 4–5 rounds.</p>
