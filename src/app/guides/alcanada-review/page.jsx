    ...
    <PageLayout>
      ...
      <PostLayout meta={meta}>
        ...
        <div className="post-pull">
          <p>"The lighthouse visible from 16 of 18 holes. On a clear morning, it's one of the most beautiful settings I've played golf in anywhere in the world."</p>
        </div>
        ...
        <p>The combination of slope, speed, and subtle breaks on the greens is what separates this from a merely scenic layout into something that genuinely tests skilful players. The course hosts the Rolex Challenge Tour Grand Final â€” returning for its sixth time in October 2026.</p>

        <h2>Design Pedigree</h2>
        <p>Robert Trent Jones Jr.'s father designed Valderrama â€” the venue of the 1997 Ryder Cup â€” and Spyglass Hill at Pebble Beach. RTJ Jr. also designed Spring City Golf in Kunming, ranked China's number one course by Golf Digest. The lineage is genuine.</p>
        ...
        <p>Green fees 2026: â‚¬115 low season (January, December) to â‚¬220 peak (Marchâ€“May, Septemberâ€“October). Full seasonal breakdown at golf-alcanada.com.</p>
