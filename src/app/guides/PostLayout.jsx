...
const SIDEBAR_COPY = {
  en: { experience: 'The Experience', h3: 'Play one of these courses with a PGA professional alongside you.', guidesTitle: 'Play one of these courses with a PGA professional alongside you.', p: 'Private days on Son Gual, Alcanada, and beyond. Everything arranged. On-course coaching throughout.', guidesBody: 'Private days on Son Gual, Alcanada, and beyond. Everything arranged. On-course coaching throughout.', seeExp: 'See the Experiences', guidesPrimaryCta: 'See the Experiences', contact: 'Get in Touch', guidesSecondaryCta: 'Get in Touch', moreGuides: 'More Guides', allGuides: 'All guides', home: 'Home', guidesLabel: 'Guides' },
