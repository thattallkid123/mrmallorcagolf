...
const SIDEBAR_COPY = {
  en: { experience: 'Plan the trip', h3: 'Want this course in a Mallorca golf itinerary that actually makes sense?', guidesTitle: 'Want this course in a Mallorca golf itinerary that actually makes sense?', p: 'Start with the itinerary builder, then add a Play With A Pro day if it improves the trip.', guidesBody: 'Start with the itinerary builder, then add a Play With A Pro day if it improves the trip.', seeExp: 'See the add-on', guidesPrimaryCta: 'See the add-on', contact: 'Build itinerary', guidesSecondaryCta: 'Build itinerary', moreGuides: 'More Guides', allGuides: 'All guides', home: 'Home', guidesLabel: 'Guides' },
  ...
  zh: { experience: '体验项目', h3: '与 PGA 职业球手同场竞技，在这些球场享受私人球局。', guidesTitle: '与 PGA 职业球手同场竞技，在这些球场享受私人球局。', p: '在 Son Gual、Alcanada 等球场享受私人高尔夫日。全程安排，球场实地指导。', guidesBody: '在 Son Gual、Alcanada 等球场享受私人高尔夫日。全程安排，球场实地指导。', seeExp: '了解体验项目', guidesPrimaryCta: '了解体验项目', contact: '联系我们', guidesSecondaryCta: '联系我们', moreGuides: '更多指南', allGuides: '所有指南', home: '首页', guidesLabel: '指南' },
  sv: { experience: 'Upplevelsen', h3: 'Spela en av dessa banor med ett PGA-proffs vid din sida.', guidesTitle: 'Spela en av dessa banor med ett PGA-proffs vid din sida.', p: 'Privata dagar på Son Gual, Alcanada och mer. Allt arrangerat. Coaching på banan.', guidesBody: 'Privata dagar på Son Gual, Alcanada och mer. Allt arrangerat. Coaching på banan.', seeExp: 'Se upplevelserna', guidesPrimaryCta: 'Se upplevelserna', contact: 'Hör av dig', guidesSecondaryCta: 'Hör av dig', moreGuides: 'Fler guider', allGuides: 'Alla guider', home: 'Hem', guidesLabel: 'Guider' },
  nl: { experience: 'De Ervaring', h3: 'Speel een van deze banen met een PGA professional aan uw zijde.', guidesTitle: 'Speel een van deze banen met een PGA professional aan uw zijde.', p: 'Privé dagen op Son Gual, Alcanada en meer. Alles geregeld. Coaching op de baan.', guidesBody: 'Privé dagen op Son Gual, Alcanada en meer. Alles geregeld. Coaching op de baan.', seeExp: 'Bekijk de ervaringen', guidesPrimaryCta: 'Bekijk de ervaringen', contact: 'Neem contact op', guidesSecondaryCta: 'Neem contact op', moreGuides: 'Meer gidsen', allGuides: 'Alle gidsen', home: 'Home', guidesLabel: 'Gidsen' },
}
      ...
      <div className="post-body">
        ...
        <aside className="post-sidebar">
          <div className="post-sidebar__block">
            ...
            <a href={l === 'en' ? 'https://internal.mrmallorcagolf.com' : `${pre}/contact`} className="btn btn--dark post-sidebar__cta post-sidebar__cta--secondary">{c.guidesSecondaryCta} &rarr;</a>
          </div>
