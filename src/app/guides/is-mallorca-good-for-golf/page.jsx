...
export const metadata = {
  title: "Is Mallorca Good for Golf? A PGA Professionalâ€™s Answer",
  ...
  openGraph: {
    ...
    images: [{ url: "https://mrmallorcagolf.com/images/blog-is-mallorca-good/Son Gual.jpg", width: 1200, height: 630, alt: "Is Mallorca Good for Golf? A PGA Professionalâ€™s Answer" }],
  },
  twitter: {
...
const meta = {
  ...
  intro: "Yes. But here's the proper answer â€” because Mallorca is good for golf in ways that aren't obvious from the outside.",
  related: [
  ...
  return (
    <PageLayout>
      ...
      <PostLayout meta={meta}>
        ...
        <p>Pula, Canyamel, Capdepera â€” some of the most beautiful courses â€” are 55â€“65km from Palma. Factor in travel time and consider basing yourself in the east for a night and tick off a few.</p>
        ...
        <p>One thing visitors often underestimate: Mallorca is an exceptional island beyond the golf which is why so many celebrities, sports star and more call here home or visit for holidays. The courses are the anchor, but the days between rounds â€” or the afternoon after an early finish are what makes the trip.</p>
        <p>The clubhouse restaurants at many of the courses are more than an after-thought, but the island boasts many options from Michelin stars, local favourites and private chef dining experiences. Old town Palma has a dining scene that punches well above its size. The northwest coast â€” Valldemossa, DeiÃ , SÃ³ller â€” is UNESCO World Heritage and looks like nothing else in the Mediterranean. The northeast coast and the drive to Alcanada takes you through some of the best scenery on the island. The Ma-10 mountain road from Andratx to PollenÃ§a is one of the most dramatic drives in Europe. Build in at least one afternoon where you don't have a tee time.</p>
        ...
        <p style={{ fontSize: '0.85rem', fontStyle: 'italic', color: '#666', margin: '0.25rem 0 0 0' }}>SÃ³ller - UNESCO World Heritage setting on northwest coast</p>
