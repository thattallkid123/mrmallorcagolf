  ...
  return (
    <PageLayout>
      ...
      <PostLayout meta={meta}>
        ...
        <p>Coming from Shanghai — 27 million people, 12 courses — the density of quality golf here is remarkable. A week on the island can include four or five genuinely different, genuinely excellent rounds. Southwest, east coast, north, central Palma — each area has its own character.</p>
        ...
        <p>Pula, Canyamel, Capdepera — some of the most beautiful courses — are 55–65km from Palma. Factor in travel time and consider basing yourself in the east for a night.</p>
        ...
        <p>One thing visitors often underestimate: Mallorca is an exceptional island beyond the golf. The courses are the anchor, but the days between rounds — or the afternoon after an early finish — are genuinely part of what makes the trip.</p>
        <p>Old town Palma has a dining scene that punches well above its size. The northwest coast — Valldemossa, Deià, Sóller — is UNESCO World Heritage and looks like nothing else in the Mediterranean. The northeast coast and the drive to Alcanada takes you through some of the best scenery on the island.</p>
        <p>The clubhouse restaurants at Son Gual and Alcanada are both worth staying for. The Ma-10 mountain road from Andratx to Pollença is one of the most dramatic drives in Europe. Build in at least one afternoon where you don't have a tee time.</p>
