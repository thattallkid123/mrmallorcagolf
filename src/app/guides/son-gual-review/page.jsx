...
export const metadata = {
  title: "Son Gual Golf Mallorca â€” A PGA Professionalâ€™s Honest Review (2026)",
  ...
  openGraph: {
    ...
    images: [{ url: "https://mrmallorcagolf.com/images/son-gual-blog/sg-hero.webp", width: 1200, height: 630, alt: "Son Gual Golf Mallorca â€” A PGA Professionalâ€™s Honest Review (2026)" }],
  },
  twitter: {
...
const meta = {
  ...
  title: "Son Gual Golf Mallorca â€” A PGA Professional's Honest Review (2026)",
  intro: 'My most-played course on the island. The wind, the greens, the closing stretch â€” and why Obama and Nadal both keep coming back.',
  related: [
  ...
  return (
    <PageLayout>
      ...
      <PostLayout meta={meta}>
        ...
        <p>Son Gual is my most-played course in Mallorca and the one I recommend most consistently when clients ask where to play. I want to be honest about why â€” and honest about what makes it hard, because it is hard, and anyone booking expecting a relaxed day will be surprised.</p>
        ...
        <p>The drive came off the heel slightly. Still flew further than expected and avoided the bunkers â€” just. There are so many bunkers at Son Gual, positioned exactly where slightly mishit shots go. You're factoring in wind, elevation changes, inconsistent ball-striking, and the bunkers seem to grow larger the longer you stand contemplating them.</p>
        ...
        <p>One of my playing partners that day â€” a student visiting Mallorca from China â€” reached for her putter believing she was on the green. She had about 30 yards of fringe still to cover. The conditioning is that meticulous.</p>

        <PostImage
          src="/images/son-gual-blog/sg-2.jpg"
          alt="Son Gual green and surrounding landscape"
          caption="Fast, raised greens. Where you miss matters more than how you swing â€” that's the Son Gual lesson."
        />

        <h2>The Course</h2>
        <p>Thomas Himmel's 2007 design uses elevation intelligently. The 2nd hole features one of Europe's largest bunkers. The closing stretch from the 15th is widely regarded as one of the finest finishing sequences in European golf â€” and having played it, I'd agree. Views across the Bay of Palma are best between holes 8â€“12. The restaurant shares that view and is worth staying for after the round.</p>

        <PostImage
          src="/images/son-gual-blog/sg-3.webp"
          alt="Son Gual closing stretch"
          caption="The 18th. The closing stretch â€” holes 15 to 18 â€” is among the finest four holes in European golf. I'd stand by that."
        />
        ...
        <p>Rafa Nadal plays here regularly â€” his stated favourite course on the island. Barack Obama played in November 2024, and general manager Andreas Pamer described him as genuinely likeable and said he promised to return.</p>
        ...
        <div className="post-fact">
          <div className="post-fact__item"><span className="post-fact__val">â‚¬80â€“165</span><span className="post-fact__label">Green fee range 2026</span></div>
        ...
        <p>Low season (mid-November to December): â‚¬115. January maintenance window: â‚¬80 for 9 holes only. Peak spring and autumn (Marchâ€“May, Septemberâ€“November): â‚¬165. Summer (Julyâ€“August): â‚¬115. Full seasonal breakdown at son-gual.com.</p>
        <p>Club hire at the pro shop: Callaway â‚¬35, Titleist â‚¬45 per round. Buggy â‚¬45, electric trolley from â‚¬15. A valid WHS handicap certificate is required to book.</p>

        <h2>Verdict</h2>
        <p>Son Gual is my favourite course in Mallorca. It would stand up against any course I've played in my travels â€” the conditioning, the design intelligence, and the setting are exceptional. It's not a course to arrive at without your game in reasonable order, but for any golfer who wants a serious round in a serious setting, this is it.</p>
