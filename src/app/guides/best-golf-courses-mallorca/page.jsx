...
export const metadata = {
  title: "The Best Golf Courses in Mallorca â€” A PGA Professionalâ€™s Honest Guide (2026)",
  ...
  openGraph: {
    type: 'article',
    url: "https://mrmallorcagolf.com/guides/best-golf-courses-mallorca",
    title: "The Best Golf Courses in Mallorca â€” A PGA Professionalâ€™s Honest Guide (2026)",
    description: "The best golf courses in Mallorca ranked and reviewed by a PGA professional based on the island. Son Gual, Alcanada, Son Muntaner, and more â€” honest first-hand takes.",
    publishedTime: '2026-03-01',
    authors: ['Andy Griffiths'],
    images: [{ url: "https://mrmallorcagolf.com/images/blog-best-golf-courses/Son Gual.jpg", width: 1200, height: 630, alt: "The Best Golf Courses in Mallorca â€” A PGA Professionalâ€™s Honest Guide (2026)" }],
  },
  twitter: {
    card: 'summary_large_image',
    title: "The Best Golf Courses in Mallorca â€” A PGA Professionalâ€™s Honest Guide (2026)",
    description: "The best golf courses in Mallorca ranked and reviewed by a PGA professional based on the island. Son Gual, Alcanada, Son Muntaner, and more â€” honest first-hand takes.",
    images: ["https://mrmallorcagolf.com/images/blog-best-golf-courses/Son Gual.jpg"],
  },
}
  ...
  return (
    <PageLayout>
      ...
      <PostLayout meta={meta}>
        ...
        <p>Mallorca â€” or Majorca if you grew up spelling it that way â€” is a much better golf destination than most people realise. I moved here from Shanghai in March 2025, where I'd spent eleven years coaching in a city of 27 million people with not enough golf courses between them. Mostly built to championship standards as there was no point having anything there that wasn't the "best". Arriving on an island with 22 courses, many hosting international competitions, in conditions that stay quality even through the winter, felt like discovering a secret.</p>
        <p>I'm a PGA Advanced Professional and I'm working my way through every course on the island â€” playing them, reviewing them honestly, working out what makes each one worth the trip and taking my guests along too to learn. Below is what I know so far.</p>
        ...
        <p>Robert Trent Jones Jr. design in the north of the island, with a lighthouse visible from 16 of the 18 holes. Standing on the back tees on number 7, elevated way above the bay, with everyone below looking like tiny dots and the lighthouse and expanse of water taking up the whole horizon â€” is one of those moments that reminds you why you play golf. The greens are severe, can get extremely fast, and is a real challenge. The drive north from Palma takes about 50 minutes. Worth every minute.</p>
        ...
        <p>Widely considered as 1 of the most difficult course on the island. A championship layout in the southwest with breathtaking scenery and hazards on near enough every hole. The 6th is the longest par 5 in the whole of Spain at 609 metres. Recommended for experienced players, and bring extra balls! Green fees approximately â‚¬96 to â‚¬140 depending on season.</p>
        ...
        <p>The only public course in the Santa Ponsa group, with genuine European Tour history â€” it hosted the 2021 DP World Tour Mallorca Golf Open and 6 European Tour Events. One of the longest courses on the island, with open fairways that reward an aggressive approach from the tee and good opportunities to hit driver.</p>
        ...
        <p><strong>Santa Ponsa:</strong> Hosted 6 European Tour Events and all the big names of the time playing, including Spanish legends Seve Ballesteros and JosÃ© MarÃ­a OlazÃ¡bal alongside Ian Woosnam, Bernhard Langer and more.</p>
