  ...
  return (
    <PageLayout>
      ...
      <PostLayout meta={meta}>
        ...
        <p>Mallorca — or Majorca if you grew up spelling it that way — is a better golf destination than most people realise. I moved here from Shanghai in March 2025, where I'd spent eleven years coaching in a city of 27 million people with 12 golf courses between them. Arriving on an island with 22 courses, several of genuine European Tour standard, in conditions that stay immaculate through the winter, felt like discovering a secret.</p>
        <p>I'm a PGA Advanced Professional and I'm working my way through every course on the island — playing them, reviewing them honestly, working out what makes each one worth the trip. Below is what I know so far.</p>

        <h2>The Top Courses — By Purpose</h2>

        <h3>For a Serious Championship Round: Son Gual</h3>
        <p>My most-played course on the island and the one I recommend most often for a proper test. Thomas Himmel's design sits in its own wind ecosystem in the hills above Palma — I've left my house on a calm morning and arrived at the first tee to find it blowing hard and staying that way for four hours. The greens are fast, raised, and unforgiving. The bunkering is aggressive — enormous traps positioned exactly where slightly mishit shots go. The closing stretch from the 15th is genuinely outstanding.</p>
        ...
        <p>Robert Trent Jones Jr. design in the north of the island, with a lighthouse visible from 16 of the 18 holes. Standing on the back tees, elevated above the bay, with everyone below looking like tiny dots and the lighthouse behind you — it's one of those moments that reminds you why you play golf. The greens are severe and extremely fast, which is why the course hosts elite-level events. The drive north from Palma takes about 50 minutes. Worth every minute.</p>
        <p>Green fees: €115 (low season) to €220 (peak spring and autumn).</p>

        <h3>For a DP World Tour Experience: Son Muntaner</h3>
        <p>Named Best Golf Course in Spain at the 2025 World Golf Awards — the only course in the Balearics with this recognition. Hosted the Mallorca Golf Open and the Ladies European Tour event. Wide fairways, technically demanding greens, five minutes from Palma.</p>

        <h3>For the Hardest Test: Golf de Andratx</h3>
        <p>Widely considered the most difficult course on the island. Championship layout in the southwest with breathtaking scenery and hazards on every hole. The 6th is the longest par 5 in Spain at 609 metres. Experienced players only — and bring extra balls. Green fees approximately €96 to €140 depending on season.</p>
        ...
        <p>The only public course in the Santa Ponsa group, with genuine European Tour history — it hosted the 2021 DP World Tour Mallorca Golf Open. One of the longest courses on the island, with open fairways that reward an aggressive approach from the tee.</p>

        <h3>For Beginners or Mixed Groups: Son Quint or Son Antem East</h3>
        <p>Son Quint is the most accessible course in the Arabella complex — flat, wide fairways, native planting, no intimidation factor. Tiger Woods and his son Charlie played here in July 2022. Son Antem East in the south is similarly flat and forgiving, with a hotel resort if you want to combine with accommodation.</p>
