...
export const metadata = {
  title: 'Mallorca Golf Guide 2026 â€” Every Course on the Island',
  description: 'The complete guide to golf in Mallorca â€” all 22 courses, green fees, difficulty ratings, and honest recommendations from a PGA professional based on the island. 2026 edition.',
  alternates: {
    ...
    <PageLayout>
      ...
      <header className="page-hero" style={{
        ...
        <div className="page-hero__inner">
          ...
          <h1>Golf in Mallorca 2026 â€”<br />An Insider&apos;s Guide</h1>
