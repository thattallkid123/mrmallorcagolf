...
const COURSE_DATA = [
  ...
  },
  {
    ...
    courses: [
      ...
      { expert: false, badges: [], name: 'T Golf Calvià (Poniente)', img: '/images/courses/t-golf-calvia.webp', location: 'Calvià · 12km from Palma', pills: ['€70–120 - Dynamic Pricing', 'Par 72 · 15 lakes', '€10M renovation'], difficulty: 70, diffScore: '7/10', text: "Originally designed by John Harris in 1978 and completely rebuilt following a €10 million renovation — new course, new clubhouse, entirely different proposition. Fifteen lakes, open fairways encouraging driver, large undulating greens. The sea on one side and the Tramuntana on the other. Has hosted the Mallorca Open.", footer: 'Mallorca Open host' },
