    ...
    <div className="contact-wrap">
      <div className="contact-left">
        <div>
          ...
          <p className="contact-left__intro">Pas de systemes de reservation. Dites-moi vos dates, votre handicap et ce que vous voulez de la journée. Je vous repondrai personnellement.</p>
        </div>
        <div className="contact-details">
          ...
          <div className="contact-detail"><span className="contact-detail__label">Base</span><a href="https://maps.google.com/?q=Mallorca,Spain" target="_blank" rel="noopener noreferrer" className="contact-detail__value" style={{color:"inherit",textDecoration:"none"}}>Majorque, Espagne ↗</a></div>
        </div>
        ...
        {submitted ? (
          ...
          <>
            <div className="form-header">
              ...
              <h2>Commencez a planifier votre journée.</h2>
              <p>Plus vous me donnez de details, mieux je peux adapter la journée a vous.</p>
            </div>
            <form onSubmit={handleSubmit}>
              ...
              <div className="form-group">
                <label>Quelle expérience vous intéresse ?</label>
                <select name="experience" className="form-control" value={form.experience} onChange={handleChange}>
                  <option value="">Sélectionner</option>
                  <option value="mallorca-round">Le Tour Mallorca — €350 p.p. + green fee</option>
                  ...
                  <option value="not-sure">Pas encore sûr — conseillez-moi</option>
                </select>
              </div>
              <div className="form-group"><label htmlFor="message">Autre chose que je devrais savoir</label><textarea id="message" name="message" className="form-control" placeholder="Objectifs pour la journée, parcours, groupe mixte, demandes specifiques." value={form.message} onChange={handleChange} /></div>
              <div className="form-submit">
                <button type="submit" className="btn-submit">Envoyer la demande &rarr;</button>
                <p className="form-note">Pas de réponses automatiques. Je lis chaque message personnellement.</p>
              </div>
            </form>
          </>
        )}
