      ...
      <div className="contact-right">
        {submitted ? (
          <div className="form-success visible">
            ...
            <h3>Demande reçue.</h3>
            <p>Je vous répondrai personnellement sous 24 heures. WhatsApp est le moyen le plus rapide.</p>
          </div>
        ) : (
          <>
            ...
            <form onSubmit={handleSubmit} aria-busy={submitting}>
              ...
              <div className="form-row">
                <div className="form-group"><label htmlFor="dates">Dates souhaitées</label><input type="text" id="dates" name="dates" className="form-control" placeholder="ex. 15-22 octobre 2026" value={form.dates} onChange={handleChange} /></div>
                <div className="form-group"><label htmlFor="handicap">Votre handicap</label><input type="text" id="handicap" name="handicap" className="form-control" placeholder="ex. 14 ou débutant" value={form.handicap} onChange={handleChange} /></div>
              </div>
              ...
              <div className="form-group">
                ...
                <div className="radio-group">
                    ...
                    <label className="radio-option"><input type="radio" name="experience" value="full-experience" checked={form.experience === "full-experience"} onChange={handleChange} /><span className="radio-option-label">L'Expérience Complète</span><span className="radio-option-price">Sur devis</span></label>
                    <label className="radio-option"><input type="radio" name="experience" value="not-sure" checked={form.experience === "not-sure"} onChange={handleChange} /><span className="radio-option-label">Pas encore certain(e) — conseillez-moi</span></label>
                </div>
              </div>
