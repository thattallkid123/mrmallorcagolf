  ...
  return (
    <PageLayout lang="fr">
      ...
      <div className="story">
        <main className="story__main">
          ...
          <div className="chapter reveal">
            ...
            <p>La Chine à cette époque était un environnement extraordinaire pour coacher. Les leçons tournaient autour de 500 € de l'heure. Les clients attendaient une amélioration sérieuse et mesurable — pas seulement des encouragements.</p>
          ...
          <div className="chapter reveal">
            ...
            <p>Un PGA professionnel qui a passé plus d\'une décennie à coacher en Asie, maintenant à la tête de journées golf privées sur l'une des meilleures îles de golf d'Europe. Si ça ressemble à la journée que vous cherchez — prenez contact.</p>
          </div>
        </main>
        <aside className="story__sidebar">
          <div className="creds reveal">
            ...
            <ul className="cred-list">
              <li key={0} className="cred-item"><span className="cred-check">&#10003;</span><span className="cred-text"><strong>PGA Advanced Professional (UK)</strong>La qualification la plus élevée du golf britannique</span></li>
              ...
              <li key={8} className="cred-item"><span className="cred-check">&#10003;</span><span className="cred-text"><strong>Auteur publié</strong>Putting It Out There — A Life in Full Swing, 2016</span></li>
      ...
      <section className="venues reveal">
        <p style={{fontSize:'9px',letterSpacing:'.2em',textTransform:'uppercase',color:'rgba(255,255,255,.3)',marginBottom:'.5rem'}}>Lieux & expérience</p>
        <h2>Où la carrière s\'est construite.</h2>
        <div className="venues__grid">
            ...
            <div key={2} className="venue"><p className="venue__name">Evian Championship</p><p className="venue__detail">France · Major Dames</p></div>
            <div key={3} className="venue"><p className="venue__name">Doral</p><p className="venue__detail">Miami, USA</p></div>
            <div key={4} className="venue"><p className="venue__name">Shanghai</p><p className="venue__detail">Chine · 11 ans</p></div>
        </div>
      </section>
      ...
      <section className="cta-final">
        <div className="cta-final__left reveal">
          ...
          <h2 className="serif-display" style={{color:'#fff'}}>Un PGA Advanced Professional. Une île de golf exceptionnelle. Votre tour.</h2>
