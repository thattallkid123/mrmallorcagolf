...
export const metadata = {
  title: 'Guide Golf Majorque — Parcours, Conseils et Avis Honnêtes',
  description: 'Guides honnêtes sur le golf à Majorque par un PGA professionnel. Parcours, green fees, planification de voyage et meilleure période — mis à jour pour 2026.',
    ...
    <PageLayout lang="fr">
      ...
      <header className="page-hero">
        <div className="page-hero__inner">
          ...
          <p style={{fontSize:'1rem',fontWeight:300,color:'rgba(255,255,255,.6)',lineHeight:1.8,maxWidth:540,marginTop:'1rem'}}>Avis sur les parcours, planification de voyage, green fees et quand venir — rédigés par un PGA professionnel qui joue ici chaque semaine.</p>
      ...
      <section style={{maxWidth:860,margin:'0 auto',padding:'clamp(48px,8vw,96px) clamp(20px,4vw,40px)'}}>
        <p style={{fontSize:'0.875rem',fontWeight:300,color:'var(--taupe)',fontStyle:'italic',marginBottom:'2rem',paddingBottom:'1.5rem',borderBottom:'1px solid var(--linen)'}}>(Ces guides sont rédigés en anglais — les informations les plus complètes pour les golfeurs sur l'île.)</p>
      ...
      <section className="cta-final">
        <div className="cta-final__left reveal">
          ...
          <h2 className="serif-display" style={{color:'#fff'}}>Un tour privé sur l'un de ces parcours avec un PGA professionnel à vos côtés.</h2>
