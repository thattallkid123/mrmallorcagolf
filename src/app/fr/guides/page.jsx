...
const guides = [
  ...
  { slug: 'best-golf-courses-mallorca', badge: 'Guide parcours', badgeGold: true, title: 'Les Meilleurs Parcours de Golf à Majorque — Guide honnête (2026)', intro: "Majorque offre plus de golf de qualité que la plupart des visiteurs ne l'imaginent. Vingt-deux parcours, plusieurs de niveau DP World Tour.", readTime: '8 min', keywords: 'Son Gual · Alcanada · Son Muntaner · Golf de Andratx' },
  { slug: 'is-mallorca-good-for-golf', badge: "Vue d'ensemble", badgeGold: false, title: "Majorque est-elle un bon endroit pour le golf ? Réponse d'un PGA", intro: "Oui. Mais voici la vraie réponse — car Majorque est bonne pour le golf de façons qui ne sont pas évidentes de l'extérieur.", readTime: '6 min', keywords: "Parcours de niveau mondial · Toute l'année · 22 parcours · Au-delà du golf" },
  { slug: 'best-time-play-golf-mallorca', badge: 'Quand venir', badgeGold: false, title: 'La Meilleure Période pour Jouer au Golf à Majorque — Mois par mois (2026)', intro: "Réponse courte : octobre–novembre et février–avril. Mais l'île se joue mieux toute l'année qu'on ne le pense.", readTime: '4 min', keywords: 'Guide de saison · Mois par mois · Timing des green fees' },
  { slug: 'golf-cost-mallorca', badge: 'Green fees', badgeGold: false, title: 'Combien Coûte le Golf à Majorque ? Bilan complet 2026', intro: "Un tour peut coûter €20 ou €220 selon le parcours et la période. Bilan honnête par quelqu'un qui joue ici presque chaque semaine.", readTime: '5 min', keywords: 'Green fees · Location de clubs · Voiturettes · Coûts journée complète' },
  { slug: 'golf-trip-planning-mallorca', badge: 'Planification voyage', badgeGold: false, title: 'Comment Planifier le Voyage de Golf Parfait à Majorque', intro: "Pas de texte touristique, pas de remplissage. Quels parcours, quand venir, combien de tours, comment se déplacer — par quelqu'un qui vit ici.", readTime: '7 min', keywords: 'Quand visiter · Parcours · Transport · Que faire' },
  { slug: 'golf-club-hire-mallorca', badge: 'Guide pratique', badgeGold: false, title: "Location de Clubs de Golf à Majorque — Tout ce qu'il faut savoir (2026)", intro: 'Apporter ses propres clubs ou en louer ? Quelles entreprises valent le coup et lesquelles éviter.', readTime: '6 min', keywords: 'Sociétés de location · Prix · Pros shops · Conseils' },
]
