...
export const metadata = {
  ...
  description: 'Une partie de golf privee a Majorque aux cotes du PGA Advanced Professional Andy Griffiths. Coaching sur parcours, journee complete organisee. A partir de 500 EUR par personne.',
    ...
    <PageLayout lang="fr">
      ...
      <section className="pwap-hero">
        ...
        <div className="pwap-hero__inner">
          <div className="pwap-hero__content">
            ...
            <p className="eyebrow eyebrow--gold" style={{marginBottom:'1rem',marginTop:'1rem'}}>Journees Golf Privees · Majorque</p>
            <h1 className="serif-display" style={{fontSize:'clamp(2.4rem,5vw,4.2rem)',color:'#fff',marginBottom:'1.25rem'}}>Une Journee Golf Privee a Majorque.</h1>
            <p style={{fontSize:'1rem',fontWeight:300,color:'rgba(255,255,255,.65)',lineHeight:1.75,maxWidth:520,marginBottom:'1.5rem'}}>Pas une lecon. Pas un tour standard. Une journee privee sur l'un des plus beaux parcours de l'ile, animee par un PGA professionnel qui a coache au plus haut niveau sur trois continents.</p>
            <p style={{fontFamily:"'Cormorant Garamond',serif",fontSize:'1.15rem',color:'var(--gold-light)',marginBottom:'2rem'}}>A partir de &euro;500 par personne</p>
            <div style={{display:'flex',gap:14,flexWrap:'wrap'}}>
              <Link href="/fr/contact" className="btn btn--gold">Reserver votre journee &rarr;</Link>
      ...
      <section className="pwap-day">
        <div className="pwap-day__left reveal">
          <p className="eyebrow">Ce que la journee implique</p>
          <h2 className="serif-display" style={{fontSize:'clamp(1.8rem,3vw,2.5rem)',color:'var(--deep)',marginTop:'.75rem',marginBottom:'1.5rem'}}>Avant votre arrivee, je sais deja quoi observer.</h2>
          <p>Avant votre arrivee, vous remplissez un court questionnaire. Ce qui vous frustre, ou est l'ecart. Quand nous arrivons au premier depart, je sais deja quoi observer.</p>
          <p>Pendant le tour, le coaching s'integre naturellement — pas un commentaire continu, mais la bonne observation au bon moment. Des decisions de gestion de parcours que vous n'aviez pas envisagees.</p>
          <p>J'ai coache dans des environnements ou l'attente etait une amelioration serieuse et mesurable — des joueurs de l'equipe nationale en Chine, des mordus de golf a travers l'Asie.</p>
          ...
          <p>Le debriefing autour du dejeuner n'est pas un resume. C'est la conversation qui donne un sens a toute la journee.</p>
        </div>
        <div className="pwap-day__right reveal">
          <div className="included">
            ...
            <ul className="included-list">
              ...
              <li className="included-item"><span className="included-dot"></span><p><strong>18 trous aux cotes d'Andy</strong>En jouant, comme votre partenaire</p></li>
              ...
              <li className="included-item"><span className="included-dot"></span><p><strong>Dejeuner</strong>Au restaurant du parcours ou local (Journee Signature)</p></li>
            </ul>
          </div>
        </div>
      </section>
      ...
      <section className="pwap-courses">
        <div className="courses-intro reveal">
          ...
          <p style={{color:'rgba(255,255,255,.55)',lineHeight:1.8,maxWidth:680}}>Un groupe avec des debutants, une demi-journee — il y a des parcours qui conviennent mieux, et je vous dirai honnettement lequel. Certains sont reserves aux membres — cet acces peut etre arrange.</p>
        </div>
      ...
      <section className="pwap-who">
        <div className="reveal">
          ...
          <h2 className="serif-display" style={{fontSize:'clamp(1.8rem,3vw,2.5rem)',color:'var(--deep)',marginTop:'.75rem',marginBottom:'2.5rem'}}>L'experience s'adapte a votre jeu.</h2>
        </div>
        <div className="who-grid">
          ...
          <div className="who-card reveal reveal-delay-1"><span className="who-card__icon">02</span><h3>L'ecart practice/parcours</h3><p>Des golfeurs dont le jeu au practice ne se transfere jamais. Le probleme est presque toujours la gestion de parcours.</p></div>
          <div className="who-card reveal reveal-delay-2"><span className="who-card__icon">03</span><h3>Le groupe d'executives</h3><p>Groupes d'entreprise, dirigeants en visite, journee premium entierement organisee.</p></div>
          ...
          <div className="who-card reveal reveal-delay-2"><span className="who-card__icon">06</span><h3>Quiconque veut plus</h3><p>La seule condition est de vouloir une experience golf genuinement differente.</p></div>
        </div>
      </section>
      ...
      <section className="pwap-testimonials">
        ...
        <div className="pwap-testimonials__grid">
          <div className="testimonial reveal"><p>&ldquo;Jouer au golf avec Andy etait une experience superbe. Il possede un niveau d'insight sans egal, et le transmet de facon a la fois subtile et empathique. Apres seulement 18 trous, j'ai decouvert un nouveau plafond a mon potentiel.&rdquo;</p><span className="testimonial__author">— Jo</span></div>
          <div className="testimonial reveal reveal-delay-1"><p>&ldquo;L'insight sur les calculs derriere chaque coup a considerablement ameliore ma prise de decision. Le moment marquant : voir Andy frapper un fer 3 a 220 metres par-dessus un dogleg a droite et le placer sur le green.&rdquo;</p><span className="testimonial__author">— Finlay</span></div>
      ...
      <section className="pwap-packages" id="packages">
        <div className="reveal">
          <p className="eyebrow">Experiences & Formules</p>
          ...
          <p style={{fontSize:'1rem',color:'var(--taupe)',lineHeight:1.8,maxWidth:560,marginBottom:'3rem'}}>La difference est dans la completude de la journee. Les trois incluent le meme niveau d'expertise.</p>
        </div>
        <div className="pricing-grid">
          <div className="tier reveal">
            <p className="tier__name-small">Le Tour de Majorque</p>
            <h3 className="tier__name">Jouer avec un Pro</h3>
            <p className="tier__price">A partir de &euro;500 par personne</p>
            ...
            <ul className="tier__features">
              ...
              <li>18 trous aux cotes d'Andy</li>
              <li>Coaching sur parcours</li>
              <li>Debriefing apres la ronde</li>
            </ul>
            <Link href="/fr/contact" className="tier__btn">Demander &rarr;</Link>
          </div>
          <div className="tier tier--feature reveal">
            <p className="tier__name-small">La Journee Signature</p>
            <h3 className="tier__name">Journee Golf Encadree</h3>
            <p className="tier__price">A partir de &euro;650 par personne</p>
            <div className="tier__rule"></div>
            <ul className="tier__features">
              ...
              <li>Rythme pose — une vraie journee</li>
            </ul>
            <Link href="/fr/contact" className="tier__btn">Demander &rarr;</Link>
          </div>
          <div className="tier reveal">
            <p className="tier__name-small">L'Experience Complete</p>
            <h3 className="tier__name">Voyage Golf Sur Mesure</h3>
            <p className="tier__price">Sur devis</p>
            <div className="tier__rule"></div>
            <ul className="tier__features">
              <li>Journee multi-parcours ou programme</li>
      ...
      <section className="cta-final">
        <div className="cta-final__left reveal">
          ...
          <h2 className="serif-display" style={{color:'#fff'}}>Prenez contact et organisons votre journee.</h2>
          <p>Dites-moi vos dates, votre handicap et ce que vous attendez. Je vous repondrai — personnellement, sous 24 heures.</p>
        </div>
        <div className="cta-final__right reveal">
          <Link href="/fr/contact" className="btn btn--gold" style={{fontSize:11,padding:'15px 36px'}}>Reserver votre journee &rarr;</Link>
