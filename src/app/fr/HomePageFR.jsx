    ...
    <>
      <section className="hero">
        ...
        <div className="hero__content">
          ...
          <h1 className="serif-display hero__title">
            ...
            <em style={{fontStyle:'italic',fontWeight:400,opacity:0.85}}>Avec un professionnel a vos cotes.</em>
          </h1>
          <div className="hero__actions">
            <Link href="/fr/contact" className="btn btn--gold">Reserve su día</Link>
        ...
        <div className="hero__trust">
          ...
          <p className="hero__trust-line"><em>Trackman Master certifie</em></p>
      ...
      <section className="courses" id="courses">
        <div className="courses__header">
          <div className="courses__header-left">
            ...
            <h2 className="serif-display">Los mejores parcours de Majorque — jugados y valorados.</h2>
          </div>
        ...
        <div style={{textAlign:'center',marginTop:'2.5rem'}}>
          <Link href="/fr/golf-courses" className="btn btn--dark">Ver los 22 campos →</Link>
        </div>
      </section>
      ...
      <section className="what">
        <div className="what__left reveal">
          ...
          <Link href="/fr/play-with-a-pro" className="btn btn--dark">Ver las experiencias</Link>
        </div>
      ...
      <section className="packages">
        ...
        <div className="packages__grid">
          <div className="package reveal">
            ...
            <Link href="/fr/contact" className="btn btn--dark">Consultar</Link>
          </div>
          <div className="package package--featured reveal reveal-delay-1">
            ...
            <Link href="/fr/contact" className="btn btn--gold">Consultar</Link>
          </div>
      ...
      <section className="cta-final">
        ...
        <div className="cta-final__right reveal reveal-delay-1">
          ...
          <Link href="/fr/contact" className="btn btn--gold" style={{fontSize:11,padding:'15px 36px',letterSpacing:'0.18em'}}>Reserve su día</Link>
