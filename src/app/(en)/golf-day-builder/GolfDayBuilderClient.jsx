...
const COURSES = [
  ...
  { id:"pula", name:"Pula Golf", region:"east", tags:["forgiving","relaxed","family"], facts:["Par 72 · Olazábal redesign","TrackMan Range, unique in Mallorca"], blurb:"A welcoming east coast course with a serious tournament past, redesigned by José María Olazábal. Generous where it matters and well kept year round.", level:"beginner+", driveMins:{southwest:65, palma:50, north:35, east:10, south:60} },
