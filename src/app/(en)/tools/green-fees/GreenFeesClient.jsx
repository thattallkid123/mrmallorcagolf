...
const BASE_COURSES = [
  ...
  { name: 'T Golf Palma Puntiró', area: 'Palma',   peak: 150, low: 60,  buggy: '€40',                           walking: 'yes',        walkingNote: '',                            handicap: 'yes', handicapNote: '34M / 36L',               nineHoles: false, verdict: "The only Nicklaus design in Mallorca, with a 42-bay range that makes it the island's best practice hub.", guideUrl: null },
  ...
  { name: 'Son Antem East',     area: 'Palma',     peak: 125, low: 64,  buggy: '€48',                           walking: 'yes',        walkingNote: '',                            handicap: 'yes', handicapNote: '54',                      nineHoles: false, verdict: "Handicap 54 welcome and one of Europe's largest golf academies on site. The friendlier of the two Antem courses.", guideUrl: null },
  { name: 'Son Antem West',     area: 'Palma',     peak: 115, low: 67,  buggy: '€48',                           walking: 'yes',        walkingNote: 'Flat',                        handicap: 'yes', handicapNote: '27M / 35L',               nineHoles: false, verdict: 'Flat and forgiving, and the tree-lined 16th is worth the round alone. Expect queues at busy times.', guideUrl: '/guides/son-antem-west-review' },
