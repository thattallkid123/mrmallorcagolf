...
const BASE_COURSES = [
  ...
  { name: 'Son Muntaner',       area: 'Palma',     peak: 259, low: 110, buggy: 'Included Mar–late Nov',         walking: 'yes',        walkingNote: 'Long but flat',               handicap: 'yes', handicapNote: '36',                      nineHoles: false, verdict: 'Named Best Golf Course in Spain 2025, and the conditioning backs the title up. Peak €259 / low €110.', guideUrl: '/guides/son-muntaner-review' },
  { name: 'Son Vida',           area: 'Palma',     peak: 190, low: 85,  buggy: 'Available (dynamic pricing)',   walking: 'yes',        walkingNote: 'Undulating',                  handicap: 'yes', handicapNote: '36 + certificate',        nineHoles: false, verdict: "The island's oldest course. Short and tight rather than long, ten minutes from the city. Peak €190 / low €85.", guideUrl: null },
  { name: 'Son Quint',          area: 'Palma',     peak: 172, low: 70,  buggy: 'Available (dynamic pricing)',   walking: 'yes',        walkingNote: '',                            handicap: 'yes', handicapNote: '36',                      nineHoles: false, verdict: 'The 8th tee faces straight at Palma Cathedral. Wide, forgiving fairways suit a relaxed round. Peak €172 / low €70.', guideUrl: null },
  { name: 'T Golf Palma Puntiró', area: 'Palma',   peak: 150, low: 60,  buggy: '€40',                           walking: 'yes',        walkingNote: '',                            handicap: 'yes', handicapNote: '34M / 36L',               nineHoles: false, verdict: "The only Nicklaus design in Mallorca, with a 42-bay range that makes it the island's best practice hub. Peak €150 / low €60.", guideUrl: null },
  ...
  { name: 'Son Antem East',     area: 'Palma',     peak: 125, low: 64,  buggy: '€48',                           walking: 'yes',        walkingNote: '',                            handicap: 'yes', handicapNote: '54',                      nineHoles: false, verdict: "Handicap 54 welcome and one of Europe's largest golf academies on site. The friendlier of the two Antem courses. Peak €125 / low €64.", guideUrl: null },
  { name: 'Son Antem West',     area: 'Palma',     peak: 115, low: 67,  buggy: '€48',                           walking: 'yes',        walkingNote: 'Flat',                        handicap: 'yes', handicapNote: '27M / 35L',               nineHoles: false, verdict: 'Flat and forgiving, and the tree-lined 16th is worth the round alone. Expect queues at busy times. Peak €115 / low €67.', guideUrl: '/guides/son-antem-west-review' },
  { name: 'Son Termes',         area: 'Palma',     peak: 110, low: 90,  buggy: 'Green fee + buggy bundles',     walking: 'restricted', walkingNote: 'Front 9 flat, back 9 steep',  handicap: 'yes', handicapNote: '36 + certificate',        nineHoles: false, verdict: 'More character than most courses at this price. The views from the back nine are the best this close to Palma.', guideUrl: '/guides/son-termes-review' },
  { name: 'Pollensa',           area: 'North',     peak: 75,  low: 55,  buggy: '€25–€35',                       walking: 'yes',        walkingNote: '',                            handicap: 'yes', handicapNote: '36',                      nineHoles: true,  verdict: 'Nine holes under the Tramuntana mountains at the friendliest prices on the island.', guideUrl: null },
  ...
  { name: 'Pula',               area: 'East',      peak: 145, low: 69,  buggy: '€45',                           walking: 'yes',        walkingNote: 'One notable hill',            handicap: 'yes', handicapNote: '34M / 36L',               nineHoles: false, verdict: 'An Olazábal redesign with the only TrackMan range in Mallorca. Peak €145 / low €69.', guideUrl: null },
