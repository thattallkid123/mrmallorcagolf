...
const BASE_COURSES = [
  ...
  { name: 'Son Antem West',     area: 'Palma',     peak: 135, low: 109, buggy: '€48',                           walking: 'yes',        walkingNote: 'Flat',                        handicap: 'yes', handicapNote: '27M / 35L',               nineHoles: false, verdict: 'Flat and forgiving, and the tree-lined 16th is worth the round alone. Expect queues at busy times.', guideUrl: '/guides/son-antem-west-review' },
