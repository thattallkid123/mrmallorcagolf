...
/* =====================================================================
   ...
   ===================================================================== */
const BASE_COURSES = [
  { name: 'Son Gual',           area: 'Palma',     peak: 165, low: 115, buggy: '€45',                           walking: 'yes',        walkingNote: '',                            handicap: 'yes', handicapNote: '28M / 36L', certRequired: true, nineHoles: false, verdict: 'My most-played course in Mallorca and the one I recommend most consistently. Peak season €165 / low season €115. Not a soft holiday round.', guideUrl: '/guides/son-gual-review' },
  ...
  { name: 'Palma Pitch & Putt', area: 'Palma',     peak: 30,  low: 20,  buggy: 'Not needed',                    walking: 'yes',        walkingNote: '',                            handicap: 'no',  handicapNote: 'None', certRequired: false, nineHoles: true,  verdict: 'No handicap needed and club hire from €5. Green fees are €20 for 9 holes or €30 for 18. The right first golf experience on the island.', guideUrl: null },
  ...
  { name: 'Santa Ponsa II',     area: 'Southwest', peakText: 'Via pro', lowText: 'Members', buggy: 'Member', walking: 'yes', walkingNote: '',           handicap: 'yes', handicapNote: '28M / 36L', certRequired: true, nineHoles: false, verdict: 'Members only, quiet, and more strategic than people expect. The 18th green is shaped like Mallorca itself.', guideUrl: null },
  { name: 'Santa Ponsa III',    area: 'Southwest', peakText: 'Via pro', lowText: 'Members', buggy: 'Not needed',        walking: 'yes', walkingNote: '',           handicap: 'yes', handicapNote: '28M / 36L', certRequired: true, nineHoles: true,  verdict: 'A nine-hole scoring loop. I use it for wedge and approach work rather than a serious test.', guideUrl: null },
  ...
  { name: 'Maioris',            area: 'Palma',     peak: 110, low: 91,  buggy: '€36–€47',                       walking: 'yes',        walkingNote: '',                            handicap: 'yes', handicapNote: '36', certRequired: true, nineHoles: false, verdict: 'The most sensible spend this close to Palma, fifteen minutes from the city.', guideUrl: null },
  { name: 'Son Antem East',     area: 'Palma',     peak: 140, low: 105, buggy: '€48',                           walking: 'yes',        walkingNote: '',                            handicap: 'yes', handicapNote: '54', certRequired: false, nineHoles: false, verdict: "Handicap 54 welcome and one of Europe's largest golf academies on site. The friendlier of the two Antem courses.", guideUrl: null },
  ...
  { name: 'Son Termes',         area: 'Palma',     peak: 100, low: 80,  buggy: 'Bundled',                       walking: 'restricted', walkingNote: 'Front flat, back steep', handicap: 'yes', handicapNote: '36', certRequired: true, nineHoles: false, verdict: 'More character than most courses at this price. The views from the back nine are the best this close to Palma.', guideUrl: '/guides/son-termes-review' },
  { name: 'Pollensa',           area: 'North',     peak: 65,  low: 55,  buggy: '€25–€35',                       walking: 'yes',        walkingNote: '',                            handicap: 'yes', handicapNote: '36', certRequired: true, nineHoles: true,  verdict: 'Nine holes under the Tramuntana mountains at the friendliest prices on the island.', guideUrl: null },
...
function handicapDisplay(c) {
  if (c.handicapNote === 'None') return { text: 'No', cls: '' }
  const text = c.handicapNote + (c.certRequired ? ' †' : '')
  const cls = c.certRequired ? 'gold' : ''
  return { text, cls }
}
  ...
  return (
    <div className="gf">
      <style>{`
        ...
        .gf thead th { background:var(--pine); color:#fff; font-weight:400; letter-spacing:.05em; text-transform:uppercase; font-size:.72rem; text-align:left; padding:12px 10px; cursor:pointer; user-select:none; white-space:nowrap; }
      ...
      <main className="gf-main">
        ...
        <div className="gf-disclaimer">
          <strong>Please note:</strong> Prices are approximate and change seasonally. Always confirm directly with the course before booking. Peak season on Mallorca generally runs March–May and September–November; low season is midsummer and midwinter. † = Handicap certificate required.
        </div>
              ...
              {rows.map((c) => {
                ...
                return (
                  <tr key={c.name}>
                    ...
                    <td>{c.area}</td>
                    <td>{fmtFee(c.peak, c.peakText)}</td>
                    <td>{fmtFee(c.low, c.lowText)}</td>
                    <td>{c.buggy}</td>
                    <td><span className={`gf-pill ${w.cls}`}>{w.text}</span></td>
                    <td><span className={`gf-pill ${h.cls}`}>{h.text}</span></td>
            ...
            return (
              <div className="gf-card" key={c.name}>
                ...
                <div className="grid">
                  ...
                  <div><span className="k">Handicap</span>{h.text}</div>
                </div>
