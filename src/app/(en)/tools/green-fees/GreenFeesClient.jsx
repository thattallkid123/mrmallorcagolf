...
const BASE_COURSES = [
  ...
  { name: 'Son Vida',           area: 'Palma',     peak: 190, low: 84,  buggy: '€48–€60',                       walking: 'yes',        walkingNote: '',                            handicap: 'yes', handicapNote: '36', certRequired: true, nineHoles: false, verdict: "The island's oldest course. Short and tight rather than long, ten minutes from the city.", guideUrl: null },
  { name: 'Son Quint',          area: 'Palma',     peak: 172, low: 76,  buggy: '€48–€60',                       walking: 'yes',        walkingNote: '',                            handicap: 'yes', handicapNote: '36', certRequired: true, nineHoles: false, verdict: 'The 8th tee faces straight at Palma Cathedral. Wide, forgiving fairways suit a relaxed round.', guideUrl: null },
  { name: 'T Golf Palma Puntiró', area: 'Palma',   peak: 150, low: 80, buggy: '€40',                           walking: 'yes',        walkingNote: '',                            handicap: 'yes', handicapNote: '28M / 34L', certRequired: true, nineHoles: false, verdict: "The only Nicklaus design in Mallorca, with a 42-bay range that makes it the island's best practice hub.", guideUrl: null },
  { name: 'Palma Pitch & Putt', area: 'Palma',     peak: 30,  low: 27,  buggy: 'Not needed',                    walking: 'yes',        walkingNote: '',                            handicap: 'no',  handicapNote: 'None', certRequired: false, nineHoles: true,  verdict: 'The natural starting point for beginners and juniors, a useful warm-up, or a low-pressure way for a non-golfer to try the game.', guideUrl: null },
  ...
  { name: 'Capdepera',          area: 'East',      peak: 149, low: 79,  buggy: '€35–€45',                       walking: 'yes',        walkingNote: '',                            handicap: 'yes', handicapNote: '36', certRequired: true, nineHoles: false, verdict: 'The 15th is stroke index 1 and was voted the best hole on the island. Rafa Nadal plays here regularly.', guideUrl: null },
  ...
  { name: 'Son Servera',        area: 'East',      peak: 165, low: 80,  buggy: '€38–€49',                       walking: 'yes',        walkingNote: '',                            handicap: 'yes', handicapNote: '36', certRequired: true, nineHoles: false, verdict: "The island's second oldest club. Flat, walkable, and the €21 menu del día is honest value.", guideUrl: null },
