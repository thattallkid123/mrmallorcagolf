...
/* =====================================================================
   EDITORIAL COURSE DATA — verdicts may stay local here. Guide links are NOT
   typed here: they come from `reviewSlug` in golf-courses-data.js.
   ...
   ===================================================================== */
const BASE_COURSES = [
  { name: 'Son Gual',           area: 'Palma',     peak: 165, low: 115, buggy: '€45',                           walking: 'yes',        walkingNote: '',                            handicap: 'yes', handicapNote: '28M / 36L', certRequired: true, nineHoles: false, verdict: 'My most-played course on the island. The wind is fickle, the greens are quick, and the closing stretch is as good as anything in Mallorca.' },
  { name: 'Alcanada',           area: 'North',     peak: 230, low: 115, buggy: '€48 with GPS',                  walking: 'restricted', walkingNote: 'Hilly',                      handicap: 'yes', handicapNote: '33M / 35L', certRequired: true, nineHoles: false, verdict: 'The lighthouse is visible from 16 of the 18 holes. The course I take people to when I want them to remember one round in particular.' },
  { name: 'T Golf Calvià',      area: 'Southwest', peak: 210, low: 80,  buggy: '€40',                           walking: 'yes',        walkingNote: '',                            handicap: 'yes', handicapNote: '28M / 34L', certRequired: true, nineHoles: false, verdict: 'One of the best-conditioned courses I have played in Mallorca. Fifteen lakes keep water in play mentally all day.' },
  { name: 'Son Muntaner',       area: 'Palma',     peak: 260, low: 99, buggy: 'Included',                      walking: 'yes',        walkingNote: '',                            handicap: 'yes', handicapNote: '36', certRequired: true, nineHoles: false, verdict: 'Named Best Golf Course in Spain 2025, and the conditioning backs the title up. One of the premium Palma rounds, with daily licence on top.' },
  { name: 'Son Vida',           area: 'Palma',     peak: 190, low: 84,  buggy: '€48–€60',                       walking: 'yes',        walkingNote: '',                            handicap: 'yes', handicapNote: '36', certRequired: true, nineHoles: false, verdict: "The island's oldest course. Short and tight rather than long, ten minutes from the city." },
  { name: 'Son Quint',          area: 'Palma',     peak: 172, low: 76,  buggy: '€48–€60',                       walking: 'yes',        walkingNote: '',                            handicap: 'yes', handicapNote: '36', certRequired: true, nineHoles: false, verdict: 'The 8th tee faces straight at Palma Cathedral. Wide, forgiving fairways suit a relaxed round.' },
  { name: 'T Golf Palma Puntiró', area: 'Palma',   peak: 150, low: 80, buggy: '€40',                           walking: 'yes',        walkingNote: '',                            handicap: 'yes', handicapNote: '28M / 34L', certRequired: true, nineHoles: false, verdict: "The only Nicklaus design in Mallorca, with a 42-bay range that makes it the island's best practice hub." },
  { name: 'Palma Pitch & Putt', area: 'Palma',     peak: 30,  low: 27,  buggy: 'Not needed',                    walking: 'yes',        walkingNote: '',                            handicap: 'no',  handicapNote: 'None', certRequired: false, nineHoles: true,  verdict: 'The natural starting point for beginners and juniors, a useful warm-up, or a low-pressure way for a non-golfer to try the game.' },
  { name: 'Santa Ponsa I',      area: 'Southwest', peak: 126, low: 77,  buggy: '€43',                          walking: 'yes',        walkingNote: '',                            handicap: 'yes', handicapNote: '28M / 36L', certRequired: true, nineHoles: false, verdict: 'The open fairways here helped me get my own driving confidence back. The 590m 10th is one of the longest par 5s in Europe.' },
  { name: 'Santa Ponsa II',     area: 'Southwest', peak: 88, low: 65, buggy: '€38 · Optional', walking: 'yes', walkingNote: '', handicap: 'yes', handicapNote: '36', certRequired: true, nineHoles: false, verdict: 'Quieter and more strategic than Santa Ponsa 1. The 18th green is shaped like Mallorca itself.' },
  { name: 'Santa Ponsa III',    area: 'Southwest', peak: 30, low: 25, buggy: '€38 · Optional', walking: 'yes', walkingNote: '', handicap: 'no', handicapNote: 'None', certRequired: false, nineHoles: true, verdict: 'Most holes are short, but the second still asks for a precise tee shot. Best for beginners, approach practice, or a quick extra nine.' },
  { name: 'Golf de Andratx',    area: 'Southwest', peak: 170, low: 95,  buggy: '€45 (morning)',                 walking: 'restricted', walkingNote: 'Walkable afternoon',         handicap: 'yes', handicapNote: '28M / 36L', certRequired: true, nineHoles: false, verdict: 'Home to the longest par 5 in Spain and the best sea views on the island. Bring plenty of golf balls.' },
  { name: 'Bendinat',           area: 'Southwest', peak: 123, low: 74,  buggy: '€33–€43',                       walking: 'restricted', walkingNote: 'Hilly',                     handicap: 'yes', handicapNote: '36', certRequired: true, nineHoles: false, verdict: 'Castle views and real hills. Take the buggy and enjoy it.' },
  { name: 'Maioris',            area: 'Palma',     peak: 110, low: 91,  buggy: '€36–€47',                       walking: 'yes',        walkingNote: '',                            handicap: 'yes', handicapNote: '36', certRequired: true, nineHoles: false, verdict: 'Less crowded than many Palma courses, with two significant climbs waiting in the closing holes.' },
  { name: 'Son Antem East',     area: 'Palma',     peak: 140, low: 105, buggy: '€48',                           walking: 'yes',        walkingNote: '',                            handicap: 'yes', handicapNote: '54', certRequired: false, nineHoles: false, verdict: 'Wide, generous fairways make this the friendlier Antem course, while five lakes keep the round interesting.' },
  { name: 'Son Antem West',     area: 'Palma',     peak: 145, low: 109, buggy: '€48',                           walking: 'yes',        walkingNote: '',                            handicap: 'yes', handicapNote: '27M / 35L', certRequired: true, nineHoles: false, verdict: 'Flat and forgiving, and the tree-lined 16th is worth the round alone. Expect queues at busy times.' },
  { name: 'Son Termes',         area: 'Palma',     peak: 110, low: 90,  buggy: 'Bundled',                       walking: 'restricted', walkingNote: 'Front flat, back steep', handicap: 'yes', handicapNote: '36', certRequired: true, nineHoles: false, verdict: 'The back nine has the best mountain views this close to Palma, but the climbs make it a much tougher walk than the front.' },
  { name: 'Pollensa',           area: 'North',     peak: 75,  low: 65,  buggy: '€25–€35',                       walking: 'yes',        walkingNote: '',                            handicap: 'yes', handicapNote: '36', certRequired: true, nineHoles: true,  verdict: 'A compact nine-hole option under the Tramuntana mountains, with a few proper climbs despite the short format.' },
  { name: 'Capdepera',          area: 'East',      peak: 149, low: 79,  buggy: '€35–€45',                       walking: 'yes',        walkingNote: '',                            handicap: 'yes', handicapNote: '36', certRequired: true, nineHoles: false, verdict: 'The 15th is stroke index 1 and was voted the best hole on the island. Rafa Nadal plays here regularly.' },
  { name: 'Canyamel',           area: 'East',      peak: 145, low: 85,  buggy: '€30–€45',                       walking: 'restricted', walkingNote: 'Front hilly', handicap: 'yes', handicapNote: '36M / 45L', certRequired: true, nineHoles: false, verdict: 'A José Gancedo design with lakes throughout. Tee off before 8:50am and the early-bird rate saves a decent amount.' },
  { name: 'Pula',               area: 'East',      peak: 145, low: 69,  buggy: '€45',                           walking: 'yes',        walkingNote: '',                            handicap: 'yes', handicapNote: '34M / 36L', certRequired: true, nineHoles: false, verdict: 'An Olazábal redesign with a two-level range and strong short-game facilities. A good choice for a practice-heavy golf day.' },
  { name: 'Son Servera',        area: 'East',      peak: 165, low: 80,  buggy: '€38–€49',                       walking: 'yes',        walkingNote: '',                            handicap: 'yes', handicapNote: '36', certRequired: true, nineHoles: false, verdict: "The island's second oldest club. Flat, walkable, and the €21 menu del día is honest value." },
  { name: "Vall d'Or",          area: 'East',      peak: 132, low: 99,  buggy: '€35–€50',                       walking: 'restricted', walkingNote: 'Hilly',                      handicap: 'yes', handicapNote: '36', certRequired: true, nineHoles: false, verdict: 'Two different nines: wooded and uphill going out, sea views coming home.' },
  { name: 'La Reserva Rotana',  area: 'East',      peakText: 'Hotel', lowText: 'Incl.', buggy: 'Not needed', walking: 'yes', walkingNote: '',                    handicap: 'yes', handicapNote: 'Cert req.', certRequired: true, nineHoles: true,  verdict: 'A quiet nine-hole estate course. More of a relaxed hotel round than a course to build the trip around.' },
]
...
export default function GreenFeesClient({ lang = 'en' }) {
  ...
  const guideCell = (c) => c.reviewSlug
    ? <Link className="gf-guide" href={getGuidePath(c.reviewSlug, lang)}>{t.table.viewFullGuide}</Link>
          ...
          {rows.map((c) => {
            ...
            return (
              <div className="gf-card" key={c.name}>
                ...
                {c.reviewSlug && <Link className="gf-guide" href={getGuidePath(c.reviewSlug, lang)}>{t.table.viewFullGuide}</Link>}
              </div>
            )
          })}
        </div>
