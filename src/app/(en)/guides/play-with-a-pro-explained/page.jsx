  ...
  return (
    <PageLayout trackScrollDepth>
      ...
      <article className="a-day-article">
        ...
        <section className="a-day-section a-day-section--white">
          <div className="a-day-section__inner">
            ...
            <p className="a-day-section__copy">
              The course is chosen to match your game. A proper test, but not unfair. Wind, conditions, narrow fairways, water: the decisions you make change with what&rsquo;s in front of you, and getting them right or wrong matters. That&rsquo;s why playing with someone matters.
            </p>
            <p className="a-day-section__copy">
      ...
      <div className="a-day-facts">
        <div className="a-day-facts__grid">
          {[
            ...
            { label: 'Day rate', value: `${soloOffer.priceDisplay} solo · ${groupOffer.priceDisplay} for 2-3 golfers (course fee and lunch additional)` },
          ].map(({ label, value }) => (
            <div key={label}>
      ...
      <StickyMobileCta
        ...
        secondaryHref="https://wa.me/34624466702?text=Hi%20Andy%2C%20I%27m%20interested%20in%20a%20Play%20With%20a%20Pro%20day."
