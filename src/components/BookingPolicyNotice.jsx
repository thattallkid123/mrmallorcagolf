...
const BOOKING_POLICY_COPY = {
  ...
  de: {
    ...
    pairingNote: 'Hinweis zur Startzeit: An stark gebuchten Tagen kann der Golfplatz kleine Gruppen mit anderen Spielern zusammenlegen. Wenn die Startzeit nur fuer Ihre Gruppe reserviert sein soll, kann ich die freien Plaetze vorab gegen Aufpreis mitbuchen. Beim Signature Day ist das standardmaessig enthalten.',
  ...
  fr: {
    ...
    pairingNote: 'Note depart: les parcours tres demandes peuvent regrouper les petites reservations avec d autres joueurs. Si vous voulez garder le depart uniquement pour votre groupe, je peux ajouter les places restantes avec un cout supplementaire avant reservation. Le Signature Day l inclut d office.',
