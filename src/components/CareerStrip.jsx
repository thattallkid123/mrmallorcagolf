...
const CAREER_VENUES = [
  ...
  { name: 'The Open Championship', detail: 'United Kingdom',          img: '/images/career/the-open.webp', imageFit: 'contain', imagePosition: 'center center' },
    ...
    <section className="career-strip">
      ...
      <div ref={viewportRef} className="career-strip__viewport" aria-label="Career venues carousel">
        <div ref={trackRef} className="career-strip__track">
          {allVenues.map((v, i) => (
            <div key={i} className={`career-strip__card${v.imageFit === 'contain' ? ' career-strip__card--contain' : ''}`}>
              {v.img ? (
                <>
                  <div className="career-strip__card-img">
                    <Image
                      ...
                      unoptimized
                      style={{ objectFit: v.imageFit || 'cover', objectPosition: v.imagePosition || 'center 30%' }}
                    />
