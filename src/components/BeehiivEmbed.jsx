...
export default function BeehiivEmbed() {
  ...
  return (
    <div style={{ width: '100%', maxWidth: 520, overflow: 'hidden', height: 52 }}>
      <iframe
        ...
        frameBorder="0"
        scrolling="no"
        style={{ display: 'block', width: '100%', height: 110, marginTop: -49, border: 'none', borderRadius: 0, background: 'transparent', boxShadow: 'none' }}
      />
    </div>
  )
}
